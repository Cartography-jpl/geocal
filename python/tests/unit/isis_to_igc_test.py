    ...
    if check_time:
        for ln in range(0, igc.number_line, 100):
            ...
            npt.assert_almost_equal(
                igc.pixel_time(ic).j2000, igc_isis.pixel_time(ic).j2000, decimal=6
            )
    ...
    if check_isis:
        ...
        for ln in range(0, igc.number_line, 1000):
            ...
            for smp in range(0, igc.number_sample, 100):
                ...
                gc2 = igc_match_isis.ground_coordinate_approx_height(
                    ic, gc.height_reference_surface
                )
...
def test_hrsc_to_igc(mars_test_data, isolated_dir):
    ...
    if True:
        ...
        pds_to_isis(
            "/bigdata/tllogan30/isis/hrsc_testcase/pds_data/h5235_0000_nd2.img",
            "hrsc.cub",
        )
        fname = "hrsc.cub"
    check_igc(fname)
...
def test_lunar_wac_to_igc(isolated_dir):
    ...
    if False:
        ...
        f = VicarRasterImage("wac.img", "DOUB", igc.number_line, igc.number_sample)
        copy_raster(igc.image, f, True, -1, igc.number_sample)
        return
    check_igc(
        fname,
        band=3,
        check_glas_rsm=False,
        check_time=False,
        check_camera=False,
        check_isis=True,
        check_spice=False,
        check_glas=True,
        check_create_nitf=True,
    )
...
def test_lunar_nac_to_igc(isolated_dir):
    if True:
        ...
        lcam_nac_fname = (
            "/raid28/tllogan/Moon_Luna_Data/WAC/mixed_WAC_NAC_edr_cdr/M1124549139LE.IMG"
        )
        rcam_nac_fname = (
            "/raid28/tllogan/Moon_Luna_Data/WAC/mixed_WAC_NAC_edr_cdr/M1124549139RE.IMG"
        )
...
def test_lunar_nac_to_igc2(isolated_dir):
    ...
    if True:
        ...
        lcam_nac_fname = (
            "/raid28/tllogan/Moon_Luna_Data/NAC_pilot_PDS/M1192065066LE.IMG"
        )
