...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__CartLabMultifile_t swig_types[63]
...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__GdalCartLabMultifile_t swig_types[74]
