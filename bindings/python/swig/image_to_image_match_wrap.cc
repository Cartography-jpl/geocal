...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__ImageCoordinateWithDerivative_t swig_types[36]
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__ImageCoordinate_t swig_types[37]
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__ImageToImageMatch_t swig_types[38]
