...
AC_SUBST([pythonswigsrc], [${geocal_topdir}/geocal/bindings/python])
AC_SUBST([swigsrc], [${geocal_topdir}/geocal/bindings/python/swig])
...
AC_SUBST([srcsdbx], [${geocal_topdir}/geocal/thirdparty/libsdbx])
AC_SUBST([srcraw], [${geocal_topdir}/geocal/thirdparty/libraw])
