...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__ImagePointDisplay_t swig_types[118]
...
#define SWIGTYPE_p_std__basic_iosT_char_std__char_traitsT_char_t_t swig_types[156]
