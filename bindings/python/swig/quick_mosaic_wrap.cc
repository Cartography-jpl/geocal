...
SWIGINTERN PyObject *_wrap_new_QuickMosaic__SWIG_0(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  ...
  if ((nobjs < 5) || (nobjs > 5)) SWIG_fail;
  {
    ...
    if (SWIG_IsOK(res1)) {
      ...
      if (!argp1) {
        SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "new_QuickMosaic" "', argument " "1"" of type '" "GeoCal::MapInfo const &""'"); 
      }
      if (newmem & SWIG_CAST_NEW_MEMORY) {
  ...
  }
  {
    ...
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "new_QuickMosaic" "', argument " "2"" of type '" "std::vector< boost::shared_ptr< GeoCal::RasterImage >,std::allocator< boost::shared_ptr< GeoCal::RasterImage > > > const &""'"); 
    }
    arg2 = ptr;
  }
