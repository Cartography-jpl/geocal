...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__IgcRollingShutter_t swig_types[187]
...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__NoVelocityAberration_t swig_types[203]
