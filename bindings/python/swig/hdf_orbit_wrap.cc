...
SWIGINTERN PyObject *_wrap_new_HdfOrbit_EciTod_TimeAcs(PyObject *self, PyObject *args) {
  ...
  if (!(argc = SWIG_Python_UnpackTuple(args,"new_HdfOrbit_EciTod_TimeAcs",0,2,argv))) SWIG_fail;
  --argc;
  if (argc == 1) {
...
SWIGINTERN PyObject *_wrap_new_HdfOrbit_Eci_TimePgs(PyObject *self, PyObject *args) {
  ...
  if (!(argc = SWIG_Python_UnpackTuple(args,"new_HdfOrbit_Eci_TimePgs",0,2,argv))) SWIG_fail;
  --argc;
  if (argc == 1) {
...
SWIGINTERN PyObject *_wrap_new_HdfOrbit_Eci_TimeJ2000(PyObject *self, PyObject *args) {
  ...
  if (!(argc = SWIG_Python_UnpackTuple(args,"new_HdfOrbit_Eci_TimeJ2000",0,2,argv))) SWIG_fail;
  --argc;
  if (argc == 1) {
