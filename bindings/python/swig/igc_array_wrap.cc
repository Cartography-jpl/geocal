...
#define SWIGTYPE_p_GeoCal__IgcArray swig_types[28]
...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__IgcArray_t swig_types[170]
...
SWIGINTERN PyObject *_wrap_new_IgcArray__SWIG_0(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  ...
  if ((nobjs < 2) || (nobjs > 2)) SWIG_fail;
  {
    ...
    if (!ptr) {
      SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "new_IgcArray" "', argument " "1"" of type '" "std::vector< boost::shared_ptr< GeoCal::ImageGroundConnection >,std::allocator< boost::shared_ptr< GeoCal::ImageGroundConnection > > > const &""'"); 
    }
    arg1 = ptr;
  }
