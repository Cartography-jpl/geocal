...
SWIGINTERN PyObject *_wrap_new_TleOrbit(PyObject *self, PyObject *args) {
  ...
  swig_obj[0] = args;
  {
    ...
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "new_TleOrbit" "', argument " "1"" of type '" "std::string const &""'"); 
    }
    arg1 = ptr;
  }
  {
...
SWIGINTERN PyObject *_wrap_TleOrbit_orbit_data__SWIG_0(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  ...
  }
  {
    ...
    if (!argp2) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "TleOrbit_orbit_data" "', argument " "2"" of type '" "GeoCal::Time""'");
    } else {
  ...
  {
    try {
      result = ((GeoCal::TleOrbit const *)arg1)->orbit_data(arg2);
    } catch (Swig::DirectorException &e) {
      SWIG_fail; 
    } catch (const std::exception& e) {
      SWIG_exception(SWIG_RuntimeError, e.what());
...
SWIGINTERN PyObject *_wrap_TleOrbit_orbit_data__SWIG_1(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  ...
  }
  {
    ...
    if (SWIG_IsOK(res2)) {
      ...
      if (!argp2) {
        SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "TleOrbit_orbit_data" "', argument " "2"" of type '" "GeoCal::TimeWithDerivative const &""'"); 
      }
      if (newmem & SWIG_CAST_NEW_MEMORY) {
