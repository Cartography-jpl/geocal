...
#define SWIGTYPE_p_GeoCal__OrbitQuaternionList swig_types[15]
...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__OrbitData_t swig_types[46]
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__OrbitQuaternionList_t swig_types[47]
