...
SWIGINTERN PyObject *_wrap_new_SubRasterImage__SWIG_1(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  ...
  }
  {
    ...
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "new_SubRasterImage" "', argument " "2"" of type '" "std::vector< boost::shared_ptr< GeoCal::GroundCoordinate >,std::allocator< boost::shared_ptr< GeoCal::GroundCoordinate > > > const &""'"); 
    }
    arg2 = ptr;
  }
  ecode3 = SWIG_AsVal_int(swig_obj[2], &val3);
