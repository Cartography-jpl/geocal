...
#define SWIGTYPE_p_std__allocatorT_boost__shared_ptrT_GeoCal__RasterImage_t_t swig_types[62]
...
#define SWIGTYPE_p_std__vectorT_boost__shared_ptrT_GeoCal__RasterImage_t_std__allocatorT_boost__shared_ptrT_GeoCal__RasterImage_t_t_t swig_types[68]
...
SWIGINTERN void std_vector_Sl_boost_shared_ptr_Sl_GeoCal_RasterImage_Sg__Sg____setslice____SWIG_0(std::vector< boost::shared_ptr< GeoCal::RasterImage > > *self,std::vector< boost::shared_ptr< GeoCal::RasterImage > >::difference_type i,std::vector< boost::shared_ptr< GeoCal::RasterImage > >::difference_type j,std::vector< boost::shared_ptr< GeoCal::RasterImage >,std::allocator< boost::shared_ptr< GeoCal::RasterImage > > > const &v=std::vector< boost::shared_ptr< GeoCal::RasterImage >,std::allocator< boost::shared_ptr< GeoCal::RasterImage > > >()){
...
SWIGINTERN PyObject *_wrap_Vector_RasterImage___setslice____SWIG_0(PyObject *SWIGUNUSEDPARM(self), int nobjs, PyObject **swig_obj) {
  ...
  }
  {
    try {
      try {
        std_vector_Sl_boost_shared_ptr_Sl_GeoCal_RasterImage_Sg__Sg____setslice____SWIG_0(arg1,arg2,arg3,(std::vector< boost::shared_ptr< GeoCal::RasterImage >,std::allocator< boost::shared_ptr< GeoCal::RasterImage > > > const &)*arg4);
      }
      catch(std::out_of_range &_e) {
        SWIG_exception_fail(SWIG_IndexError, (&_e)->what());
      }
...
SWIGINTERN PyObject *_wrap_Vector_RasterImage_insert__SWIG_0(PyObject *SWIGUNUSEDPARM(self), int nobjs, PyObject **swig_obj) {
  ...
  {
    try {
      result = (arg1)->insert(arg2,(std::vector< boost::shared_ptr< GeoCal::RasterImage > >::value_type const &)*arg3);
    } catch (const std::exception& e) {
      SWIG_exception(SWIG_RuntimeError, e.what());
    } catch (Swig::DirectorException &e) {
      SWIG_fail; 
...
SWIGINTERN PyObject *_wrap_Vector_RasterImage_insert__SWIG_1(PyObject *SWIGUNUSEDPARM(self), int nobjs, PyObject **swig_obj) {
  ...
  {
    try {
      (arg1)->insert(arg2,arg3,(std::vector< boost::shared_ptr< GeoCal::RasterImage > >::value_type const &)*arg4);
    } catch (const std::exception& e) {
      SWIG_exception(SWIG_RuntimeError, e.what());
    } catch (Swig::DirectorException &e) {
      SWIG_fail; 
