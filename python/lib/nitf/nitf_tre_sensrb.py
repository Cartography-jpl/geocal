...
desc = ["SENSRB",
        ...
        ["start_time", "Start Time", 14, int, {'condition' : "f.general_data == 'Y'"}],
        ["end_date", "End Date", 8, int, {'condition' : "f.general_data == 'Y'"}],
        ["end_time", "End Time", 14, int, {'condition' : "f.general_data == 'Y'"}],
        ...
        ["generation_time", "Generation Time", 10, int, {'condition' : "f.general_data == 'Y'"}],
        ...
        ["row_metric", "Row Metric", 8, int, {'condition' : "f.sensor_array_data == 'Y'"}],
        ["column_metric", "Column Metric", 8, int, {'condition' : "f.sensor_array_data == 'Y'"}],
        ["focal_length", "Focal Length", 8, int, {'condition' : "f.sensor_array_data == 'Y'"}],
        ["row_fov", "Row Field of View", 8, int, {'condition' : "f.sensor_array_data == 'Y'"}],
        ["column_fov", "Column Field of View", 8, int, {'condition' : "f.sensor_array_data == 'Y'"}],
