...
_camera.SHARED_PTR_DISOWN_swigconstant(_camera)
...
class Camera(ObservableCamera, geocal_swig.with_parameter.WithParameter):
    ...
    def integration_time(self, Band):
        ...
        """
        return _camera.Camera_integration_time(self, Band)
    ...
    def frame_coordinate(self, Sl, Band):
        ...
        is not seen). 
        """
        return _camera.Camera_frame_coordinate(self, Sl, Band)
    ...
    def frame_coordinate_with_derivative(self, Sl, Band):
        ...
        parameters. 
        """
        return _camera.Camera_frame_coordinate_with_derivative(self, Sl, Band)


    def frame_line_coordinate(self, Sl, Band):
        """
        ...
        """
        return _camera.Camera_frame_line_coordinate(self, Sl, Band)
    ...
    def sc_look_vector(self, F, Band):
        ...
        """
        return _camera.Camera_sc_look_vector(self, F, Band)
