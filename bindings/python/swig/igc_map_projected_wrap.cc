...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__IgcMapProjectedMultiBand_t swig_types[169]
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__IgcMapProjected_t swig_types[170]
