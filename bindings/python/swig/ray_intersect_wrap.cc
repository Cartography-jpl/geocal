...
# endif
  ...
  GeoCal::SwigTypeMapperBase::add(typeid(GeoCal::RayIntersect), boost::make_shared<GeoCal::SwigTypeMapper< GeoCal::RayIntersect > > ("boost::shared_ptr< GeoCal::RayIntersect > *"));
