...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__OrbitTimeShift_t swig_types[95]
...
# endif
  ...
  GeoCal::swig_type_map[GeoCal::type_index(typeid(GeoCal::OrbitTimeShift))] =
  boost::shared_ptr<GeoCal::SwigTypeMapperBase>(new GeoCal::SwigTypeMapper< GeoCal::OrbitTimeShift >("boost::shared_ptr< GeoCal::OrbitTimeShift > *"));
