...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__LnLookVectorWithDerivative_t swig_types[106]
...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__Refraction_t swig_types[110]
