...
SWIGINTERN PyObject *_wrap_SpotOrbit_orbit_data__SWIG_0(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  ...
  }
  {
    ...
    if (!argp2) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "SpotOrbit_orbit_data" "', argument " "2"" of type '" "GeoCal::Time""'");
    } else {
  ...
  {
    try {
      result = ((GeoCal::SpotOrbit const *)arg1)->orbit_data(arg2);
...
SWIGINTERN PyObject *_wrap_SpotOrbit_orbit_data__SWIG_1(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  ...
  }
  {
    ...
    if (SWIG_IsOK(res2)) {
      ...
      if (!argp2) {
        SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "SpotOrbit_orbit_data" "', argument " "2"" of type '" "GeoCal::TimeWithDerivative const &""'"); 
      }
      if (newmem & SWIG_CAST_NEW_MEMORY) {
