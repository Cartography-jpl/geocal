...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__SpotCamera_t swig_types[74]
...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__WithParameterNested_t swig_types[77]
