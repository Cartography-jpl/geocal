...
check_6:
  ...
  if (argc == 4) {
    ...
    if (!_v) goto check_7;
    PyObject *retobj = _wrap_new_GdalMultiBand__SWIG_14(self, argc, argv);
    if (!SWIG_Python_TypeErrorOccurred(retobj)) return retobj;
    SWIG_fail;
  }
check_7:
  ...
  if (argc == 4) {
    PyObject *retobj = _wrap_new_GdalMultiBand__SWIG_8(self, argc, argv);
    if (!SWIG_Python_TypeErrorOccurred(retobj)) return retobj;
    SWIG_fail;
  }
  if (argc == 5) {
...
check_11:
  ...
  if (argc == 6) {
    ...
    if (!_v) goto check_12;
    PyObject *retobj = _wrap_new_GdalMultiBand__SWIG_6(self, argc, argv);
    if (!SWIG_Python_TypeErrorOccurred(retobj)) return retobj;
    SWIG_fail;
  }
check_12:
...
check_15:
  ...
  if (argc == 8) {
    ...
    if (!_v) goto check_17;
    PyObject *retobj = _wrap_new_GdalMultiBand__SWIG_10(self, argc, argv);
    if (!SWIG_Python_TypeErrorOccurred(retobj)) return retobj;
    SWIG_fail;
  }
check_17:
  ...
  if (argc == 8) {
    ...
    if (!_v) goto check_18;
    PyObject *retobj = _wrap_new_GdalMultiBand__SWIG_4(self, argc, argv);
    if (!SWIG_Python_TypeErrorOccurred(retobj)) return retobj;
    SWIG_fail;
  }
check_18:
  ...
  if (argc == 10) {
    PyObject *retobj = _wrap_new_GdalMultiBand__SWIG_16(self, argc, argv);
    if (!SWIG_Python_TypeErrorOccurred(retobj)) return retobj;
    SWIG_fail;
  }
