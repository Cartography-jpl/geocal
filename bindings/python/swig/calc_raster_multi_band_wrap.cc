...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__TimeWithDerivative_t swig_types[72]
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__Time_t swig_types[73]
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__VicarImageCoordinate_t swig_types[74]
