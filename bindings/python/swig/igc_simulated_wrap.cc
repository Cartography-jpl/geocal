...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__IgcSimulated_t swig_types[89]
...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__RasterImageVariable_t swig_types[106]
