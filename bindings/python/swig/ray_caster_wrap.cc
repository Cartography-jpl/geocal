...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "RayCaster__v_cartesian_fixed", _wrap_RayCaster__v_cartesian_fixed, METH_O, "\n"
		...
		"The CartesianFixed object that we are using for the RayCaster, for example Ecr for the earth.\n"
		"\n"
		""},
	 ...
	 { "RayCaster__v_last_position", _wrap_RayCaster__v_last_position, METH_O, "\n"
		...
		"Returns true when we have stepped through all positions from start_position() to start_position() + number_position() - 1.\n"
		"\n"
		""},
	 ...
	 { "RayCaster_next_radiance", _wrap_RayCaster_next_radiance, METH_VARARGS, "\n"
		...
		"modifications to the underlying data. \n"
		""},
	 { "RayCaster___str__", _wrap_RayCaster___str__, METH_O, NULL},
	 { "delete_RayCaster", _wrap_delete_RayCaster, METH_O, "\n"
		"\n"
		"virtual GeoCal::RayCaster::~RayCaster()\n"
