...
#define SWIGTYPE_p_GeoCal__InterestPoint swig_types[20]
...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__InterestPoint_t swig_types[78]
...
#define SWIGTYPE_p_std__allocatorT_GeoCal__InterestPoint_t swig_types[105]
...
#define SWIGTYPE_p_std__vectorT_GeoCal__InterestPoint_std__allocatorT_GeoCal__InterestPoint_t_t swig_types[111]
...
SWIGINTERN void std_vector_Sl_GeoCal_InterestPoint_Sg____setslice____SWIG_0(std::vector< GeoCal::InterestPoint > *self,std::vector< GeoCal::InterestPoint >::difference_type i,std::vector< GeoCal::InterestPoint >::difference_type j,std::vector< GeoCal::InterestPoint,std::allocator< GeoCal::InterestPoint > > const &v=std::vector< GeoCal::InterestPoint,std::allocator< GeoCal::InterestPoint > >()){
...
SWIGINTERN PyObject *_wrap_Vector_InterestPoint___setslice____SWIG_0(PyObject *SWIGUNUSEDPARM(self), int nobjs, PyObject **swig_obj) {
  ...
  }
  {
    try {
      try {
        std_vector_Sl_GeoCal_InterestPoint_Sg____setslice____SWIG_0(arg1,arg2,arg3,(std::vector< GeoCal::InterestPoint,std::allocator< GeoCal::InterestPoint > > const &)*arg4);
      }
      catch(std::out_of_range &_e) {
        SWIG_exception_fail(SWIG_IndexError, (&_e)->what());
      }
