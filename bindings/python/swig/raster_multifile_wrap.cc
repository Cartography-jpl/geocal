...
# endif
  ...
  GeoCal::swig_type_map[GeoCal::type_index(typeid(GeoCal::RasterMultifile))] =
  boost::shared_ptr<GeoCal::SwigTypeMapperBase>(new GeoCal::SwigTypeMapper< GeoCal::RasterMultifile >("boost::shared_ptr< GeoCal::RasterMultifile > *"));
