...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__QuaternionCamera_t swig_types[32]
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__ScLookVector_t swig_types[33]
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__SimpleCamera_t swig_types[34]
