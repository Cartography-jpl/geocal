...
inline std::string
MSPI::Shared::L1B1File::granule_id() const
{
...
inline void
MSPI::Shared::L1B1File::add_meta(const Meta& Meta)
{
...
MSPI::Shared::L1B1File::meta() const
{
  return meta_;
}
...
inline size_t
MSPI::Shared::L1B1File::number_frame(
  int Row_number
) const
{
...
inline size_t
MSPI::Shared::L1B1File::number_pixel() const
{
...
inline float
MSPI::Shared::L1B1File::wavelength(int Row_number) const
{
...
inline float
MSPI::Shared::L1B1File::polarization_angle(int Row_number) const
{
...
inline std::string 
MSPI::Shared::L1B1File::swath_name(int Row_number) const
{
...
MSPI::Shared::L1B1File::row_numbers() const
{
...
MSPI::Shared::L1B1File::field_names(int Row_number) const
{
...
inline std::string
MSPI::Shared::L1B1File::epoch() const
{
...
inline void
MSPI::Shared::L1B1File::epoch(const std::string& Epoch)
{
