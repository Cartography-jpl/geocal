...
SWIGINTERN PyObject *_wrap_Vector_RasterImage___getitem____SWIG_0(PyObject *SWIGUNUSEDPARM(self), int nobjs, PyObject **swig_obj) {
  ...
  resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_std__vectorT_boost__shared_ptrT_GeoCal__RasterImage_t_std__allocatorT_boost__shared_ptrT_GeoCal__RasterImage_t_t_t, 0 |  0 );
  return resultobj;
fail:
  return NULL;
}
