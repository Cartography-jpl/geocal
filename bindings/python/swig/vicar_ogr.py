...
from ._swig_wrap import _vicar_ogr
...
_swig_new_instance_method = _vicar_ogr.SWIG_PyInstanceMethod_New
_swig_new_static_method = _vicar_ogr.SWIG_PyStaticMethod_New
...
class SwigPyIterator(object):
    ...
    value = _swig_new_instance_method(_vicar_ogr.SwigPyIterator_value)
    incr = _swig_new_instance_method(_vicar_ogr.SwigPyIterator_incr)
    decr = _swig_new_instance_method(_vicar_ogr.SwigPyIterator_decr)
    distance = _swig_new_instance_method(_vicar_ogr.SwigPyIterator_distance)
    equal = _swig_new_instance_method(_vicar_ogr.SwigPyIterator_equal)
    copy = _swig_new_instance_method(_vicar_ogr.SwigPyIterator_copy)
    next = _swig_new_instance_method(_vicar_ogr.SwigPyIterator_next)
    __next__ = _swig_new_instance_method(_vicar_ogr.SwigPyIterator___next__)
    previous = _swig_new_instance_method(_vicar_ogr.SwigPyIterator_previous)
    advance = _swig_new_instance_method(_vicar_ogr.SwigPyIterator_advance)
    __eq__ = _swig_new_instance_method(_vicar_ogr.SwigPyIterator___eq__)
    __ne__ = _swig_new_instance_method(_vicar_ogr.SwigPyIterator___ne__)
    __iadd__ = _swig_new_instance_method(_vicar_ogr.SwigPyIterator___iadd__)
    __isub__ = _swig_new_instance_method(_vicar_ogr.SwigPyIterator___isub__)
    __add__ = _swig_new_instance_method(_vicar_ogr.SwigPyIterator___add__)
    __sub__ = _swig_new_instance_method(_vicar_ogr.SwigPyIterator___sub__)
    def __iter__(self):
        return self
...
class VicarOgr(geocal_swig.generic_object.GenericObject):
    ...
    from_vicar = _swig_new_instance_method(_vicar_ogr.VicarOgr_from_vicar)
    to_vicar = _swig_new_instance_method(_vicar_ogr.VicarOgr_to_vicar)
    __swig_destroy__ = _vicar_ogr.delete_VicarOgr

# Register VicarOgr in _vicar_ogr:
_vicar_ogr.VicarOgr_swigregister(VicarOgr)
