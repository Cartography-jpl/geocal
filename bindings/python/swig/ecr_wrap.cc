...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__Ecr_t swig_types[39]
...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__ScLookVectorWithDerivative_t swig_types[46]
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__ScLookVector_t swig_types[47]
