...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__QuaternionCamera_t swig_types[45]
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__QuickBirdCamera_t swig_types[46]
