...
SWIGINTERN PyObject *_wrap_MapReprojectedImage_write(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  GeoCal::MapReprojectedImage *arg1 = (GeoCal::MapReprojectedImage *) 0 ;
  int arg2 ;
  int arg3 ;
  ...
  if (!SWIG_Python_UnpackTuple(args,"MapReprojectedImage_write",4,4,swig_obj)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_GeoCal__MapReprojectedImage_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "MapReprojectedImage_write" "', argument " "1"" of type '" "GeoCal::MapReprojectedImage *""'"); 
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
  ...
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "MapReprojectedImage_write" "', argument " "2"" of type '" "int""'");
  } 
  arg2 = static_cast< int >(val2);
  ecode3 = SWIG_AsVal_int(swig_obj[2], &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "MapReprojectedImage_write" "', argument " "3"" of type '" "int""'");
  } 
  arg3 = static_cast< int >(val3);
  ecode4 = SWIG_AsVal_int(swig_obj[3], &val4);
  if (!SWIG_IsOK(ecode4)) {
    SWIG_exception_fail(SWIG_ArgError(ecode4), "in method '" "MapReprojectedImage_write" "', argument " "4"" of type '" "int""'");
  } 
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"MapReprojectedImage__v_raw_image", (PyCFunction)_wrap_MapReprojectedImage__v_raw_image, METH_O, (char *)"\n"
		...
		"\n"
		""},
	 { (char *)"MapReprojectedImage_write", _wrap_MapReprojectedImage_write, METH_VARARGS, NULL},
