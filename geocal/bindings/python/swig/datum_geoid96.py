...
if version_info >= (3,0,0):
    new_instancemethod = lambda func, inst, cls: _datum_geoid96.SWIG_PyInstanceMethod_New(func)
else:
...
if version_info >= (2,6,0):
    def swig_import_helper():
        ...
        fp = None
        try:
            fp, pathname, description = imp.find_module('_datum_geoid96', [dirname(__file__)])
        except ImportError:
            import _datum_geoid96
            return _datum_geoid96
        if fp is not None:
            try:
                _mod = imp.load_module('_datum_geoid96', fp, pathname, description)
            finally:
                fp.close()
            return _mod
    _datum_geoid96 = swig_import_helper()
...
class DatumGeoid96(geocal.geocal_datum.Datum):
    ...
    def __init__(self, Fname=""): 
        ...
        """
        _datum_geoid96.DatumGeoid96_swiginit(self,_datum_geoid96.new_DatumGeoid96(Fname))
    def _v_file_name(self):
        """
        const std::string& GeoCal::DatumGeoid96::file_name() const

        """
        return _datum_geoid96.DatumGeoid96__v_file_name(self)
...
DatumGeoid96_swigregister = _datum_geoid96.DatumGeoid96_swigregister
