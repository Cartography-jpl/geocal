...
SWIGINTERN PyObject *_wrap_geocal_version(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  std::string result;
  
  (void)self;
  if (!SWIG_Python_UnpackTuple(args, "geocal_version", 0, 0, 0)) SWIG_fail;
  {
    try {
      result = GeoCal::geocal_version();
...
SWIGINTERN PyObject *_wrap_delete_GenericObject(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  GeoCal::GenericObject *arg1 = (GeoCal::GenericObject *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  boost::shared_ptr< GeoCal::GenericObject > tempshared1 ;
  boost::shared_ptr< GeoCal::GenericObject > *smartarg1 = 0 ;
  PyObject *swig_obj[1] ;
  ...
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_GeoCal__GenericObject_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_GenericObject" "', argument " "1"" of type '" "GeoCal::GenericObject *""'");
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
      tempshared1 = *reinterpret_cast< boost::shared_ptr<  GeoCal::GenericObject > * >(argp1);
      delete reinterpret_cast< boost::shared_ptr<  GeoCal::GenericObject > * >(argp1);
      arg1 = const_cast< GeoCal::GenericObject * >(tempshared1.get());
    } else {
      smartarg1 = reinterpret_cast< boost::shared_ptr<  GeoCal::GenericObject > * >(argp1);
      arg1 = const_cast< GeoCal::GenericObject * >((smartarg1 ? smartarg1->get() : 0));
    }
  }
  {
    try {
...
SWIGINTERN PyObject *_wrap_new_GenericObject(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  GeoCal::GenericObject *result = 0 ;
  
  (void)self;
  if (!SWIG_Python_UnpackTuple(args, "new_GenericObject", 0, 0, 0)) SWIG_fail;
  {
    try {
      result = (GeoCal::GenericObject *)new GeoCal::GenericObject();
    } catch (Swig::DirectorException &e) {
      SWIG_fail; 
    } catch (const std::exception& e) {
      SWIG_exception(SWIG_RuntimeError, e.what());
  ...
  {
    boost::shared_ptr<  GeoCal::GenericObject > *smartresult = result ? new boost::shared_ptr<  GeoCal::GenericObject >(result SWIG_NO_NULL_DELETER_SWIG_POINTER_NEW) : 0;
    resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(smartresult), SWIGTYPE_p_boost__shared_ptrT_GeoCal__GenericObject_t, SWIG_POINTER_NEW | SWIG_POINTER_OWN);
  }
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *GenericObject_swigregister(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *obj = NULL;
  if (!SWIG_Python_UnpackTuple(args, "swigregister", 1, 1, &obj)) return NULL;
  SWIG_TypeNewClientData(SWIGTYPE_p_boost__shared_ptrT_GeoCal__GenericObject_t, SWIG_NewClientData(obj));
  return SWIG_Py_Void();
}

SWIGINTERN PyObject *GenericObject_swiginit(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "geocal_version", _wrap_geocal_version, METH_NOARGS, "\n"
		"geocal_version() -> std::string\n"
		"\n"
		"GeoCal::geocal_version\n"
		"Geocal library version number.  \n"
		"\n"
		""},
	 { "delete_GenericObject", _wrap_delete_GenericObject, METH_O, "\n"
		"delete_GenericObject(GenericObject self)\n"
		"\n"
		"GeoCal::GenericObject::~GenericObject\n"
		""},
	 { "new_GenericObject", _wrap_new_GenericObject, METH_NOARGS, "new_GenericObject() -> GenericObject"},
	 { "GenericObject_swigregister", GenericObject_swigregister, METH_O, NULL},
	 { "GenericObject_swiginit", GenericObject_swiginit, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
