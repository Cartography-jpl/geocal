...
SWIGINTERN PyObject *_wrap_new_MapReprojectedImage(PyObject *self, PyObject *args) {
  ...
  }
  {
    ...
    if (SWIG_IsOK(res2)) {
      ...
      if (!argp2) {
        SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "new_MapReprojectedImage" "', argument " "2"" of type '" "GeoCal::MapInfo const &""'"); 
      }
      if (newmem & SWIG_CAST_NEW_MEMORY) {
  ...
  {
    try {
      result = (GeoCal::MapReprojectedImage *)new GeoCal::MapReprojectedImage(arg1,(GeoCal::MapInfo const &)*arg2);
