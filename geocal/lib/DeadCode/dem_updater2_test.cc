...
BOOST_AUTO_TEST_SUITE(dem_update2)
...
BOOST_AUTO_TEST_CASE(basic_test)
{
  ...
  boost::shared_ptr<MapProjectedImage> img1(new GdalMapProjectedImage("/Users/smyth/image_refsurf1.img"));
  boost::shared_ptr<MapProjectedImage> img2(new GdalMapProjectedImage("/Users/smyth/image_refsurf2.img"));
  Rpc r1, r2;
  ...
  DemUpdater2 u(img1, img2, r1, r2, d);
  std::cerr << u.compare_image(781, 1277, 783.0) << "\n";
  double height, max_corr;
  bool success;
  u.find_height(781, 1277, -9999, height, success, &max_corr);
  std::cerr << height << "\n";
  std::cerr << max_corr << "\n";
  std::cerr << u.height(781, 1277) << "\n";
}
