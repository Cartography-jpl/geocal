...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__ArgusCamera_t swig_types[29]
...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__LookVectorT_double_t_t swig_types[38]
