...
#define SWIGTYPE_p_GeoCal__GeoCalTempFile swig_types[1]
...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__GeoCalTempFile_t swig_types[77]
...
/*-----------------------------------------------
              @(target):= _geocal_temp_file.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__geocal_temp_file

#else
#  define SWIG_init    init_geocal_temp_file

#endif
#define SWIG_name    "_geocal_temp_file"
...
#include "geocal_temp_file_wrap.h"
...
SWIGINTERN PyObject *_wrap_new_GeoCalTempFile(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  GeoCal::GeoCalTempFile *result = 0 ;
  
  if (!SWIG_Python_UnpackTuple(args,"new_GeoCalTempFile",0,0,0)) SWIG_fail;
  {
    try {
      result = (GeoCal::GeoCalTempFile *)new GeoCal::GeoCalTempFile();
  ...
  {
    boost::shared_ptr<  GeoCal::GeoCalTempFile > *smartresult = result ? new boost::shared_ptr<  GeoCal::GeoCalTempFile >(result SWIG_NO_NULL_DELETER_SWIG_POINTER_NEW) : 0;
    resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(smartresult), SWIGTYPE_p_boost__shared_ptrT_GeoCal__GeoCalTempFile_t, SWIG_POINTER_NEW | SWIG_POINTER_OWN);
  }
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_GeoCalTempFile__v_temp_fname(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  GeoCal::GeoCalTempFile *arg1 = (GeoCal::GeoCalTempFile *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  boost::shared_ptr< GeoCal::GeoCalTempFile const > tempshared1 ;
  boost::shared_ptr< GeoCal::GeoCalTempFile const > *smartarg1 = 0 ;
  PyObject *swig_obj[1] ;
  std::string result;
  ...
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_GeoCal__GeoCalTempFile_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "GeoCalTempFile__v_temp_fname" "', argument " "1"" of type '" "GeoCal::GeoCalTempFile const *""'");
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
      tempshared1 = *reinterpret_cast< boost::shared_ptr< const GeoCal::GeoCalTempFile > * >(argp1);
      delete reinterpret_cast< boost::shared_ptr< const GeoCal::GeoCalTempFile > * >(argp1);
      arg1 = const_cast< GeoCal::GeoCalTempFile * >(tempshared1.get());
    } else {
      smartarg1 = reinterpret_cast< boost::shared_ptr< const GeoCal::GeoCalTempFile > * >(argp1);
      arg1 = const_cast< GeoCal::GeoCalTempFile * >((smartarg1 ? smartarg1->get() : 0));
    }
  }
  {
    try {
      result = ((GeoCal::GeoCalTempFile const *)arg1)->temp_fname();
    } catch (Swig::DirectorException &e) {
      SWIG_fail; 
    } catch (const std::exception& e) {
      SWIG_exception(SWIG_RuntimeError, e.what());
...
SWIGINTERN PyObject *_wrap_delete_GeoCalTempFile(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  GeoCal::GeoCalTempFile *arg1 = (GeoCal::GeoCalTempFile *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  boost::shared_ptr< GeoCal::GeoCalTempFile > tempshared1 ;
  boost::shared_ptr< GeoCal::GeoCalTempFile > *smartarg1 = 0 ;
  PyObject *swig_obj[1] ;
  ...
  swig_obj[0] = args;
  {
    ...
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_GeoCal__GeoCalTempFile_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_GeoCalTempFile" "', argument " "1"" of type '" "GeoCal::GeoCalTempFile *""'");
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
      tempshared1 = *reinterpret_cast< boost::shared_ptr<  GeoCal::GeoCalTempFile > * >(argp1);
      delete reinterpret_cast< boost::shared_ptr<  GeoCal::GeoCalTempFile > * >(argp1);
      arg1 = const_cast< GeoCal::GeoCalTempFile * >(tempshared1.get());
    } else {
      smartarg1 = reinterpret_cast< boost::shared_ptr<  GeoCal::GeoCalTempFile > * >(argp1);
      arg1 = const_cast< GeoCal::GeoCalTempFile * >((smartarg1 ? smartarg1->get() : 0));
    }
  }
  {
...
SWIGINTERN PyObject *GeoCalTempFile_swigregister(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *obj;
  if (!SWIG_Python_UnpackTuple(args,(char *)"swigregister", 1, 1,&obj)) return NULL;
  SWIG_TypeNewClientData(SWIGTYPE_p_boost__shared_ptrT_GeoCal__GeoCalTempFile_t, SWIG_NewClientData(obj));
  return SWIG_Py_Void();
}

SWIGINTERN PyObject *GeoCalTempFile_swiginit(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"new_GeoCalTempFile", (PyCFunction)_wrap_new_GeoCalTempFile, METH_NOARGS, (char *)"\n"
		"\n"
		"GeoCal::GeoCalTempFile::GeoCalTempFile()\n"
		"\n"
		""},
	 { (char *)"GeoCalTempFile__v_temp_fname", (PyCFunction)_wrap_GeoCalTempFile__v_temp_fname, METH_O, (char *)"\n"
		"\n"
		"const std::string& GeoCal::GeoCalTempFile::temp_fname() const\n"
		"\n"
		""},
	 { (char *)"delete_GeoCalTempFile", (PyCFunction)_wrap_delete_GeoCalTempFile, METH_O, (char *)"\n"
		"\n"
		"virtual GeoCal::GeoCalTempFile::~GeoCalTempFile()\n"
		"\n"
		""},
	 { (char *)"GeoCalTempFile_swigregister", GeoCalTempFile_swigregister, METH_VARARGS, NULL},
	 { (char *)"GeoCalTempFile_swiginit", GeoCalTempFile_swiginit, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
...
static void *_p_boost__shared_ptrT_GeoCal__GeoCalTempFile_tTo_p_boost__shared_ptrT_GeoCal__GenericObject_t(void *x, int *newmemory) {
    *newmemory = SWIG_CAST_NEW_MEMORY;
    return (void *) new boost::shared_ptr< GeoCal::GenericObject >(*(boost::shared_ptr< GeoCal::GeoCalTempFile > *)x);
}
static void *_p_GeoCal__GeoCalTempFileTo_p_GeoCal__GenericObject(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((GeoCal::GenericObject *)  ((GeoCal::GeoCalTempFile *) x));
}
...
static swig_type_info _swigt__p_GeoCal__GeoCalTempFile = {"_p_GeoCal__GeoCalTempFile", "GeoCal::GeoCalTempFile *", 0, 0, (void*)0, 0};
...
static swig_type_info _swigt__p_boost__shared_ptrT_GeoCal__GeoCalTempFile_t = {"_p_boost__shared_ptrT_GeoCal__GeoCalTempFile_t", "boost::shared_ptr< GeoCal::GeoCalTempFile > *", 0, 0, (void*)0, 0};
...
static swig_type_info *swig_type_initial[] = {
  ...
  &_swigt__p_GeoCal__GeoCalTempFile,
  ...
  &_swigt__p_boost__shared_ptrT_GeoCal__GeoCalTempFile_t,
  &_swigt__p_char,
  &_swigt__p_char_type,
...
static swig_cast_info _swigc__p_GeoCal__GenericObject[] = {  {&_swigt__p_GeoCal__GenericObject, 0, 0, 0},  {&_swigt__p_GeoCal__GeoCalTempFile, _p_GeoCal__GeoCalTempFileTo_p_GeoCal__GenericObject, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_GeoCal__GeoCalTempFile[] = {  {&_swigt__p_GeoCal__GeoCalTempFile, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_boost__shared_ptrT_GeoCal__GenericObject_t[] = {  {&_swigt__p_boost__shared_ptrT_GeoCal__GenericObject_t, 0, 0, 0},  {&_swigt__p_boost__shared_ptrT_GeoCal__GeoCalTempFile_t, _p_boost__shared_ptrT_GeoCal__GeoCalTempFile_tTo_p_boost__shared_ptrT_GeoCal__GenericObject_t, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_boost__shared_ptrT_GeoCal__GeoCalTempFile_t[] = {  {&_swigt__p_boost__shared_ptrT_GeoCal__GeoCalTempFile_t, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info *swig_cast_initial[] = {
  ...
  _swigc__p_GeoCal__GeoCalTempFile,
  ...
  _swigc__p_boost__shared_ptrT_GeoCal__GeoCalTempFile_t,
  _swigc__p_char,
  _swigc__p_char_type,
...
# endif
  ...
  GeoCal::SwigTypeMapperBase::add(typeid(GeoCal::GeoCalTempFile), boost::make_shared<GeoCal::SwigTypeMapper< GeoCal::GeoCalTempFile > > ("boost::shared_ptr< GeoCal::GeoCalTempFile > *"));
