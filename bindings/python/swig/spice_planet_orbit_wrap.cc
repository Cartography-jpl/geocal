...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__SpiceKernelList_t swig_types[150]
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__SpicePlanetOrbit_t swig_types[151]
