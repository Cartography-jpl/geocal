...
#define SWIG_name    "_nitf_support"
/* -----------------------------------------------------------------------------
...
#define SWIGTYPE_p_boost__math__quaternionT_double_t swig_types[77]
...
/*-----------------------------------------------
              @(target):= _nitf_support.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__nitf_support

#else
#  define SWIG_init    init_nitf_support
...
SWIGINTERN PyObject *_wrap_nitf_to_quaternion(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  ...
  swig_obj[0] = args;
  {
    ...
    if(!SWIG_IsOK(res)) {
      ...
      if(!numpy1.obj) {
        SWIG_Error(SWIG_TypeError, "in method 'nitf_to_quaternion', expecting type  Array<double,1>");
        return NULL;
      }
  ...
  {
    try {
      result = GeoCal::nitf_to_quaternion((blitz::Array< double,1 > const &)*arg1);
...
SWIGINTERN PyObject *_wrap_quaternion_to_nitf__SWIG_0(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  ...
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "quaternion_to_nitf" "', argument " "1"" of type '" "boost::math::quaternion< double > const &""'"); 
  }
  if (!argp1) {
    SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "quaternion_to_nitf" "', argument " "1"" of type '" "boost::math::quaternion< double > const &""'"); 
  }
  arg1 = reinterpret_cast< boost::math::quaternion< double > * >(argp1);
  {
    try {
      result = GeoCal::quaternion_to_nitf((boost::math::quaternion< double > const &)*arg1);
    } catch (Swig::DirectorException &e) {
      SWIG_fail; 
    } catch (const std::exception& e) {
      SWIG_exception(SWIG_RuntimeError, e.what());
...
SWIGINTERN PyObject *_wrap_quaternion_to_nitf__SWIG_1(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  blitz::Array< double,1 > *arg1 = 0 ;
  blitz::Array< double,1 > a1 ;
  PythonObject numpy1 ;
  ...
  if ((nobjs < 1) || (nobjs > 1)) SWIG_fail;
  {
    ...
    if(!SWIG_IsOK(res)) {
      numpy1.obj = to_numpy<double >(swig_obj[0]);
      if(!numpy1.obj) {
        SWIG_Error(SWIG_TypeError, "in method 'quaternion_to_nitf', expecting type  Array<double,1>");
        return NULL;
      }
      if(PyArray_NDIM((PyArrayObject*)numpy1.obj) !=1) {
        SWIG_Error(SWIG_TypeError, "in method 'quaternion_to_nitf', expecting type  Array<double,1>");
  ...
  {
    try {
      result = GeoCal::quaternion_to_nitf((blitz::Array< double,1 > const &)*arg1);
    } catch (Swig::DirectorException &e) {
      SWIG_fail; 
    } catch (const std::exception& e) {
      SWIG_exception(SWIG_RuntimeError, e.what());
...
SWIGINTERN PyObject *_wrap_quaternion_to_nitf__SWIG_2(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  ...
  if ((nobjs < 1) || (nobjs > 1)) SWIG_fail;
  {
    ...
    if(!SWIG_IsOK(res)) {
      numpy1.obj = to_numpy<double >(swig_obj[0]);
      if(!numpy1.obj) {
        SWIG_Error(SWIG_TypeError, "in method 'quaternion_to_nitf', expecting type  Array<double,2>");
        return NULL;
      }
  ...
  {
    try {
      result = GeoCal::quaternion_to_nitf((blitz::Array< double,2 > const &)*arg1);
    } catch (Swig::DirectorException &e) {
      SWIG_fail; 
    } catch (const std::exception& e) {
      SWIG_exception(SWIG_RuntimeError, e.what());
...
SWIGINTERN PyObject *_wrap_quaternion_to_nitf(PyObject *self, PyObject *args) {
  Py_ssize_t argc;
  PyObject *argv[2] = {
    0
  };
  
  if (!(argc = SWIG_Python_UnpackTuple(args, "quaternion_to_nitf", 0, 1, argv))) SWIG_fail;
  --argc;
  if (argc == 1) {
    int _v = 0;
    {
    ...
    if (!_v) goto check_1;
    return _wrap_quaternion_to_nitf__SWIG_0(self, argc, argv);
  }
check_1:
  ...
  if (argc == 1) {
    ...
    if (!_v) goto check_2;
    return _wrap_quaternion_to_nitf__SWIG_1(self, argc, argv);
  }
check_2:
  
  if (argc == 1) {
    PyObject *retobj = _wrap_quaternion_to_nitf__SWIG_2(self, argc, argv);
    if (!SWIG_Python_TypeErrorOccurred(retobj)) return retobj;
    SWIG_fail;
  }
  
fail:
  SWIG_Python_RaiseOrModifyTypeError("Wrong number or type of arguments for overloaded function 'quaternion_to_nitf'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    GeoCal::quaternion_to_nitf(boost::math::quaternion< double > const &)\n"
    "    GeoCal::quaternion_to_nitf(blitz::Array< double,1 > const &)\n"
    "    GeoCal::quaternion_to_nitf(blitz::Array< double,2 > const &)\n");
  return 0;
}
