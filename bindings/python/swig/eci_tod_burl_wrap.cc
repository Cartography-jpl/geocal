...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__EciTodBurl_t swig_types[57]
...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__LnLookVectorWithDerivative_t swig_types[60]
