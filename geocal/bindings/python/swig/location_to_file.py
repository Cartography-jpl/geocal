...
if version_info >= (3,0,0):
    new_instancemethod = lambda func, inst, cls: _location_to_file.SWIG_PyInstanceMethod_New(func)
else:
...
if version_info >= (2,6,0):
    def swig_import_helper():
        ...
        fp = None
        try:
            fp, pathname, description = imp.find_module('_location_to_file', [dirname(__file__)])
        except ImportError:
            import _location_to_file
            return _location_to_file
        if fp is not None:
            try:
                _mod = imp.load_module('_location_to_file', fp, pathname, description)
            finally:
                fp.close()
            return _mod
    _location_to_file = swig_import_helper()
...
LocationToFile_swigregister = _location_to_file.LocationToFile_swigregister
