...
#define SWIGTYPE_p_GeoCal__WorldView2CloudMask swig_types[65]
...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__WorldView2CloudMask_t swig_types[208]
...
SWIGINTERN PyObject *_wrap_new_WorldView2CloudMask(PyObject *self, PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "new_WorldView2CloudMask", 4, 4, swig_obj)) SWIG_fail;
  {
    ...
    if (SWIG_IsOK(res1)) {
      ...
      if (!argp1) {
        SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "new_WorldView2CloudMask" "', argument " "1"" of type '" "GeoCal::RasterImageMultiBand const &""'"); 
      }
      if (newmem & SWIG_CAST_NEW_MEMORY) {
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "new_WorldView2CloudMask", _wrap_new_WorldView2CloudMask, METH_VARARGS, "\n"
		"new_WorldView2CloudMask(RasterImageMultiBand Mul_spec_data, int Min_cloud_size, double Cloud_threshold, double Shadow_threshold) -> WorldView2CloudMask\n"
		"\n"
	 ...
	 { "delete_WorldView2CloudMask", _wrap_delete_WorldView2CloudMask, METH_O, "\n"
		"delete_WorldView2CloudMask(WorldView2CloudMask self)\n"
		"\n"
		"GeoCal::WorldView2CloudMask::~WorldView2CloudMask\n"
		""},
