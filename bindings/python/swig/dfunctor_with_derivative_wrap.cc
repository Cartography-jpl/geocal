...
SWIGINTERN PyObject *_wrap_DFunctorWithDerivative_df(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
...
SWIGINTERN PyObject *_wrap_DFunctorWithDerivative_f_with_derivative(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  GeoCal::DFunctorWithDerivative *arg1 = (GeoCal::DFunctorWithDerivative *) 0 ;
  double arg2 ;
  void *argp1 = 0 ;
...
SWIGINTERN PyObject *_wrap_delete_DFunctorWithDerivative(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  GeoCal::DFunctorWithDerivative *arg1 = (GeoCal::DFunctorWithDerivative *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "DFunctorWithDerivative_df", _wrap_DFunctorWithDerivative_df, METH_VARARGS, "\n"
		"DFunctorWithDerivative_df(DFunctorWithDerivative self, double X) -> double\n"
		"\n"
		"GeoCal::DFunctorWithDerivative::df\n"
		"Return df / dx.  \n"
		"\n"
		""},
	 { "DFunctorWithDerivative_f_with_derivative", _wrap_DFunctorWithDerivative_f_with_derivative, METH_VARARGS, "\n"
		"DFunctorWithDerivative_f_with_derivative(DFunctorWithDerivative self, double X) -> AutoDerivativeDouble\n"
		"\n"
		"GeoCal::DFunctorWithDerivative::f_with_derivative\n"
		"Return df / dp_i as a AutoDerivative.  \n"
		"\n"
		""},
	 { "delete_DFunctorWithDerivative", _wrap_delete_DFunctorWithDerivative, METH_O, "delete_DFunctorWithDerivative(DFunctorWithDerivative self)"},
	 { "DFunctorWithDerivative_swigregister", DFunctorWithDerivative_swigregister, METH_O, NULL},
	 { NULL, NULL, 0, NULL }
};
...
static PyMethodDef SwigMethods_proxydocs[] = {
	 ...
	 { "SwigPyIterator_swigregister", SwigPyIterator_swigregister, METH_O, NULL},
	 { "DFunctorWithDerivative_df", _wrap_DFunctorWithDerivative_df, METH_VARARGS, "\n"
		"df(DFunctorWithDerivative self, double X) -> double\n"
		"\n"
		"GeoCal::DFunctorWithDerivative::df\n"
		"Return df / dx.  \n"
		"\n"
		""},
	 { "DFunctorWithDerivative_f_with_derivative", _wrap_DFunctorWithDerivative_f_with_derivative, METH_VARARGS, "\n"
		"f_with_derivative(DFunctorWithDerivative self, double X) -> AutoDerivativeDouble\n"
		"\n"
		"GeoCal::DFunctorWithDerivative::f_with_derivative\n"
		"Return df / dp_i as a AutoDerivative.  \n"
		"\n"
...
# endif
  ...
  GeoCal::SwigTypeMapperBase::add(typeid(GeoCal::DFunctorWithDerivative), boost::make_shared<GeoCal::SwigTypeMapper< GeoCal::DFunctorWithDerivative > > ("boost::shared_ptr< GeoCal::DFunctorWithDerivative > *"));
