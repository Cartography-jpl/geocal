...
MagnifyBilinear._v_number_line = new_instancemethod(_magnify_bilinear.MagnifyBilinear__v_number_line,None,MagnifyBilinear)
MagnifyBilinear._v_number_sample = new_instancemethod(_magnify_bilinear.MagnifyBilinear__v_number_sample,None,MagnifyBilinear)
MagnifyBilinear._v_number_tile_line = new_instancemethod(_magnify_bilinear.MagnifyBilinear__v_number_tile_line,None,MagnifyBilinear)
MagnifyBilinear._v_number_tile_sample = new_instancemethod(_magnify_bilinear.MagnifyBilinear__v_number_tile_sample,None,MagnifyBilinear)
MagnifyBilinear._v_has_map_info = new_instancemethod(_magnify_bilinear.MagnifyBilinear__v_has_map_info,None,MagnifyBilinear)
MagnifyBilinear._v_map_info = new_instancemethod(_magnify_bilinear.MagnifyBilinear__v_map_info,None,MagnifyBilinear)
MagnifyBilinear._v_grid_center_line_resolution = new_instancemethod(_magnify_bilinear.MagnifyBilinear__v_grid_center_line_resolution,None,MagnifyBilinear)
MagnifyBilinear._v_grid_center_sample_resolution = new_instancemethod(_magnify_bilinear.MagnifyBilinear__v_grid_center_sample_resolution,None,MagnifyBilinear)
MagnifyBilinear._v_has_rpc = new_instancemethod(_magnify_bilinear.MagnifyBilinear__v_has_rpc,None,MagnifyBilinear)
MagnifyBilinear._v_rpc = new_instancemethod(_magnify_bilinear.MagnifyBilinear__v_rpc,None,MagnifyBilinear)
