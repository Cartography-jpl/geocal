...
SWIGINTERN PyObject *_wrap_new_MemoryDem__SWIG_0(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  ...
  }
  {
    ...
    if (SWIG_IsOK(res2)) {
      ...
      if (!argp2) {
        SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "new_MemoryDem" "', argument " "2"" of type '" "GeoCal::MapInfo const &""'"); 
      }
      if (newmem & SWIG_CAST_NEW_MEMORY) {
...
SWIGINTERN PyObject *_wrap_MemoryDem_elevation_data_set(PyObject *self, PyObject *args) {
  ...
  }
  {
    ...
    if (!argp2) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "MemoryDem_elevation_data_set" "', argument " "2"" of type '" "boost::multi_array< double,2 >""'");
    } else {
