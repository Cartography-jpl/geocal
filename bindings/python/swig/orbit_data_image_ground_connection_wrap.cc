...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__OrbitDataImageGroundConnection_t swig_types[120]
...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__Refraction_t swig_types[128]
