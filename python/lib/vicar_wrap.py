...
class __scinterp(VicarInterface):
    ...
    def __init__(self, time, pos_previous, t_pos_previous, att_previous, 
                 t_att_previous,
...
local o3 real
'''
        self.build_command(["peph", "patt", "seph", "satt", "imtime"],
                           ["w_t_sv1=w1",
                            "w_t_sv2=w2",
                            "w_t_sv3=w3",
                            "w_q_sv0=o0",
...
def scinterp(time, pos_previous, t_pos_previous, att_previous, t_att_previous,
    ...
    t = __scinterp(time, pos_previous, t_pos_previous, 
                   att_previous, t_att_previous,
                   pos_subsequent, t_pos_subsequent, 
                   att_subsequent, t_att_subsequent)
    return t.res

class __sc2rpc(VicarInterface):
    '''Helper class for calling sc2rpc'''
    def __init__(self, orbit_data, delta_ut1, leapsecond_file, 
                 image_coordinate, height, sc_to_cam_q, fu, fv):
        VicarInterface.__init__(self)
...
'''
        ...
        self.urange = [image_coordinate.sample,1, 
                       image_coordinate.sample + 2]
        self.vrange = [image_coordinate.line,1, 
                       image_coordinate.line + 2]
        ...
        self.tod_t_sv = [orbit_data.position_ci.position[0],
        ...
        self.u0 = 1824.5
        self.v0 = 1688.0
        self.kappa = [0.0,0.0,0.0,0.0,0.]
        self.fu = fu
        self.fv = fv
        self.input = [leapsecond_file]
        self.build_command(["urange", "vrange", "hrange", "leapfile", 
                            "acs_time", "delta_ut1",
                            "tod_t_sv", "tod_q_sv", "sv_t_c",
                            "sv_q_c", "fu", "fv", "q", "u0", "v0",
                            "kappa"])
        self.debug = False
        self.timing = False
...
def sc2rpc(orbit_data, delta_ut1, leapsecond_file, image_coordinate, 
