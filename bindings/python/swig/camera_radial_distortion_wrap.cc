...
#define SWIGTYPE_p_boost__math__quaternionT_double_t swig_types[105]
...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__CameraRadialDistortion_t swig_types[112]
