...
#define SWIGTYPE_p_GeoCal__QuickBirdCamera swig_types[7]
...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__QuickBirdCamera_t swig_types[31]
...
static void *_p_GeoCal__QuickBirdCameraTo_p_GeoCal__GenericObject(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((GeoCal::GenericObject *) (GeoCal::Camera *)(GeoCal::QuaternionCamera *) ((GeoCal::QuickBirdCamera *) x));
}
