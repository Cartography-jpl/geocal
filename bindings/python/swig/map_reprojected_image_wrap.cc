...
#define SWIGTYPE_p_GeoCal__MapReprojectedImage swig_types[23]
...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__MapReprojectedImage_t swig_types[80]
...
# endif
  ...
  GeoCal::swig_type_map[GeoCal::type_index(typeid(GeoCal::MapReprojectedImage))] =
  boost::shared_ptr<GeoCal::SwigTypeMapperBase>(new GeoCal::SwigTypeMapper< GeoCal::MapReprojectedImage >("boost::shared_ptr< GeoCal::MapReprojectedImage > *"));
