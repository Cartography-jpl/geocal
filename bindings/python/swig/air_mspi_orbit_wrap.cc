...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__AirMspiOrbit_t swig_types[43]
...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__SimpleDatum_t swig_types[71]
