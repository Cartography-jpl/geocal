...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__CameraRadialDistortionAndTransform_t swig_types[110]
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__CameraRadialDistortion_t swig_types[111]
