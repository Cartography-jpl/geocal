...
#define SWIGTYPE_p_blitz__ArrayT_GeoCal__AutoDerivativeT_double_t_1_t swig_types[29]
...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__SubCamera_t swig_types[128]
