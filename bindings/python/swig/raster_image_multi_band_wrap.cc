...
SWIGINTERN PyObject *_wrap_RasterImageMultiBand_overview(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  {
    boost::shared_ptr<  GeoCal::RasterImageMultiBandVariable > *smartresult = new boost::shared_ptr<  GeoCal::RasterImageMultiBandVariable >(new GeoCal::RasterImageMultiBandVariable((GeoCal::RasterImageMultiBandVariable &)result));
