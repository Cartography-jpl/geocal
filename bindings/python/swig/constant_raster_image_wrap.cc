...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__ConstantRasterImage_t swig_types[155]
...
SWIGINTERN PyObject *_wrap_new_ConstantRasterImage__SWIG_1(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  ...
  if ((nobjs < 2) || (nobjs > 2)) SWIG_fail;
  {
    ...
    if (SWIG_IsOK(res1)) {
      ...
      if (!argp1) {
        SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "new_ConstantRasterImage" "', argument " "1"" of type '" "GeoCal::MapInfo const &""'"); 
      }
