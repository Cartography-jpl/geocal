...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__DemToRaster_t swig_types[71]
...
# endif
  ...
  GeoCal::swig_type_map[GeoCal::type_index(typeid(GeoCal::DemToRaster))] =
  boost::shared_ptr<GeoCal::SwigTypeMapperBase>(new GeoCal::SwigTypeMapper< GeoCal::DemToRaster >("boost::shared_ptr< GeoCal::DemToRaster > *"));
