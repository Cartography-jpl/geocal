...
OrbitDataImageGroundConnection._v_number_line = new_instancemethod(_orbit_data_image_ground_connection.OrbitDataImageGroundConnection__v_number_line,None,OrbitDataImageGroundConnection)
OrbitDataImageGroundConnection._v_number_sample = new_instancemethod(_orbit_data_image_ground_connection.OrbitDataImageGroundConnection__v_number_sample,None,OrbitDataImageGroundConnection)
OrbitDataImageGroundConnection._v_number_band = new_instancemethod(_orbit_data_image_ground_connection.OrbitDataImageGroundConnection__v_number_band,None,OrbitDataImageGroundConnection)
OrbitDataImageGroundConnection._v_has_time = new_instancemethod(_orbit_data_image_ground_connection.OrbitDataImageGroundConnection__v_has_time,None,OrbitDataImageGroundConnection)
