...
SWIGINTERN PyObject *_wrap_vector_auto_derivative_pop(PyObject *self, PyObject *args) {
  ...
  {
    boost::shared_ptr<  GeoCal::AutoDerivative<double> > *smartresult = new boost::shared_ptr<  GeoCal::AutoDerivative<double> >(new std::vector< GeoCal::AutoDerivative< double > >::value_type(result));
