...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__TimeWithDerivative_t swig_types[71]
...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__VicarMultiFile_t swig_types[74]
