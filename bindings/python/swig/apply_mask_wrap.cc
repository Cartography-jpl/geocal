...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__ApplyMask_t swig_types[39]
...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__RasterImageVariable_t swig_types[59]
