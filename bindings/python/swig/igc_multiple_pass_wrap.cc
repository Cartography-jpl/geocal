...
#define SWIGTYPE_p_std__vectorT_boost__shared_ptrT_GeoCal__IgcCollection_t_std__allocatorT_boost__shared_ptrT_GeoCal__IgcCollection_t_t_t swig_types[147]
