...
SWIGINTERN PyObject *_wrap_new_RollingShutterConstantTimeTable__SWIG_0(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  ...
  if ((nobjs < 3) || (nobjs > 3)) SWIG_fail;
  {
    ...
    if (!argp1) {
      SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "new_RollingShutterConstantTimeTable" "', argument " "1"" of type '" "GeoCal::Time""'");
    } else {
  ...
  }
  {
    ...
    if (!argp2) {
      SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "new_RollingShutterConstantTimeTable" "', argument " "2"" of type '" "GeoCal::Time""'");
    } else {
...
SWIGINTERN PyObject *_wrap_RollingShutterConstantTimeTable_image_coordinate(PyObject *self, PyObject *args) {
  ...
  }
  {
    ...
    if (!argp2) {
      SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "RollingShutterConstantTimeTable_image_coordinate" "', argument " "2"" of type '" "GeoCal::Time""'");
    } else {
      arg2 = *(reinterpret_cast< boost::shared_ptr<  GeoCal::Time > * >(argp2)->get());
      if (newmem & SWIG_CAST_NEW_MEMORY) delete reinterpret_cast< boost::shared_ptr<  GeoCal::Time > * >(argp2);
    }
  }
  {
    ...
    if (SWIG_IsOK(res3)) {
      ...
      if (!argp3) {
        SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "RollingShutterConstantTimeTable_image_coordinate" "', argument " "3"" of type '" "GeoCal::FrameCoordinate const &""'"); 
      }
      if (newmem & SWIG_CAST_NEW_MEMORY) {
