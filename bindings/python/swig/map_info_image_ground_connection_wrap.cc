...
#define SWIGTYPE_p_GeoCal__MapInfoImageGroundConnection swig_types[37]
...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__MapInfoImageGroundConnection_t swig_types[115]
