...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_rpc_image_ground_connection')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_rpc_image_ground_connection')
...
class SwigPyIterator(object):
    ...
    def __iter__(self):
        return self
SwigPyIterator.value = new_instancemethod(_rpc_image_ground_connection.SwigPyIterator_value, None, SwigPyIterator)
SwigPyIterator.incr = new_instancemethod(_rpc_image_ground_connection.SwigPyIterator_incr, None, SwigPyIterator)
SwigPyIterator.decr = new_instancemethod(_rpc_image_ground_connection.SwigPyIterator_decr, None, SwigPyIterator)
SwigPyIterator.distance = new_instancemethod(_rpc_image_ground_connection.SwigPyIterator_distance, None, SwigPyIterator)
SwigPyIterator.equal = new_instancemethod(_rpc_image_ground_connection.SwigPyIterator_equal, None, SwigPyIterator)
SwigPyIterator.copy = new_instancemethod(_rpc_image_ground_connection.SwigPyIterator_copy, None, SwigPyIterator)
SwigPyIterator.next = new_instancemethod(_rpc_image_ground_connection.SwigPyIterator_next, None, SwigPyIterator)
SwigPyIterator.__next__ = new_instancemethod(_rpc_image_ground_connection.SwigPyIterator___next__, None, SwigPyIterator)
SwigPyIterator.previous = new_instancemethod(_rpc_image_ground_connection.SwigPyIterator_previous, None, SwigPyIterator)
SwigPyIterator.advance = new_instancemethod(_rpc_image_ground_connection.SwigPyIterator_advance, None, SwigPyIterator)
SwigPyIterator.__eq__ = new_instancemethod(_rpc_image_ground_connection.SwigPyIterator___eq__, None, SwigPyIterator)
SwigPyIterator.__ne__ = new_instancemethod(_rpc_image_ground_connection.SwigPyIterator___ne__, None, SwigPyIterator)
SwigPyIterator.__iadd__ = new_instancemethod(_rpc_image_ground_connection.SwigPyIterator___iadd__, None, SwigPyIterator)
SwigPyIterator.__isub__ = new_instancemethod(_rpc_image_ground_connection.SwigPyIterator___isub__, None, SwigPyIterator)
SwigPyIterator.__add__ = new_instancemethod(_rpc_image_ground_connection.SwigPyIterator___add__, None, SwigPyIterator)
SwigPyIterator.__sub__ = new_instancemethod(_rpc_image_ground_connection.SwigPyIterator___sub__, None, SwigPyIterator)
SwigPyIterator_swigregister = _rpc_image_ground_connection.SwigPyIterator_swigregister
...
class RpcImageGroundConnection(geocal_swig.image_ground_connection.ImageGroundConnection):
    ...
    def cf_look_vector(self, Ic):
        ...
        """
        return _rpc_image_ground_connection.RpcImageGroundConnection_cf_look_vector(self, Ic)
