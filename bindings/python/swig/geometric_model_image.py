...
GeometricModelImage._v_number_line = new_instancemethod(_geometric_model_image.GeometricModelImage__v_number_line,None,GeometricModelImage)
GeometricModelImage._v_number_sample = new_instancemethod(_geometric_model_image.GeometricModelImage__v_number_sample,None,GeometricModelImage)
GeometricModelImage._v_number_tile_line = new_instancemethod(_geometric_model_image.GeometricModelImage__v_number_tile_line,None,GeometricModelImage)
GeometricModelImage._v_number_tile_sample = new_instancemethod(_geometric_model_image.GeometricModelImage__v_number_tile_sample,None,GeometricModelImage)
GeometricModelImage._v_has_map_info = new_instancemethod(_geometric_model_image.GeometricModelImage__v_has_map_info,None,GeometricModelImage)
GeometricModelImage._v_map_info = new_instancemethod(_geometric_model_image.GeometricModelImage__v_map_info,None,GeometricModelImage)
GeometricModelImage._v_grid_center_line_resolution = new_instancemethod(_geometric_model_image.GeometricModelImage__v_grid_center_line_resolution,None,GeometricModelImage)
GeometricModelImage._v_grid_center_sample_resolution = new_instancemethod(_geometric_model_image.GeometricModelImage__v_grid_center_sample_resolution,None,GeometricModelImage)
GeometricModelImage._v_has_rpc = new_instancemethod(_geometric_model_image.GeometricModelImage__v_has_rpc,None,GeometricModelImage)
GeometricModelImage._v_rpc = new_instancemethod(_geometric_model_image.GeometricModelImage__v_rpc,None,GeometricModelImage)
