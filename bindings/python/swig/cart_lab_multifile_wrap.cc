...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__RasterMultifile_t swig_types[192]
...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__VicarCartLabMultifileSetup_t swig_types[204]
