...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__CalcRasterMultiBand_t swig_types[46]
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__CartesianFixedLookVectorWithDerivative_t swig_types[47]
...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__RasterImage_t swig_types[69]
