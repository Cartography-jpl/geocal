...
#define SWIGTYPE_p_GeoCal__SurfaceImageToImageMatch swig_types[29]
...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__SurfaceImageToImageMatch_t swig_types[76]
