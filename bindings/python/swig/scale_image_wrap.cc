...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__ScaleImageMultiBand_t swig_types[90]
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__ScaleImage_t swig_types[91]
