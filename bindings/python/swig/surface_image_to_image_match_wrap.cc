...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__ImageMatcher_t swig_types[95]
...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__SurfaceImageToImageMatch_t swig_types[110]
