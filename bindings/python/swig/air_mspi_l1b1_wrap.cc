...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__AirMspiL1b1File_t swig_types[140]
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__AirMspiL1b1_t swig_types[141]
