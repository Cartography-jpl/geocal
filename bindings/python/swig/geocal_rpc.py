...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_geocal_rpc')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_geocal_rpc')
...
class Rpc(geocal_swig.generic_object.GenericObject):
    ...
    def resolution_meter(self, D):
        ...
        the Dem. 
        """
        return _geocal_rpc.Rpc_resolution_meter(self, D)


    def fit(self, Gc, Ic, Line_sigma, Sample_sigma, Blunder, Blunder_threshold=3, Chisq_threshold=0.8, Blunder_detect=True):
        """
        ...
        """
        return _geocal_rpc.Rpc_fit(self, Gc, Ic, Line_sigma, Sample_sigma, Blunder, Blunder_threshold, Chisq_threshold, Blunder_detect)


    def fit_all(self, Line, Sample, Latitude, Longitude, Height):
        """
        ...
        """
        return _geocal_rpc.Rpc_fit_all(self, Line, Sample, Latitude, Longitude, Height)


    def generate_rpc(Igc, Min_height, Max_height, Nlat=20, Nlon=20, Nheight=20, Skip_masked_point=False, Ignore_error=False):
        """
    ...
    def image_coordinate_jac(self, Latitude, Longitude, Height_ellipsoid):
        """
        ...
        order. 
        """
        return _geocal_rpc.Rpc_image_coordinate_jac(self, Latitude, Longitude, Height_ellipsoid)


    def rpc_project(self, Res, Img, D, Line_scale=1, Sample_scale=1):
        """
        ...
        """
        return _geocal_rpc.Rpc_rpc_project(self, Res, Img, D, Line_scale, Sample_scale)
...
def Rpc_generate_rpc(Igc, Min_height, Max_height, Nlat=20, Nlon=20, Nheight=20, Skip_masked_point=False, Ignore_error=False):
    """
