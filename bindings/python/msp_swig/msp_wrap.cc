...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__msp_wrap

#else
#  define SWIG_init    init_msp_wrap

#endif
#define SWIG_name    "_msp_wrap"
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"new_Test", (PyCFunction)_wrap_new_Test, METH_NOARGS, NULL},
	 { (char *)"delete_Test", (PyCFunction)_wrap_delete_Test, METH_O, NULL},
	 { (char *)"Test_swigregister", Test_swigregister, METH_VARARGS, NULL},
	 { (char *)"Test_swiginit", Test_swiginit, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
