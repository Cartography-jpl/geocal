...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__RayCasterResampler_t swig_types[185]
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__RayCaster_t swig_types[186]
