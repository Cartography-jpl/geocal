...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_argus_orbit')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_argus_orbit')
...
class ArgusOrbitData(geocal_swig.aircraft_orbit_data.AircraftOrbitData):
    ...
    def save_ortho(self, Mi, Cam, D, Fname, Type, Border=10, Grid_spacing=1):
        """
        ...
        involved. 
        """
        return _argus_orbit.ArgusOrbitData_save_ortho(self, Mi, Cam, D, Fname, Type, Border, Grid_spacing)


    def add_ortho_to_image(self, M1, M2, M3, Cam, D, Border=10):
        """
        ...
        already has data. 
        """
        return _argus_orbit.ArgusOrbitData_add_ortho_to_image(self, M1, M2, M3, Cam, D, Border)


    def mosaic(Od, Cam, D, Mi, Fname, Type, Border=10):
        """
        ...
        """
        return _argus_orbit.ArgusOrbitData_mosaic(Od, Cam, D, Mi, Fname, Type, Border)
...
def ArgusOrbitData_mosaic(Od, Cam, D, Mi, Fname, Type, Border=10):
    """
...
class ArgusOrbit(geocal_swig.orbit_quaternion_list.OrbitQuaternionList):
    ...
    def focal_length(self, camera_num):
        """
        ...
        we return -1. 
        """
        return _argus_orbit.ArgusOrbit_focal_length(self, camera_num)
    ...
    def nav(self, row, camera_num):
        ...
        """
        return _argus_orbit.ArgusOrbit_nav(self, row, camera_num)
