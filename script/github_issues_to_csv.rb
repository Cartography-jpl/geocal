...
#=begin
OUTPUT_FILE = "../issues"
USERNAME = "smyth"  # Put your GitHub username inside the quotes
#PASSWORD = ""   # Put your GitHub password inside the quotes 
ORG = "Cartography"        # Put your organization (or username if you have no org) name here
REPO = "geocal"      # Put the repository name here
