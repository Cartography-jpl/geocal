...
#define SWIGTYPE_p_GeoCal__MeasuredTimeTable swig_types[28]
...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__Orbit_t swig_types[105]
...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__SimpleCamera_t swig_types[109]
