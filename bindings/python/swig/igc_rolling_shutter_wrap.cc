...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__ConstantSpacingFrameletTimeTable_t swig_types[173]
...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__IgcRollingShutter_t swig_types[189]
