...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__OrbitDataImageGroundConnection_t swig_types[121]
...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__Refraction_t swig_types[129]
