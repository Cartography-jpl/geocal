...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__IgcArray_t swig_types[103]
...
# endif
  ...
  GeoCal::swig_type_map[GeoCal::type_index(typeid(GeoCal::IgcArray))] =
  boost::shared_ptr<GeoCal::SwigTypeMapperBase>(new GeoCal::SwigTypeMapper< GeoCal::IgcArray >("boost::shared_ptr< GeoCal::IgcArray > *"));
