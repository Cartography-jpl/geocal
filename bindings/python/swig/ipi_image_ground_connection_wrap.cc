...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__IpiImageGroundConnection_t swig_types[189]
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__Ipi_t swig_types[190]
