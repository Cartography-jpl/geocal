...
SWIGINTERN PyObject *_wrap_new_IgcCollectionRollingShutter__SWIG_0(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  ...
  if ((nobjs < 6) || (nobjs > 6)) SWIG_fail;
  {
    ...
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "new_IgcCollectionRollingShutter" "', argument " "1"" of type '" "std::vector< boost::shared_ptr< GeoCal::RasterImage >,std::allocator< boost::shared_ptr< GeoCal::RasterImage > > > const &""'"); 
    }
    arg1 = ptr;
  }
  ...
  if (!argp2) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "new_IgcCollectionRollingShutter" "', argument " "2"" of type '" "std::vector< boost::shared_ptr< GeoCal::TimeTable >,std::allocator< boost::shared_ptr< GeoCal::TimeTable > > > const &""'"); 
  }
