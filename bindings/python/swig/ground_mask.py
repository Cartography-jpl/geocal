...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_ground_mask')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_ground_mask')
...
class GroundMask(geocal_swig.generic_object.GenericObject):
    ...
    def mask(self, Gc):
        ...
        """
        return _ground_mask.GroundMask_mask(self, Gc)
    ...
    def region_masked(self, Ulc, Lrc):
        ...
        """
        return _ground_mask.GroundMask_region_masked(self, Ulc, Lrc)
