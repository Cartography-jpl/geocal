...
# endif
  ...
  SWIG_addvarlink(SWIG_globals(),(char *)"arcsecond_to_rad",Swig_var_arcsecond_to_rad_get, Swig_var_arcsecond_to_rad_set);
  SWIG_addvarlink(SWIG_globals(),(char *)"rad_to_arcsecond",Swig_var_rad_to_arcsecond_get, Swig_var_rad_to_arcsecond_set);
  SWIG_addvarlink(SWIG_globals(),(char *)"speed_of_light",Swig_var_speed_of_light_get, Swig_var_speed_of_light_set);
#if PY_VERSION_HEX >= 0x03000000
  return m;
#else
  return;
