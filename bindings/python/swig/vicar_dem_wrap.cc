...
SWIGINTERN PyObject *_wrap_new_VicarDem__SWIG_0(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  ...
  if ((nobjs < 4) || (nobjs > 4)) SWIG_fail;
  {
    ...
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "new_VicarDem" "', argument " "1"" of type '" "std::string const &""'"); 
    }
    arg1 = ptr;
  }
...
SWIGINTERN PyObject *_wrap_new_VicarDem__SWIG_5(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  ...
  arg4 = static_cast< int >(val4);
  {
    ...
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "new_VicarDem" "', argument " "5"" of type '" "std::string const &""'"); 
    }
    arg5 = ptr;
  }
  {
