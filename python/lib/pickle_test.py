...
def test_rpc_pickle():
    ...
    rpc.line_numerator.set([0.0132748, -0.14751, -1.13465,
                          -0.0138959, 0.0020018,
    ...
    rpc.line_denominator.set([1, 0.00380256, 0.00643151, 0.00031479,
    ...
    rpc.sample_numerator.set([-0.0104025, 0.96885, -0.000487887, -0.0325142,
      ...
      5.84016e-05, 3.80777e-08, 9.01765e-06, 1.65988e-06,
       -1.19374e-07])
    rpc.sample_denominator.set([1, -0.000319831, 0.000681092, -0.000549762,
