...
SWIGINTERN PyObject *_wrap_CoordinateConverter_convert_to_coordinate(PyObject *self, PyObject *args) {
  ...
  }
  {
    ...
    if (SWIG_IsOK(res2)) {
      ...
      if (!argp2) {
        SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "CoordinateConverter_convert_to_coordinate" "', argument " "2"" of type '" "GeoCal::GroundCoordinate const &""'"); 
      }
      if (newmem & SWIG_CAST_NEW_MEMORY) {
...
SWIGINTERN PyObject *_wrap_CoordinateConverter_create(PyObject *self, PyObject *args) {
  ...
  }
  {
    ...
    if (SWIG_IsOK(res2)) {
      ...
      if (!argp2) {
        SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "CoordinateConverter_create" "', argument " "2"" of type '" "GeoCal::GroundCoordinate const &""'"); 
      }
      if (newmem & SWIG_CAST_NEW_MEMORY) {
        tempshared2 = *reinterpret_cast< boost::shared_ptr< const GeoCal::GroundCoordinate > * >(argp2);
        delete reinterpret_cast< boost::shared_ptr< const GeoCal::GroundCoordinate > * >(argp2);
...
SWIGINTERN PyObject *_wrap_CoordinateConverter_is_same(PyObject *self, PyObject *args) {
  ...
  }
  {
    ...
    if (SWIG_IsOK(res2)) {
      ...
      if (!argp2) {
        SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "CoordinateConverter_is_same" "', argument " "2"" of type '" "GeoCal::CoordinateConverter const &""'"); 
      }
      if (newmem & SWIG_CAST_NEW_MEMORY) {
