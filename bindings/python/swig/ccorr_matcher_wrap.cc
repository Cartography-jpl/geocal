...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__CcorrMatcher_t swig_types[40]
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__CombinedImageMask_t swig_types[41]
