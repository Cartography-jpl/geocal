...
#define SWIGTYPE_p_GeoCal__RayIntersect swig_types[30]
...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__RasterImageMultiBandVariable_t swig_types[74]
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__RasterImageMultiBand_t swig_types[75]
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__RasterImageTileIterator_t swig_types[76]
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__RasterImage_t swig_types[77]
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__RayIntersect_t swig_types[78]
...
SWIGINTERN PyObject *_wrap_RayIntersect_two_look_vector_intersect(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args,"RayIntersect_two_look_vector_intersect",4,4,swig_obj)) SWIG_fail;
  {
    ...
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], (void**)(&ptr), SWIGTYPE_p_GeoCal__CartesianFixed,  0 , &newmem);
    if (SWIG_IsOK(res1)) {
      arg1 = ptr;
    } else {
      res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_GeoCal__CartesianFixed_t,  0 , &newmem);
      if (!SWIG_IsOK(res1)) {
        SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "RayIntersect_two_look_vector_intersect" "', argument " "1"" of type '" "GeoCal::CartesianFixed const &""'"); 
      }
      if (!argp1) {
        SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "RayIntersect_two_look_vector_intersect" "', argument " "1"" of type '" "GeoCal::CartesianFixed const &""'"); 
      }
      if (newmem & SWIG_CAST_NEW_MEMORY) {
        ...
        arg1 = const_cast< GeoCal::CartesianFixed * >(reinterpret_cast< boost::shared_ptr< const GeoCal::CartesianFixed > * >(argp1)->get());
      }
    }
  }
  {
  ...
  }
  {
    ...
    if (SWIG_IsOK(res3)) {
      ...
      if (!SWIG_IsOK(res3)) {
        SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "RayIntersect_two_look_vector_intersect" "', argument " "3"" of type '" "GeoCal::CartesianFixed const &""'"); 
      }
      if (!argp3) {
        SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "RayIntersect_two_look_vector_intersect" "', argument " "3"" of type '" "GeoCal::CartesianFixed const &""'"); 
      }
      if (newmem & SWIG_CAST_NEW_MEMORY) {
