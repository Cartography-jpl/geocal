...
# endif
  ...
  GeoCal::SwigTypeMapperBase::add(typeid(GeoCal::SmoothImage), boost::make_shared<GeoCal::SwigTypeMapper< GeoCal::SmoothImage > > ("boost::shared_ptr< GeoCal::SmoothImage > *"));
