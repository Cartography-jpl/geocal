...
SWIGINTERN PyObject *_wrap_IpiImageGroundConnection_cf_look_vector(PyObject *self, PyObject *args) {
  ...
  }
  {
    ...
    if (SWIG_IsOK(res2)) {
      ...
      if (!argp2) {
        SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "IpiImageGroundConnection_cf_look_vector" "', argument " "2"" of type '" "GeoCal::ImageCoordinate const &""'"); 
      }
      if (newmem & SWIG_CAST_NEW_MEMORY) {
