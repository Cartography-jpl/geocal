...
SWIGINTERN PyObject *_wrap_VelocityAberrationExact_aberration_calc__SWIG_0(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  ...
  }
  {
    ...
    if (SWIG_IsOK(res2)) {
      ...
      if (!argp2) {
        SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "VelocityAberrationExact_aberration_calc" "', argument " "2"" of type '" "GeoCal::GroundCoordinate const &""'"); 
      }
      if (newmem & SWIG_CAST_NEW_MEMORY) {
...
SWIGINTERN PyObject *_wrap_VelocityAberrationExact_velocity_aberration_apply(PyObject *self, PyObject *args) {
  ...
  }
  {
    ...
    if (SWIG_IsOK(res2)) {
      ...
      if (!argp2) {
        SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "VelocityAberrationExact_velocity_aberration_apply" "', argument " "2"" of type '" "GeoCal::GroundCoordinate const &""'"); 
      }
      if (newmem & SWIG_CAST_NEW_MEMORY) {
        tempshared2 = *reinterpret_cast< boost::shared_ptr< const GeoCal::GroundCoordinate > * >(argp2);
        delete reinterpret_cast< boost::shared_ptr< const GeoCal::GroundCoordinate > * >(argp2);
  ...
  }
  {
    ...
    if (SWIG_IsOK(res3)) {
      ...
      if (!argp3) {
        SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "VelocityAberrationExact_velocity_aberration_apply" "', argument " "3"" of type '" "GeoCal::GroundCoordinate const &""'"); 
      }
      if (newmem & SWIG_CAST_NEW_MEMORY) {
        tempshared3 = *reinterpret_cast< boost::shared_ptr< const GeoCal::GroundCoordinate > * >(argp3);
        delete reinterpret_cast< boost::shared_ptr< const GeoCal::GroundCoordinate > * >(argp3);
