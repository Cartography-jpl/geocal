...
# endif
  ...
  GeoCal::SwigTypeMapperBase::add(typeid(GeoCal::QuickBirdTimeTable), boost::make_shared<GeoCal::SwigTypeMapper< GeoCal::QuickBirdTimeTable > > ("boost::shared_ptr< GeoCal::QuickBirdTimeTable > *"));
