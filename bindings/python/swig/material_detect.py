...
MaterialDetect._v_number_line = new_instancemethod(_material_detect.MaterialDetect__v_number_line,None,MaterialDetect)
MaterialDetect._v_number_sample = new_instancemethod(_material_detect.MaterialDetect__v_number_sample,None,MaterialDetect)
MaterialDetect._v_number_tile_line = new_instancemethod(_material_detect.MaterialDetect__v_number_tile_line,None,MaterialDetect)
MaterialDetect._v_number_tile_sample = new_instancemethod(_material_detect.MaterialDetect__v_number_tile_sample,None,MaterialDetect)
MaterialDetect._v_has_map_info = new_instancemethod(_material_detect.MaterialDetect__v_has_map_info,None,MaterialDetect)
MaterialDetect._v_map_info = new_instancemethod(_material_detect.MaterialDetect__v_map_info,None,MaterialDetect)
MaterialDetect._v_grid_center_line_resolution = new_instancemethod(_material_detect.MaterialDetect__v_grid_center_line_resolution,None,MaterialDetect)
MaterialDetect._v_grid_center_sample_resolution = new_instancemethod(_material_detect.MaterialDetect__v_grid_center_sample_resolution,None,MaterialDetect)
MaterialDetect._v_has_rpc = new_instancemethod(_material_detect.MaterialDetect__v_has_rpc,None,MaterialDetect)
MaterialDetect._v_rpc = new_instancemethod(_material_detect.MaterialDetect__v_rpc,None,MaterialDetect)
