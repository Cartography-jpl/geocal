...
SWIGINTERN void std_vector_Sl_boost_shared_ptr_Sl_GeoCal_Camera_Sg__Sg____setslice____SWIG_0(std::vector< boost::shared_ptr< GeoCal::Camera > > *self,std::vector< boost::shared_ptr< GeoCal::Camera > >::difference_type i,std::vector< boost::shared_ptr< GeoCal::Camera > >::difference_type j,std::vector< boost::shared_ptr< GeoCal::Camera >,std::allocator< boost::shared_ptr< GeoCal::Camera > > > const &v=std::vector< boost::shared_ptr< GeoCal::Camera >,std::allocator< boost::shared_ptr< GeoCal::Camera > > >()){
...
SWIGINTERN PyObject *_wrap_Vector_Camera___setslice____SWIG_0(PyObject *SWIGUNUSEDPARM(self), int nobjs, PyObject **swig_obj) {
  ...
  }
  {
    try {
      try {
        std_vector_Sl_boost_shared_ptr_Sl_GeoCal_Camera_Sg__Sg____setslice____SWIG_0(arg1,arg2,arg3,(std::vector< boost::shared_ptr< GeoCal::Camera >,std::allocator< boost::shared_ptr< GeoCal::Camera > > > const &)*arg4);
      }
      catch(std::out_of_range &_e) {
        SWIG_exception_fail(SWIG_IndexError, (&_e)->what());
      }
