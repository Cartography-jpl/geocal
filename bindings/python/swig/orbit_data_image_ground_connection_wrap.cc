...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__OrbitDataImageGroundConnection_t swig_types[191]
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__OrbitData_t swig_types[192]
