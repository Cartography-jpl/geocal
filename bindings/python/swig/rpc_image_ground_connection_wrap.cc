...
#define SWIGTYPE_p_GeoCal__RpcImageGroundConnection swig_types[47]
...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__RpcImageGroundConnection_t swig_types[186]
