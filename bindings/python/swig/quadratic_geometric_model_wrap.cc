...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__QuadraticGeometricModel_t swig_types[29]
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__VicarImageCoordinate_t swig_types[30]
