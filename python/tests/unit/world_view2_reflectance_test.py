from geocal import WorldView2Reflectance
import numpy as np
...
def test_print(unit_test_data):
    ...
    wv2 = WorldView2Reflectance(
        unit_test_data / "10MAY07185751-M1BS-052360785020_01_P001.IMD",
        unit_test_data / "10MAY07185751-P1BS-052360785020_01_P001.IMD",
    )
    wv2.printMetadata()
...
def test_refl(unit_test_data):
    ...
    ref_expect = np.array(
        [
            [0.18104724, 0.17321347, 0.16450928],
            [0.18931623, 0.17538952, 0.16059239],
            [0.19062186, 0.17800078, 0.16320365],
        ]
    )
    npt.assert_almost_equal(wv2.dn2TOAReflectance(dn, 8), ref_expect, 8)
...
def test_nitf():
    ...
    if not os.path.exists(nitf_test_data):
        pytest.skip("Missing tests data")
    wv2_imd = WorldView2Reflectance(
        nitf_test_data + "12MAR10105443-M1BS-052683561010_04_P007.IMD",
        nitf_test_data + "12MAR10105443-P1BS-052683561010_04_P007.IMD",
    )
    wv2_nitf = WorldView2Reflectance(
        nitf_test_data + "12MAR10105443-M1BS-052683561010_04_P007.NTF",
        nitf_test_data + "12MAR10105443-P1BS-052683561010_04_P007.NTF",
    )
    ...
    for i in range(9):
        if wv2_imd.absCalFactors[i] > -999:
            ...
            npt.assert_almost_equal(
                wv2_imd.dn2TOAReflectance_factor(i),
