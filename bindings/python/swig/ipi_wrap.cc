...
SWIGINTERN PyObject *_wrap_new_Ipi(PyObject *self, PyObject *args) {
  ...
  if (!(argc = SWIG_Python_UnpackTuple(args,"new_Ipi",0,9,argv))) SWIG_fail;
  --argc;
  if (argc == 5) {
...
# endif
  ...
  GeoCal::swig_type_map[GeoCal::type_index(typeid(GeoCal::Ipi))] =
  boost::shared_ptr<GeoCal::SwigTypeMapperBase>(new GeoCal::SwigTypeMapper< GeoCal::Ipi >("boost::shared_ptr< GeoCal::Ipi > *"));
