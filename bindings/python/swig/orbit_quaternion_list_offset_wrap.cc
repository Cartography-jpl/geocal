...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__OrbitListCache_t swig_types[107]
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__OrbitQuaternionListOffset_t swig_types[108]
