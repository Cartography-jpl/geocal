...
SWIGINTERN PyObject *_wrap_VicarRasterImage_set_rpc(PyObject *self, PyObject *args) {
  ...
  }
  {
    ...
    if (SWIG_IsOK(res2)) {
      ...
      if (!argp2) {
        SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "VicarRasterImage_set_rpc" "', argument " "2"" of type '" "GeoCal::Rpc const &""'"); 
      }
      if (newmem & SWIG_CAST_NEW_MEMORY) {
...
SWIGINTERN PyObject *_wrap_VicarRasterImage_set_map_info(PyObject *self, PyObject *args) {
  ...
  }
  {
    ...
    if (SWIG_IsOK(res2)) {
      ...
      if (!argp2) {
        SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "VicarRasterImage_set_map_info" "', argument " "2"" of type '" "GeoCal::MapInfo const &""'"); 
      }
      if (newmem & SWIG_CAST_NEW_MEMORY) {
        tempshared2 = *reinterpret_cast< boost::shared_ptr< const GeoCal::MapInfo > * >(argp2);
        delete reinterpret_cast< boost::shared_ptr< const GeoCal::MapInfo > * >(argp2);
...
SWIGINTERN PyObject *_wrap_vicar_open__SWIG_0(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  ...
  if ((nobjs < 7) || (nobjs > 7)) SWIG_fail;
  {
    ...
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "vicar_open" "', argument " "1"" of type '" "std::string const &""'"); 
    }
    arg1 = ptr;
  }
  ecode2 = SWIG_AsVal_int(swig_obj[1], &val2);
