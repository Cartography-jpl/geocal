...
#define SWIGTYPE_p_blitz__ArrayT_std__complexT_double_t_2_t swig_types[52]
...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__Fftw2dBackward_t swig_types[77]
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__Fftw2dForward_t swig_types[78]
...
# endif
  ...
  GeoCal::SwigTypeMapperBase::add(typeid(GeoCal::Fftw2dForward), boost::make_shared<GeoCal::SwigTypeMapper< GeoCal::Fftw2dForward > > ("boost::shared_ptr< GeoCal::Fftw2dForward > *"));
  
  
  GeoCal::SwigTypeMapperBase::add(typeid(GeoCal::Fftw2dBackward), boost::make_shared<GeoCal::SwigTypeMapper< GeoCal::Fftw2dBackward > > ("boost::shared_ptr< GeoCal::Fftw2dBackward > *"));
