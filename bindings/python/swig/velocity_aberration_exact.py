...
if _swig_python_version_info >= (3, 0, 0):
    new_instancemethod = lambda func, inst, cls: _velocity_aberration_exact.SWIG_PyInstanceMethod_New(func)
else:
...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_velocity_aberration_exact')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_velocity_aberration_exact')
    _velocity_aberration_exact = swig_import_helper()
    ...
    def swig_import_helper():
        ...
        fp = None
        try:
            fp, pathname, description = imp.find_module('_velocity_aberration_exact', [dirname(__file__)])
        except ImportError:
            import _velocity_aberration_exact
            return _velocity_aberration_exact
        try:
            _mod = imp.load_module('_velocity_aberration_exact', fp, pathname, description)
        finally:
            if fp is not None:
                fp.close()
        return _mod
...
class SwigPyIterator(object):
    ...
    __repr__ = _swig_repr
    __swig_destroy__ = _velocity_aberration_exact.delete_SwigPyIterator
    def __iter__(self):
        return self
SwigPyIterator.value = new_instancemethod(_velocity_aberration_exact.SwigPyIterator_value, None, SwigPyIterator)
SwigPyIterator.incr = new_instancemethod(_velocity_aberration_exact.SwigPyIterator_incr, None, SwigPyIterator)
SwigPyIterator.decr = new_instancemethod(_velocity_aberration_exact.SwigPyIterator_decr, None, SwigPyIterator)
SwigPyIterator.distance = new_instancemethod(_velocity_aberration_exact.SwigPyIterator_distance, None, SwigPyIterator)
SwigPyIterator.equal = new_instancemethod(_velocity_aberration_exact.SwigPyIterator_equal, None, SwigPyIterator)
SwigPyIterator.copy = new_instancemethod(_velocity_aberration_exact.SwigPyIterator_copy, None, SwigPyIterator)
SwigPyIterator.next = new_instancemethod(_velocity_aberration_exact.SwigPyIterator_next, None, SwigPyIterator)
SwigPyIterator.__next__ = new_instancemethod(_velocity_aberration_exact.SwigPyIterator___next__, None, SwigPyIterator)
SwigPyIterator.previous = new_instancemethod(_velocity_aberration_exact.SwigPyIterator_previous, None, SwigPyIterator)
SwigPyIterator.advance = new_instancemethod(_velocity_aberration_exact.SwigPyIterator_advance, None, SwigPyIterator)
SwigPyIterator.__eq__ = new_instancemethod(_velocity_aberration_exact.SwigPyIterator___eq__, None, SwigPyIterator)
SwigPyIterator.__ne__ = new_instancemethod(_velocity_aberration_exact.SwigPyIterator___ne__, None, SwigPyIterator)
SwigPyIterator.__iadd__ = new_instancemethod(_velocity_aberration_exact.SwigPyIterator___iadd__, None, SwigPyIterator)
SwigPyIterator.__isub__ = new_instancemethod(_velocity_aberration_exact.SwigPyIterator___isub__, None, SwigPyIterator)
SwigPyIterator.__add__ = new_instancemethod(_velocity_aberration_exact.SwigPyIterator___add__, None, SwigPyIterator)
SwigPyIterator.__sub__ = new_instancemethod(_velocity_aberration_exact.SwigPyIterator___sub__, None, SwigPyIterator)
SwigPyIterator_swigregister = _velocity_aberration_exact.SwigPyIterator_swigregister
...
__all__ = ["VelocityAberrationExact"]
