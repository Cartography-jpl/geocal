...
class IgcMsp(geocal_swig.image_ground_connection.ImageGroundConnectionCopy):
    ...
    The python code is set up to do this automatically. But this is a
    fairly obscure thing that took a good while to track down initially,
    so we want to document this. Also, this might change in a future
    version of the MSP library (either adding or remove libraries
