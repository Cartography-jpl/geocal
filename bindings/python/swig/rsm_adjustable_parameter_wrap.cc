...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__RsmAdjustableParameter_t swig_types[80]
...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__WithParameterNested_t swig_types[85]
