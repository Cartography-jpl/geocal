...
#ifndef SWIG_orbit_correction_WRAP_H_
#define SWIG_orbit_correction_WRAP_H_

#include <map>
#include <string>


class SwigDirector_OrbitCorrection : public GeoCal::OrbitCorrection, public Swig::Director {

public:
    SwigDirector_OrbitCorrection(PyObject *self,boost::shared_ptr< GeoCal::Orbit > const Orb_uncorr);
    SwigDirector_OrbitCorrection(PyObject *self);
    virtual ~SwigDirector_OrbitCorrection();
    ...
    virtual boost::array< GeoCal::AutoDerivative< double >,3 > pcorr_with_derivative(GeoCal::TimeWithDerivative const &Tm,GeoCal::CartesianFixed const &Pos_uncorr) const;
    virtual boost::array< double,3 > pcorr(GeoCal::Time const &Tm,GeoCal::CartesianFixed const &Pos_uncorr) const;
    virtual boost::math::quaternion< GeoCal::AutoDerivative< double > > acorr_with_derivative(GeoCal::TimeWithDerivative const &T) const;
    virtual boost::math::quaternion< double > acorr(GeoCal::Time const &T) const;
...
/* VTable implementation */
    PyObject *swig_get_method(size_t method_index, const char *method_name) const {
      ...
      if (!method) {
        ...
        if (!method) {
          std::string msg = "Method in class OrbitCorrection doesn't exist, undefined ";
          msg += method_name;
