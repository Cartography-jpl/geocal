...
/*-----------------------------------------------
              @(target):= _air_mspi_file.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__air_mspi_file

#else
#  define SWIG_init    init_air_mspi_file

#endif
#define SWIG_name    "_air_mspi_file"
...
SWIGINTERN PyObject *_wrap_air_mspi_permanent_file_name(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::string *arg1 = 0 ;
  ...
  swig_obj[0] = args;
  {
    ...
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "air_mspi_permanent_file_name" "', argument " "1"" of type '" "std::string const &""'"); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "air_mspi_permanent_file_name" "', argument " "1"" of type '" "std::string const &""'"); 
    }
    arg1 = ptr;
  }
  {
    try {
      result = GeoCal::air_mspi_permanent_file_name((std::string const &)*arg1);
...
SWIGINTERN PyObject *_wrap_air_mspi_local_file_name(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  std::string *arg1 = 0 ;
  int res1 = SWIG_OLDOBJ ;
  PyObject *swig_obj[1] ;
  ...
  swig_obj[0] = args;
  {
    ...
    res1 = SWIG_AsPtr_std_string(swig_obj[0], &ptr);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "air_mspi_local_file_name" "', argument " "1"" of type '" "std::string const &""'"); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "air_mspi_local_file_name" "', argument " "1"" of type '" "std::string const &""'"); 
    }
    arg1 = ptr;
  }
  {
    try {
      result = GeoCal::air_mspi_local_file_name((std::string const &)*arg1);
    } catch (Swig::DirectorException &e) {
      SWIG_fail; 
    } catch (const std::exception& e) {
      SWIG_exception(SWIG_RuntimeError, e.what());
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"air_mspi_permanent_file_name", (PyCFunction)_wrap_air_mspi_permanent_file_name, METH_O, (char *)"\n"
		"\n"
		...
		""},
	 { (char *)"air_mspi_local_file_name", (PyCFunction)_wrap_air_mspi_local_file_name, METH_O, (char *)"\n"
		"\n"
