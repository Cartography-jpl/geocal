...
def test_create_cov():
    ...
    cov.core_set.append(
        GlasGfmCoreSet(GlasGfmCoreSet.ORBITAL_FRAME, GlasGfmCoreSet.SENSOR_FRAME)
    )
    ...
    glist.append(
        GlasGfmGroup(
            corr_ref_t=Time.parse_time("2021-10-19T12:00:00Z"),
            adjustable_parameter=[1, 2, 3],
            errcov_c1=cov_m,
            sr_spdcf_id=1,
            post_sub_alloc=True,
            post_start_t=Time.parse_time("2021-10-19T12:01:00Z"),
            post_delta=10.0,
            num_post=3,
