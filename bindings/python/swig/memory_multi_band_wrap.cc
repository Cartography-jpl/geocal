...
#define SWIGTYPE_p_GeoCal__MemoryMultiBand swig_types[23]
...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__MemoryMultiBand_t swig_types[81]
...
# endif
  ...
  GeoCal::swig_type_map[GeoCal::type_index(typeid(GeoCal::MemoryMultiBand))] =
  boost::shared_ptr<GeoCal::SwigTypeMapperBase>(new GeoCal::SwigTypeMapper< GeoCal::MemoryMultiBand >("boost::shared_ptr< GeoCal::MemoryMultiBand > *"));
