...
SWIGINTERN PyObject *_wrap_new_IgcCollectionOrbitData__SWIG_0(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  ...
  if ((nobjs < 6) || (nobjs > 6)) SWIG_fail;
  {
    ...
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "new_IgcCollectionOrbitData" "', argument " "1"" of type '" "std::vector< boost::shared_ptr< GeoCal::RasterImage >,std::allocator< boost::shared_ptr< GeoCal::RasterImage > > > const &""'"); 
    }
    arg1 = ptr;
  }
  {
  ...
  }
  {
    ...
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "new_IgcCollectionOrbitData" "', argument " "3"" of type '" "std::vector< std::string,std::allocator< std::string > > const &""'"); 
    }
    arg3 = ptr;
  }
  {
...
SWIGINTERN PyObject *_wrap_IgcCollectionOrbitData_add_image(PyObject *self, PyObject *args) {
  ...
  }
  {
    ...
    if (SWIG_IsOK(res3)) {
      ...
      if (!argp3) {
        SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "IgcCollectionOrbitData_add_image" "', argument " "3"" of type '" "GeoCal::Time const &""'"); 
      }
      if (newmem & SWIG_CAST_NEW_MEMORY) {
  ...
  }
  {
    ...
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "IgcCollectionOrbitData_add_image" "', argument " "4"" of type '" "std::string const &""'"); 
    }
    arg4 = ptr;
  }
  {
