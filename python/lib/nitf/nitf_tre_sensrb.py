...
desc = ["SENSRB",
        ...
        [["loop", "f.time_stamped_data_sets"],
         ...
         [["loop", "f.time_stamp_count[i1]"],
          ["time_stamp_time", "Time Stamp Time", 12, str],
          ["time_stamp_value", "Time Stamp Value", 11, float, {'condition' : "f.time_stamp_type eq 06a", "frmt": _6a_format}],
          ["time_stamp_value", "Time Stamp Value", 12, float, {'condition' : "f.time_stamp_type eq 06b", "frmt": _6b_format}],
          ["time_stamp_value", "Time Stamp Value", 11, float, {'condition' : "f.time_stamp_type eq 06c", "frmt": _6c_format}],
          ["time_stamp_value", "Time Stamp Value", 8, float, {'condition' : "f.time_stamp_type eq 06d", "frmt": _6d_format}],
          ["time_stamp_value", "Time Stamp Value", 8, float, {'condition' : "f.time_stamp_type eq 06e", "frmt": _6e_format}],
          ["time_stamp_value", "Time Stamp Value", 8, float, {'condition' : "f.time_stamp_type eq 06f", "frmt": _6f_format}],
          ...
          ["time_stamp_value", "Time Stamp Value", 10, float, {'condition' : "f.time_stamp_type eq 09a", "frmt": _9a_format}],
          ["time_stamp_value", "Time Stamp Value", 10, float, {'condition' : "f.time_stamp_type eq 09b", "frmt": _9b_format}],
          ["time_stamp_value", "Time Stamp Value", 10, float, {'condition' : "f.time_stamp_type eq 09c", "frmt": _9c_format}],
          ["time_stamp_value", "Time Stamp Value", 10, float, {'condition' : "f.time_stamp_type eq 09d", "frmt": _9d_format}],
