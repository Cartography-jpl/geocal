...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__LocationToFile_t swig_types[77]
...
# endif
  ...
  GeoCal::SwigTypeMapperBase::add(typeid(GeoCal::LocationToFile), boost::make_shared<GeoCal::SwigTypeMapper< GeoCal::LocationToFile > > ("boost::shared_ptr< GeoCal::LocationToFile > *"));
