...
#define SWIGTYPE_p_GeoCal__ArrayRasterImage swig_types[1]
...
#define SWIGTYPE_p_GeoCal__CalcRaster swig_types[4]
...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__ApplyMask_t swig_types[58]
