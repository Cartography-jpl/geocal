...
SWIGINTERN PyObject *_wrap_rsm_write_nitf(PyObject *self, PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "rsm_write_nitf", 2, 2, swig_obj)) SWIG_fail;
  {
    ...
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "rsm_write_nitf" "', argument " "1"" of type '" "std::string const &""'"); 
    }
    arg1 = ptr;
  }
  {
...
SWIGINTERN PyObject *_wrap_rsm_read_nitf(PyObject *self, PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "rsm_read_nitf", 2, 2, swig_obj)) SWIG_fail;
  {
    ...
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "rsm_read_nitf" "', argument " "1"" of type '" "std::string const &""'"); 
    }
    arg1 = ptr;
  }
