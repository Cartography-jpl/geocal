...
#define SWIG_name    "_vfunctor_with_derivative"
/* -----------------------------------------------------------------------------
...
#define SWIGTYPE_p_GeoCal__VFunctorWithDerivative swig_types[3]
...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__DFunctor_t swig_types[78]
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__GenericObject_t swig_types[79]
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__VFunctorWithDerivative_t swig_types[80]
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__VFunctor_t swig_types[81]
...
/*-----------------------------------------------
              @(target):= _vfunctor_with_derivative.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__vfunctor_with_derivative

#else
#  define SWIG_init    init_vfunctor_with_derivative
...
#include "vfunctor_with_derivative_wrap.h"
...
SWIGINTERN PyObject *_wrap_VFunctorWithDerivative_df(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  GeoCal::VFunctorWithDerivative *arg1 = (GeoCal::VFunctorWithDerivative *) 0 ;
  blitz::Array< double,1 > *arg2 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  boost::shared_ptr< GeoCal::VFunctorWithDerivative const > tempshared1 ;
  ...
  (void)self;
  if (!SWIG_Python_UnpackTuple(args, "VFunctorWithDerivative_df", 2, 2, swig_obj)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_GeoCal__VFunctorWithDerivative_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "VFunctorWithDerivative_df" "', argument " "1"" of type '" "GeoCal::VFunctorWithDerivative const *""'");
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
      tempshared1 = *reinterpret_cast< boost::shared_ptr< const GeoCal::VFunctorWithDerivative > * >(argp1);
      delete reinterpret_cast< boost::shared_ptr< const GeoCal::VFunctorWithDerivative > * >(argp1);
      arg1 = const_cast< GeoCal::VFunctorWithDerivative * >(tempshared1.get());
    } else {
      smartarg1 = reinterpret_cast< boost::shared_ptr< const GeoCal::VFunctorWithDerivative > * >(argp1);
      arg1 = const_cast< GeoCal::VFunctorWithDerivative * >((smartarg1 ? smartarg1->get() : 0));
    }
  }
  {
    ...
    if(!SWIG_IsOK(res)) {
      ...
      if(!numpy2.obj) {
        SWIG_Error(SWIG_TypeError, "in method 'VFunctorWithDerivative_df', expecting type  Array<double,1>");
        return NULL;
      }
  ...
  {
    try {
      result = ((GeoCal::VFunctorWithDerivative const *)arg1)->df((blitz::Array< double,1 > const &)*arg2);
...
SWIGINTERN PyObject *_wrap_VFunctorWithDerivative_f_and_df(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  GeoCal::VFunctorWithDerivative *arg1 = (GeoCal::VFunctorWithDerivative *) 0 ;
  blitz::Array< double,1 > *arg2 = 0 ;
  ...
  if (!SWIG_Python_UnpackTuple(args, "VFunctorWithDerivative_f_and_df", 2, 2, swig_obj)) SWIG_fail;
  {
    ...
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_GeoCal__VFunctorWithDerivative_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "VFunctorWithDerivative_f_and_df" "', argument " "1"" of type '" "GeoCal::VFunctorWithDerivative const *""'");
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
      tempshared1 = *reinterpret_cast< boost::shared_ptr< const GeoCal::VFunctorWithDerivative > * >(argp1);
      delete reinterpret_cast< boost::shared_ptr< const GeoCal::VFunctorWithDerivative > * >(argp1);
  ...
  }
  {
    ...
    if(!SWIG_IsOK(res)) {
      numpy2.obj = to_numpy<double >(swig_obj[1]);
      if(!numpy2.obj) {
        SWIG_Error(SWIG_TypeError, "in method 'VFunctorWithDerivative_f_and_df', expecting type  Array<double,1>");
        return NULL;
      }
      if(PyArray_NDIM((PyArrayObject*)numpy2.obj) !=1) {
        SWIG_Error(SWIG_TypeError, "in method 'VFunctorWithDerivative_f_and_df', expecting type  Array<double,1>");
...
SWIGINTERN PyObject *_wrap_delete_VFunctorWithDerivative(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  GeoCal::VFunctorWithDerivative *arg1 = (GeoCal::VFunctorWithDerivative *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  boost::shared_ptr< GeoCal::VFunctorWithDerivative > tempshared1 ;
  boost::shared_ptr< GeoCal::VFunctorWithDerivative > *smartarg1 = 0 ;
  PyObject *swig_obj[1] ;
  ...
  swig_obj[0] = args;
  {
    ...
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_GeoCal__VFunctorWithDerivative_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_VFunctorWithDerivative" "', argument " "1"" of type '" "GeoCal::VFunctorWithDerivative *""'");
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
      tempshared1 = *reinterpret_cast< boost::shared_ptr<  GeoCal::VFunctorWithDerivative > * >(argp1);
      delete reinterpret_cast< boost::shared_ptr<  GeoCal::VFunctorWithDerivative > * >(argp1);
      arg1 = const_cast< GeoCal::VFunctorWithDerivative * >(tempshared1.get());
    } else {
      smartarg1 = reinterpret_cast< boost::shared_ptr<  GeoCal::VFunctorWithDerivative > * >(argp1);
      arg1 = const_cast< GeoCal::VFunctorWithDerivative * >((smartarg1 ? smartarg1->get() : 0));
    }
  }
  {
...
SWIGINTERN PyObject *VFunctorWithDerivative_swigregister(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *obj = NULL;
  if (!SWIG_Python_UnpackTuple(args, "swigregister", 1, 1, &obj)) return NULL;
  SWIG_TypeNewClientData(SWIGTYPE_p_boost__shared_ptrT_GeoCal__VFunctorWithDerivative_t, SWIG_NewClientData(obj));
  return SWIG_Py_Void();
}
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "VFunctorWithDerivative_df", _wrap_VFunctorWithDerivative_df, METH_VARARGS, "\n"
		"VFunctorWithDerivative_df(VFunctorWithDerivative self, BlitzArray_double_1 X) -> BlitzArray_double_2\n"
		"\n"
		"GeoCal::VFunctorWithDerivative::df\n"
		"Return jacobian. J_ij = Df_i / dx_j.  \n"
		"\n"
		""},
	 { "VFunctorWithDerivative_f_and_df", _wrap_VFunctorWithDerivative_f_and_df, METH_VARARGS, "\n"
		"VFunctorWithDerivative_f_and_df(VFunctorWithDerivative self, BlitzArray_double_1 X)\n"
		"\n"
		"GeoCal::VFunctorWithDerivative::f_and_df\n"
		"Return both the value of the function and the Jacobian.  \n"
		"\n"
		"Often this can be calculated more quickly. The default implementation here just\n"
		"calls opererator() and df separately.  \n"
		"\n"
		""},
	 { "delete_VFunctorWithDerivative", _wrap_delete_VFunctorWithDerivative, METH_O, "delete_VFunctorWithDerivative(VFunctorWithDerivative self)"},
	 { "VFunctorWithDerivative_swigregister", VFunctorWithDerivative_swigregister, METH_O, NULL},
	 { NULL, NULL, 0, NULL }
};
...
static PyMethodDef SwigMethods_proxydocs[] = {
	 ...
	 { "SwigPyIterator_swigregister", SwigPyIterator_swigregister, METH_O, NULL},
	 { "VFunctorWithDerivative_df", _wrap_VFunctorWithDerivative_df, METH_VARARGS, "\n"
		"df(VFunctorWithDerivative self, BlitzArray_double_1 X) -> BlitzArray_double_2\n"
		"\n"
		"GeoCal::VFunctorWithDerivative::df\n"
		"Return jacobian. J_ij = Df_i / dx_j.  \n"
		"\n"
		""},
	 { "VFunctorWithDerivative_f_and_df", _wrap_VFunctorWithDerivative_f_and_df, METH_VARARGS, "\n"
		"f_and_df(VFunctorWithDerivative self, BlitzArray_double_1 X)\n"
		"\n"
		"GeoCal::VFunctorWithDerivative::f_and_df\n"
		"Return both the value of the function and the Jacobian.  \n"
		"\n"
...
static void *_p_GeoCal__VFunctorWithDerivativeTo_p_GeoCal__GenericObject(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((GeoCal::GenericObject *) (GeoCal::VFunctor *) ((GeoCal::VFunctorWithDerivative *) x));
}
static void *_p_GeoCal__VFunctorWithDerivativeTo_p_GeoCal__VFunctor(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((GeoCal::VFunctor *)  ((GeoCal::VFunctorWithDerivative *) x));
}
...
static void *_p_boost__shared_ptrT_GeoCal__VFunctorWithDerivative_tTo_p_boost__shared_ptrT_GeoCal__GenericObject_t(void *x, int *newmemory) {
    *newmemory = SWIG_CAST_NEW_MEMORY;
    return (void *) new boost::shared_ptr< GeoCal::GenericObject >(*(boost::shared_ptr< GeoCal::VFunctorWithDerivative > *)x);
}
static void *_p_boost__shared_ptrT_GeoCal__VFunctorWithDerivative_tTo_p_boost__shared_ptrT_GeoCal__VFunctor_t(void *x, int *newmemory) {
    *newmemory = SWIG_CAST_NEW_MEMORY;
    return (void *) new boost::shared_ptr< GeoCal::VFunctor >(*(boost::shared_ptr< GeoCal::VFunctorWithDerivative > *)x);
}
...
static swig_type_info _swigt__p_GeoCal__VFunctorWithDerivative = {"_p_GeoCal__VFunctorWithDerivative", "GeoCal::VFunctorWithDerivative *", 0, 0, (void*)0, 0};
...
static swig_type_info _swigt__p_boost__shared_ptrT_GeoCal__VFunctorWithDerivative_t = {"_p_boost__shared_ptrT_GeoCal__VFunctorWithDerivative_t", "boost::shared_ptr< GeoCal::VFunctorWithDerivative > *", 0, 0, (void*)0, 0};
...
static swig_type_info *swig_type_initial[] = {
  ...
  &_swigt__p_GeoCal__VFunctorWithDerivative,
  ...
  &_swigt__p_boost__shared_ptrT_GeoCal__VFunctorWithDerivative_t,
...
static swig_cast_info _swigc__p_GeoCal__GenericObject[] = {  {&_swigt__p_GeoCal__GenericObject, 0, 0, 0},  {&_swigt__p_GeoCal__DFunctor, _p_GeoCal__DFunctorTo_p_GeoCal__GenericObject, 0, 0},  {&_swigt__p_GeoCal__VFunctor, _p_GeoCal__VFunctorTo_p_GeoCal__GenericObject, 0, 0},  {&_swigt__p_GeoCal__VFunctorWithDerivative, _p_GeoCal__VFunctorWithDerivativeTo_p_GeoCal__GenericObject, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_GeoCal__VFunctor[] = {  {&_swigt__p_GeoCal__VFunctor, 0, 0, 0},  {&_swigt__p_GeoCal__VFunctorWithDerivative, _p_GeoCal__VFunctorWithDerivativeTo_p_GeoCal__VFunctor, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_GeoCal__VFunctorWithDerivative[] = {  {&_swigt__p_GeoCal__VFunctorWithDerivative, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_boost__shared_ptrT_GeoCal__GenericObject_t[] = {  {&_swigt__p_boost__shared_ptrT_GeoCal__GenericObject_t, 0, 0, 0},  {&_swigt__p_boost__shared_ptrT_GeoCal__DFunctor_t, _p_boost__shared_ptrT_GeoCal__DFunctor_tTo_p_boost__shared_ptrT_GeoCal__GenericObject_t, 0, 0},  {&_swigt__p_boost__shared_ptrT_GeoCal__VFunctorWithDerivative_t, _p_boost__shared_ptrT_GeoCal__VFunctorWithDerivative_tTo_p_boost__shared_ptrT_GeoCal__GenericObject_t, 0, 0},  {&_swigt__p_boost__shared_ptrT_GeoCal__VFunctor_t, _p_boost__shared_ptrT_GeoCal__VFunctor_tTo_p_boost__shared_ptrT_GeoCal__GenericObject_t, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_boost__shared_ptrT_GeoCal__VFunctorWithDerivative_t[] = {  {&_swigt__p_boost__shared_ptrT_GeoCal__VFunctorWithDerivative_t, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_boost__shared_ptrT_GeoCal__VFunctor_t[] = {  {&_swigt__p_boost__shared_ptrT_GeoCal__VFunctor_t, 0, 0, 0},  {&_swigt__p_boost__shared_ptrT_GeoCal__VFunctorWithDerivative_t, _p_boost__shared_ptrT_GeoCal__VFunctorWithDerivative_tTo_p_boost__shared_ptrT_GeoCal__VFunctor_t, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info *swig_cast_initial[] = {
  ...
  _swigc__p_GeoCal__VFunctorWithDerivative,
  ...
  _swigc__p_boost__shared_ptrT_GeoCal__VFunctorWithDerivative_t,
