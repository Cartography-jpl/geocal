...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_doughnut_average')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_doughnut_average')
...
class SwigPyIterator(object):
    ...
    def __iter__(self):
        return self
SwigPyIterator.value = new_instancemethod(_doughnut_average.SwigPyIterator_value, None, SwigPyIterator)
SwigPyIterator.incr = new_instancemethod(_doughnut_average.SwigPyIterator_incr, None, SwigPyIterator)
SwigPyIterator.decr = new_instancemethod(_doughnut_average.SwigPyIterator_decr, None, SwigPyIterator)
SwigPyIterator.distance = new_instancemethod(_doughnut_average.SwigPyIterator_distance, None, SwigPyIterator)
SwigPyIterator.equal = new_instancemethod(_doughnut_average.SwigPyIterator_equal, None, SwigPyIterator)
SwigPyIterator.copy = new_instancemethod(_doughnut_average.SwigPyIterator_copy, None, SwigPyIterator)
SwigPyIterator.next = new_instancemethod(_doughnut_average.SwigPyIterator_next, None, SwigPyIterator)
SwigPyIterator.__next__ = new_instancemethod(_doughnut_average.SwigPyIterator___next__, None, SwigPyIterator)
SwigPyIterator.previous = new_instancemethod(_doughnut_average.SwigPyIterator_previous, None, SwigPyIterator)
SwigPyIterator.advance = new_instancemethod(_doughnut_average.SwigPyIterator_advance, None, SwigPyIterator)
SwigPyIterator.__eq__ = new_instancemethod(_doughnut_average.SwigPyIterator___eq__, None, SwigPyIterator)
SwigPyIterator.__ne__ = new_instancemethod(_doughnut_average.SwigPyIterator___ne__, None, SwigPyIterator)
SwigPyIterator.__iadd__ = new_instancemethod(_doughnut_average.SwigPyIterator___iadd__, None, SwigPyIterator)
SwigPyIterator.__isub__ = new_instancemethod(_doughnut_average.SwigPyIterator___isub__, None, SwigPyIterator)
SwigPyIterator.__add__ = new_instancemethod(_doughnut_average.SwigPyIterator___add__, None, SwigPyIterator)
SwigPyIterator.__sub__ = new_instancemethod(_doughnut_average.SwigPyIterator___sub__, None, SwigPyIterator)
SwigPyIterator_swigregister = _doughnut_average.SwigPyIterator_swigregister
...
class DoughnutAverage(geocal_swig.calc_raster_multi_band.CalcRasterMultiBand):
    ...
    def cvdnorm(self, band, Lstart, Sstart, Number_line, Number_sample):
        """
        ...
        """
        return _doughnut_average.DoughnutAverage_cvdnorm(self, band, Lstart, Sstart, Number_line, Number_sample)


    def pandif(self, Lstart, Sstart, Number_line, Number_sample):
        """
        ...
        """
        return _doughnut_average.DoughnutAverage_pandif(self, Lstart, Sstart, Number_line, Number_sample)
