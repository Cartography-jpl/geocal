...
# endif
  ...
  GeoCal::SwigTypeMapperBase::add(typeid(GeoCal::VicarArgument), boost::make_shared<GeoCal::SwigTypeMapper< GeoCal::VicarArgument > > ("boost::shared_ptr< GeoCal::VicarArgument > *"));
