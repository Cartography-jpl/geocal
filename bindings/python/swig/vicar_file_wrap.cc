...
#define SWIGTYPE_p_GeoCal__Geocentric swig_types[21]
#define SWIGTYPE_p_GeoCal__Geodetic swig_types[22]
...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__Geocentric_t swig_types[100]
