...
#define SWIGTYPE_p_GeoCal__TiledFileBaseT_2_t swig_types[1]
...
#define SWIGTYPE_p_boost__arrayT_boost__multi_array_types__index_2_t swig_types[76]
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__GenericObject_t swig_types[77]
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__TiledFileBaseT_2_t_t swig_types[78]
...
#define SWIGTYPE_p_index swig_types[84]
...
#define SWIGTYPE_p_std__basic_iosT_char_t swig_types[95]
#define SWIGTYPE_p_std__basic_iostreamT_char_t swig_types[96]
#define SWIGTYPE_p_std__basic_istreamT_char_t swig_types[97]
#define SWIGTYPE_p_std__basic_ostreamT_char_t swig_types[98]
...
/*-----------------------------------------------
              @(target):= _tiled_file.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__tiled_file

#else
#  define SWIG_init    init_tiled_file
...
SWIGINTERN PyObject *_wrap_TiledFileBase_2__v_number_swap(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  GeoCal::TiledFileBase< 2 > *arg1 = (GeoCal::TiledFileBase< 2 > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  boost::shared_ptr< GeoCal::TiledFileBase< 2 > const > tempshared1 ;
  boost::shared_ptr< GeoCal::TiledFileBase< 2 > const > *smartarg1 = 0 ;
  PyObject *swig_obj[1] ;
  int result;
  ...
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_GeoCal__TiledFileBaseT_2_t_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "TiledFileBase_2__v_number_swap" "', argument " "1"" of type '" "GeoCal::TiledFileBase< 2 > const *""'");
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
      tempshared1 = *reinterpret_cast< boost::shared_ptr< const GeoCal::TiledFileBase<2> > * >(argp1);
      delete reinterpret_cast< boost::shared_ptr< const GeoCal::TiledFileBase<2> > * >(argp1);
      arg1 = const_cast< GeoCal::TiledFileBase< 2 > * >(tempshared1.get());
    } else {
      smartarg1 = reinterpret_cast< boost::shared_ptr< const GeoCal::TiledFileBase<2> > * >(argp1);
      arg1 = const_cast< GeoCal::TiledFileBase< 2 > * >((smartarg1 ? smartarg1->get() : 0));
    }
  }
  {
    try {
      result = (int)((GeoCal::TiledFileBase< 2 > const *)arg1)->number_swap();
...
SWIGINTERN PyObject *_wrap_TiledFileBase_2_reset_number_swap(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  GeoCal::TiledFileBase< 2 > *arg1 = (GeoCal::TiledFileBase< 2 > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  boost::shared_ptr< GeoCal::TiledFileBase< 2 > > tempshared1 ;
  boost::shared_ptr< GeoCal::TiledFileBase< 2 > > *smartarg1 = 0 ;
  PyObject *swig_obj[1] ;
  ...
  swig_obj[0] = args;
  {
    ...
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_GeoCal__TiledFileBaseT_2_t_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "TiledFileBase_2_reset_number_swap" "', argument " "1"" of type '" "GeoCal::TiledFileBase< 2 > *""'");
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
      tempshared1 = *reinterpret_cast< boost::shared_ptr<  GeoCal::TiledFileBase<2> > * >(argp1);
      delete reinterpret_cast< boost::shared_ptr<  GeoCal::TiledFileBase<2> > * >(argp1);
      arg1 = const_cast< GeoCal::TiledFileBase< 2 > * >(tempshared1.get());
    } else {
      smartarg1 = reinterpret_cast< boost::shared_ptr<  GeoCal::TiledFileBase<2> > * >(argp1);
      arg1 = const_cast< GeoCal::TiledFileBase< 2 > * >((smartarg1 ? smartarg1->get() : 0));
    }
  }
  {
...
SWIGINTERN PyObject *_wrap_TiledFileBase_2__v_size(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  GeoCal::TiledFileBase< 2 > *arg1 = (GeoCal::TiledFileBase< 2 > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  swig_obj[0] = args;
  {
    ...
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_GeoCal__TiledFileBaseT_2_t_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "TiledFileBase_2__v_size" "', argument " "1"" of type '" "GeoCal::TiledFileBase< 2 > const *""'");
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
      tempshared1 = *reinterpret_cast< boost::shared_ptr< const GeoCal::TiledFileBase<2> > * >(argp1);
      delete reinterpret_cast< boost::shared_ptr< const GeoCal::TiledFileBase<2> > * >(argp1);
  ...
  {
    try {
      result = ((GeoCal::TiledFileBase< 2 > const *)arg1)->size();
    } catch (Swig::DirectorException &e) {
      SWIG_fail; 
    } catch (const std::exception& e) {
      SWIG_exception(SWIG_RuntimeError, e.what());
  ...
  resultobj = SWIG_NewPointerObj((new boost::array< GeoCal::TiledFileBase< 2 >::index,2 >(result)), SWIGTYPE_p_boost__arrayT_boost__multi_array_types__index_2_t, SWIG_POINTER_OWN |  0 );
  return resultobj;
fail:
  return NULL;
}
...
SWIGINTERN PyObject *_wrap_TiledFileBase_2__v_tile_size(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  GeoCal::TiledFileBase< 2 > *arg1 = (GeoCal::TiledFileBase< 2 > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  swig_obj[0] = args;
  {
    ...
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_GeoCal__TiledFileBaseT_2_t_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "TiledFileBase_2__v_tile_size" "', argument " "1"" of type '" "GeoCal::TiledFileBase< 2 > const *""'");
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
      tempshared1 = *reinterpret_cast< boost::shared_ptr< const GeoCal::TiledFileBase<2> > * >(argp1);
      delete reinterpret_cast< boost::shared_ptr< const GeoCal::TiledFileBase<2> > * >(argp1);
  ...
  {
    try {
      result = ((GeoCal::TiledFileBase< 2 > const *)arg1)->tile_size();
    } catch (Swig::DirectorException &e) {
      SWIG_fail; 
    } catch (const std::exception& e) {
      SWIG_exception(SWIG_RuntimeError, e.what());
...
SWIGINTERN PyObject *_wrap_TiledFileBase_2_get_int(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  GeoCal::TiledFileBase< 2 > *arg1 = (GeoCal::TiledFileBase< 2 > *) 0 ;
  boost::array< GeoCal::TiledFileBase< 2 >::index,2 > *arg2 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  boost::shared_ptr< GeoCal::TiledFileBase< 2 > const > tempshared1 ;
  boost::shared_ptr< GeoCal::TiledFileBase< 2 > const > *smartarg1 = 0 ;
  ...
  (void)self;
  if (!SWIG_Python_UnpackTuple(args, "TiledFileBase_2_get_int", 2, 2, swig_obj)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_GeoCal__TiledFileBaseT_2_t_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "TiledFileBase_2_get_int" "', argument " "1"" of type '" "GeoCal::TiledFileBase< 2 > const *""'");
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
      tempshared1 = *reinterpret_cast< boost::shared_ptr< const GeoCal::TiledFileBase<2> > * >(argp1);
      delete reinterpret_cast< boost::shared_ptr< const GeoCal::TiledFileBase<2> > * >(argp1);
  ...
  res2 = SWIG_ConvertPtr(swig_obj[1], &argp2, SWIGTYPE_p_boost__arrayT_boost__multi_array_types__index_2_t,  0  | 0);
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "TiledFileBase_2_get_int" "', argument " "2"" of type '" "boost::array< GeoCal::TiledFileBase< 2 >::index,2 > const &""'"); 
  }
  if (!argp2) {
    SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "TiledFileBase_2_get_int" "', argument " "2"" of type '" "boost::array< GeoCal::TiledFileBase< 2 >::index,2 > const &""'"); 
  }
  arg2 = reinterpret_cast< boost::array< GeoCal::TiledFileBase< 2 >::index,2 > * >(argp2);
  {
    try {
      result = (int)((GeoCal::TiledFileBase< 2 > const *)arg1)->get_int((boost::array< GeoCal::TiledFileBase< 2 >::index,2 > const &)*arg2);
    } catch (Swig::DirectorException &e) {
      SWIG_fail; 
    } catch (const std::exception& e) {
      SWIG_exception(SWIG_RuntimeError, e.what());
...
SWIGINTERN PyObject *_wrap_TiledFileBase_2_get_double(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  GeoCal::TiledFileBase< 2 > *arg1 = (GeoCal::TiledFileBase< 2 > *) 0 ;
  boost::array< GeoCal::TiledFileBase< 2 >::index,2 > *arg2 = 0 ;
  void *argp1 = 0 ;
  ...
  (void)self;
  if (!SWIG_Python_UnpackTuple(args, "TiledFileBase_2_get_double", 2, 2, swig_obj)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_GeoCal__TiledFileBaseT_2_t_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "TiledFileBase_2_get_double" "', argument " "1"" of type '" "GeoCal::TiledFileBase< 2 > const *""'");
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
      tempshared1 = *reinterpret_cast< boost::shared_ptr< const GeoCal::TiledFileBase<2> > * >(argp1);
      delete reinterpret_cast< boost::shared_ptr< const GeoCal::TiledFileBase<2> > * >(argp1);
  ...
  res2 = SWIG_ConvertPtr(swig_obj[1], &argp2, SWIGTYPE_p_boost__arrayT_boost__multi_array_types__index_2_t,  0  | 0);
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "TiledFileBase_2_get_double" "', argument " "2"" of type '" "boost::array< GeoCal::TiledFileBase< 2 >::index,2 > const &""'"); 
  }
  if (!argp2) {
    SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "TiledFileBase_2_get_double" "', argument " "2"" of type '" "boost::array< GeoCal::TiledFileBase< 2 >::index,2 > const &""'"); 
  }
  arg2 = reinterpret_cast< boost::array< GeoCal::TiledFileBase< 2 >::index,2 > * >(argp2);
  {
    try {
      result = (double)((GeoCal::TiledFileBase< 2 > const *)arg1)->get_double((boost::array< GeoCal::TiledFileBase< 2 >::index,2 > const &)*arg2);
    } catch (Swig::DirectorException &e) {
      SWIG_fail; 
    } catch (const std::exception& e) {
      SWIG_exception(SWIG_RuntimeError, e.what());
...
SWIGINTERN PyObject *_wrap_TiledFileBase_2_read_int(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  GeoCal::TiledFileBase< 2 > *arg1 = (GeoCal::TiledFileBase< 2 > *) 0 ;
  boost::array< GeoCal::TiledFileBase< 2 >::index,2 > *arg2 = 0 ;
  boost::array< GeoCal::TiledFileBase< 2 >::index,2 > *arg3 = 0 ;
  int *arg4 = (int *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  boost::shared_ptr< GeoCal::TiledFileBase< 2 > const > tempshared1 ;
  ...
  (void)self;
  if (!SWIG_Python_UnpackTuple(args, "TiledFileBase_2_read_int", 4, 4, swig_obj)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_GeoCal__TiledFileBaseT_2_t_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "TiledFileBase_2_read_int" "', argument " "1"" of type '" "GeoCal::TiledFileBase< 2 > const *""'");
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
      tempshared1 = *reinterpret_cast< boost::shared_ptr< const GeoCal::TiledFileBase<2> > * >(argp1);
      delete reinterpret_cast< boost::shared_ptr< const GeoCal::TiledFileBase<2> > * >(argp1);
  ...
  res2 = SWIG_ConvertPtr(swig_obj[1], &argp2, SWIGTYPE_p_boost__arrayT_boost__multi_array_types__index_2_t,  0  | 0);
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "TiledFileBase_2_read_int" "', argument " "2"" of type '" "boost::array< GeoCal::TiledFileBase< 2 >::index,2 > const &""'"); 
  }
  if (!argp2) {
    SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "TiledFileBase_2_read_int" "', argument " "2"" of type '" "boost::array< GeoCal::TiledFileBase< 2 >::index,2 > const &""'"); 
  }
  arg2 = reinterpret_cast< boost::array< GeoCal::TiledFileBase< 2 >::index,2 > * >(argp2);
  res3 = SWIG_ConvertPtr(swig_obj[2], &argp3, SWIGTYPE_p_boost__arrayT_boost__multi_array_types__index_2_t,  0  | 0);
  if (!SWIG_IsOK(res3)) {
    SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "TiledFileBase_2_read_int" "', argument " "3"" of type '" "boost::array< GeoCal::TiledFileBase< 2 >::index,2 > const &""'"); 
  }
  if (!argp3) {
    SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "TiledFileBase_2_read_int" "', argument " "3"" of type '" "boost::array< GeoCal::TiledFileBase< 2 >::index,2 > const &""'"); 
  }
  arg3 = reinterpret_cast< boost::array< GeoCal::TiledFileBase< 2 >::index,2 > * >(argp3);
  res4 = SWIG_ConvertPtr(swig_obj[3], &argp4,SWIGTYPE_p_int, 0 |  0 );
  if (!SWIG_IsOK(res4)) {
    SWIG_exception_fail(SWIG_ArgError(res4), "in method '" "TiledFileBase_2_read_int" "', argument " "4"" of type '" "int *""'"); 
  }
  arg4 = reinterpret_cast< int * >(argp4);
  {
    try {
      ((GeoCal::TiledFileBase< 2 > const *)arg1)->read_int((boost::array< GeoCal::TiledFileBase< 2 >::index,2 > const &)*arg2,(boost::array< GeoCal::TiledFileBase< 2 >::index,2 > const &)*arg3,arg4);
    } catch (Swig::DirectorException &e) {
      SWIG_fail; 
    } catch (const std::exception& e) {
      SWIG_exception(SWIG_RuntimeError, e.what());
...
SWIGINTERN PyObject *_wrap_TiledFileBase_2_read_double(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  GeoCal::TiledFileBase< 2 > *arg1 = (GeoCal::TiledFileBase< 2 > *) 0 ;
  boost::array< GeoCal::TiledFileBase< 2 >::index,2 > *arg2 = 0 ;
  boost::array< GeoCal::TiledFileBase< 2 >::index,2 > *arg3 = 0 ;
  ...
  (void)self;
  if (!SWIG_Python_UnpackTuple(args, "TiledFileBase_2_read_double", 4, 4, swig_obj)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_GeoCal__TiledFileBaseT_2_t_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "TiledFileBase_2_read_double" "', argument " "1"" of type '" "GeoCal::TiledFileBase< 2 > const *""'");
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
      tempshared1 = *reinterpret_cast< boost::shared_ptr< const GeoCal::TiledFileBase<2> > * >(argp1);
      delete reinterpret_cast< boost::shared_ptr< const GeoCal::TiledFileBase<2> > * >(argp1);
  ...
  res2 = SWIG_ConvertPtr(swig_obj[1], &argp2, SWIGTYPE_p_boost__arrayT_boost__multi_array_types__index_2_t,  0  | 0);
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "TiledFileBase_2_read_double" "', argument " "2"" of type '" "boost::array< GeoCal::TiledFileBase< 2 >::index,2 > const &""'"); 
  }
  if (!argp2) {
    SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "TiledFileBase_2_read_double" "', argument " "2"" of type '" "boost::array< GeoCal::TiledFileBase< 2 >::index,2 > const &""'"); 
  }
  arg2 = reinterpret_cast< boost::array< GeoCal::TiledFileBase< 2 >::index,2 > * >(argp2);
  res3 = SWIG_ConvertPtr(swig_obj[2], &argp3, SWIGTYPE_p_boost__arrayT_boost__multi_array_types__index_2_t,  0  | 0);
  if (!SWIG_IsOK(res3)) {
    SWIG_exception_fail(SWIG_ArgError(res3), "in method '" "TiledFileBase_2_read_double" "', argument " "3"" of type '" "boost::array< GeoCal::TiledFileBase< 2 >::index,2 > const &""'"); 
  }
  if (!argp3) {
    SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "TiledFileBase_2_read_double" "', argument " "3"" of type '" "boost::array< GeoCal::TiledFileBase< 2 >::index,2 > const &""'"); 
  }
  arg3 = reinterpret_cast< boost::array< GeoCal::TiledFileBase< 2 >::index,2 > * >(argp3);
  res4 = SWIG_ConvertPtr(swig_obj[3], &argp4,SWIGTYPE_p_double, 0 |  0 );
  if (!SWIG_IsOK(res4)) {
    SWIG_exception_fail(SWIG_ArgError(res4), "in method '" "TiledFileBase_2_read_double" "', argument " "4"" of type '" "double *""'"); 
  }
  arg4 = reinterpret_cast< double * >(argp4);
  {
    try {
      ((GeoCal::TiledFileBase< 2 > const *)arg1)->read_double((boost::array< GeoCal::TiledFileBase< 2 >::index,2 > const &)*arg2,(boost::array< GeoCal::TiledFileBase< 2 >::index,2 > const &)*arg3,arg4);
    } catch (Swig::DirectorException &e) {
      SWIG_fail; 
    } catch (const std::exception& e) {
      SWIG_exception(SWIG_RuntimeError, e.what());
...
SWIGINTERN PyObject *_wrap_TiledFileBase_2_write_int(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  GeoCal::TiledFileBase< 2 > *arg1 = (GeoCal::TiledFileBase< 2 > *) 0 ;
  boost::array< GeoCal::TiledFileBase< 2 >::index,2 > *arg2 = 0 ;
  int arg3 ;
  ...
  (void)self;
  if (!SWIG_Python_UnpackTuple(args, "TiledFileBase_2_write_int", 3, 3, swig_obj)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_GeoCal__TiledFileBaseT_2_t_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "TiledFileBase_2_write_int" "', argument " "1"" of type '" "GeoCal::TiledFileBase< 2 > *""'");
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
      tempshared1 = *reinterpret_cast< boost::shared_ptr<  GeoCal::TiledFileBase<2> > * >(argp1);
      delete reinterpret_cast< boost::shared_ptr<  GeoCal::TiledFileBase<2> > * >(argp1);
  ...
  res2 = SWIG_ConvertPtr(swig_obj[1], &argp2, SWIGTYPE_p_boost__arrayT_boost__multi_array_types__index_2_t,  0  | 0);
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "TiledFileBase_2_write_int" "', argument " "2"" of type '" "boost::array< GeoCal::TiledFileBase< 2 >::index,2 > const &""'"); 
  }
  if (!argp2) {
    SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "TiledFileBase_2_write_int" "', argument " "2"" of type '" "boost::array< GeoCal::TiledFileBase< 2 >::index,2 > const &""'"); 
  }
  arg2 = reinterpret_cast< boost::array< GeoCal::TiledFileBase< 2 >::index,2 > * >(argp2);
  ecode3 = SWIG_AsVal_int(swig_obj[2], &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "TiledFileBase_2_write_int" "', argument " "3"" of type '" "int""'");
  } 
  arg3 = static_cast< int >(val3);
  {
    try {
      (arg1)->write_int((boost::array< GeoCal::TiledFileBase< 2 >::index,2 > const &)*arg2,arg3);
    } catch (Swig::DirectorException &e) {
      SWIG_fail; 
    } catch (const std::exception& e) {
      SWIG_exception(SWIG_RuntimeError, e.what());
...
SWIGINTERN PyObject *_wrap_TiledFileBase_2_write_double(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  GeoCal::TiledFileBase< 2 > *arg1 = (GeoCal::TiledFileBase< 2 > *) 0 ;
  boost::array< GeoCal::TiledFileBase< 2 >::index,2 > *arg2 = 0 ;
  double arg3 ;
  ...
  (void)self;
  if (!SWIG_Python_UnpackTuple(args, "TiledFileBase_2_write_double", 3, 3, swig_obj)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_GeoCal__TiledFileBaseT_2_t_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "TiledFileBase_2_write_double" "', argument " "1"" of type '" "GeoCal::TiledFileBase< 2 > *""'");
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
      tempshared1 = *reinterpret_cast< boost::shared_ptr<  GeoCal::TiledFileBase<2> > * >(argp1);
      delete reinterpret_cast< boost::shared_ptr<  GeoCal::TiledFileBase<2> > * >(argp1);
  ...
  res2 = SWIG_ConvertPtr(swig_obj[1], &argp2, SWIGTYPE_p_boost__arrayT_boost__multi_array_types__index_2_t,  0  | 0);
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "TiledFileBase_2_write_double" "', argument " "2"" of type '" "boost::array< GeoCal::TiledFileBase< 2 >::index,2 > const &""'"); 
  }
  if (!argp2) {
    SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "TiledFileBase_2_write_double" "', argument " "2"" of type '" "boost::array< GeoCal::TiledFileBase< 2 >::index,2 > const &""'"); 
  }
  arg2 = reinterpret_cast< boost::array< GeoCal::TiledFileBase< 2 >::index,2 > * >(argp2);
  ecode3 = SWIG_AsVal_double(swig_obj[2], &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "TiledFileBase_2_write_double" "', argument " "3"" of type '" "double""'");
  } 
  arg3 = static_cast< double >(val3);
  {
    try {
      (arg1)->write_double((boost::array< GeoCal::TiledFileBase< 2 >::index,2 > const &)*arg2,arg3);
    } catch (Swig::DirectorException &e) {
      SWIG_fail; 
    } catch (const std::exception& e) {
      SWIG_exception(SWIG_RuntimeError, e.what());
...
SWIGINTERN PyObject *_wrap_delete_TiledFileBase_2(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  GeoCal::TiledFileBase< 2 > *arg1 = (GeoCal::TiledFileBase< 2 > *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  swig_obj[0] = args;
  {
    ...
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_GeoCal__TiledFileBaseT_2_t_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_TiledFileBase_2" "', argument " "1"" of type '" "GeoCal::TiledFileBase< 2 > *""'");
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
      tempshared1 = *reinterpret_cast< boost::shared_ptr<  GeoCal::TiledFileBase<2> > * >(argp1);
      delete reinterpret_cast< boost::shared_ptr<  GeoCal::TiledFileBase<2> > * >(argp1);
...
SWIGINTERN PyObject *TiledFileBase_2_swigregister(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *obj = NULL;
  if (!SWIG_Python_UnpackTuple(args, "swigregister", 1, 1, &obj)) return NULL;
  SWIG_TypeNewClientData(SWIGTYPE_p_boost__shared_ptrT_GeoCal__TiledFileBaseT_2_t_t, SWIG_NewClientData(obj));
  return SWIG_Py_Void();
}
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "TiledFileBase_2__v_number_swap", _wrap_TiledFileBase_2__v_number_swap, METH_O, "\n"
		"TiledFileBase_2__v_number_swap(TiledFileBase_2 self) -> int\n"
		"\n"
		"GeoCal::TiledFileBase::number_swap\n"
		"Number of times we have swapped a tile since reset_number_swap called.  \n"
		"\n"
		""},
	 { "TiledFileBase_2_reset_number_swap", _wrap_TiledFileBase_2_reset_number_swap, METH_O, "\n"
		"TiledFileBase_2_reset_number_swap(TiledFileBase_2 self)\n"
		"\n"
		"GeoCal::TiledFileBase::reset_number_swap\n"
		"Reset number of swap counter to 0.  \n"
		"\n"
		""},
	 { "TiledFileBase_2__v_size", _wrap_TiledFileBase_2__v_size, METH_O, "\n"
		"TiledFileBase_2__v_size(TiledFileBase_2 self) -> boost::array< GeoCal::TiledFileBase< 2 >::index,2 >\n"
		"\n"
		"GeoCal::TiledFileBase::size\n"
		"File size.  \n"
		"\n"
		""},
	 { "TiledFileBase_2__v_tile_size", _wrap_TiledFileBase_2__v_tile_size, METH_O, "\n"
		"TiledFileBase_2__v_tile_size(TiledFileBase_2 self) -> boost::array< GeoCal::TiledFileBase< 2 >::index,2 >\n"
		"\n"
		"GeoCal::TiledFileBase::tile_size\n"
		"Tile size.  \n"
		"\n"
		""},
	 { "TiledFileBase_2_get_int", _wrap_TiledFileBase_2_get_int, METH_VARARGS, "\n"
		"TiledFileBase_2_get_int(TiledFileBase_2 self, boost::array< GeoCal::TiledFileBase< 2 >::index,2 > const & Index) -> int\n"
		"\n"
		"GeoCal::TiledFileBase::get_int\n"
		"Get data an convert to integer.  \n"
		"\n"
		""},
	 { "TiledFileBase_2_get_double", _wrap_TiledFileBase_2_get_double, METH_VARARGS, "\n"
		"TiledFileBase_2_get_double(TiledFileBase_2 self, boost::array< GeoCal::TiledFileBase< 2 >::index,2 > const & Index) -> double\n"
		"\n"
		"GeoCal::TiledFileBase::get_double\n"
		"Get data an convert to double.  \n"
		"\n"
		""},
	 { "TiledFileBase_2_read_int", _wrap_TiledFileBase_2_read_int, METH_VARARGS, "\n"
		"TiledFileBase_2_read_int(TiledFileBase_2 self, boost::array< GeoCal::TiledFileBase< 2 >::index,2 > const & Min_index, boost::array< GeoCal::TiledFileBase< 2 >::index,2 > const & Max_index, int * Res)\n"
		"\n"
		"GeoCal::TiledFileBase::read_int\n"
		"Read a subset of the data, and convert to int.  \n"
		"\n"
		""},
	 { "TiledFileBase_2_read_double", _wrap_TiledFileBase_2_read_double, METH_VARARGS, "\n"
		"TiledFileBase_2_read_double(TiledFileBase_2 self, boost::array< GeoCal::TiledFileBase< 2 >::index,2 > const & Min_index, boost::array< GeoCal::TiledFileBase< 2 >::index,2 > const & Max_index, double * Res)\n"
		"\n"
		"GeoCal::TiledFileBase::read_double\n"
		"Read a subset of the data, and convert to double.  \n"
		"\n"
		""},
	 { "TiledFileBase_2_write_int", _wrap_TiledFileBase_2_write_int, METH_VARARGS, "\n"
		"TiledFileBase_2_write_int(TiledFileBase_2 self, boost::array< GeoCal::TiledFileBase< 2 >::index,2 > const & Index, int Val)\n"
		"\n"
		"GeoCal::TiledFileBase::write_int\n"
		"Convert an int to type T, and write to file.  \n"
		"\n"
		""},
	 { "TiledFileBase_2_write_double", _wrap_TiledFileBase_2_write_double, METH_VARARGS, "\n"
		"TiledFileBase_2_write_double(TiledFileBase_2 self, boost::array< GeoCal::TiledFileBase< 2 >::index,2 > const & Index, double Val)\n"
		"\n"
		"GeoCal::TiledFileBase::write_double\n"
		"Convert a double to type T, and write to file.  \n"
		"\n"
		""},
	 { "delete_TiledFileBase_2", _wrap_delete_TiledFileBase_2, METH_O, "\n"
		"delete_TiledFileBase_2(TiledFileBase_2 self)\n"
		"\n"
		"GeoCal::TiledFileBase::~TiledFileBase\n"
		"Destructor.  \n"
		"\n"
		""},
	 { "TiledFileBase_2_swigregister", TiledFileBase_2_swigregister, METH_O, NULL},
	 { NULL, NULL, 0, NULL }
};
...
static PyMethodDef SwigMethods_proxydocs[] = {
	 ...
	 { "SwigPyIterator_swigregister", SwigPyIterator_swigregister, METH_O, NULL},
	 { "TiledFileBase_2__v_number_swap", _wrap_TiledFileBase_2__v_number_swap, METH_O, "\n"
		"_v_number_swap(TiledFileBase_2 self) -> int\n"
		"\n"
		"GeoCal::TiledFileBase::number_swap\n"
		"Number of times we have swapped a tile since reset_number_swap called.  \n"
		"\n"
		""},
	 { "TiledFileBase_2_reset_number_swap", _wrap_TiledFileBase_2_reset_number_swap, METH_O, "\n"
		"reset_number_swap(TiledFileBase_2 self)\n"
		"\n"
		"GeoCal::TiledFileBase::reset_number_swap\n"
		"Reset number of swap counter to 0.  \n"
		"\n"
		""},
	 { "TiledFileBase_2__v_size", _wrap_TiledFileBase_2__v_size, METH_O, "\n"
		"_v_size(TiledFileBase_2 self) -> boost::array< GeoCal::TiledFileBase< 2 >::index,2 >\n"
		"\n"
		"GeoCal::TiledFileBase::size\n"
		"File size.  \n"
		"\n"
		""},
	 { "TiledFileBase_2__v_tile_size", _wrap_TiledFileBase_2__v_tile_size, METH_O, "\n"
		"_v_tile_size(TiledFileBase_2 self) -> boost::array< GeoCal::TiledFileBase< 2 >::index,2 >\n"
		"\n"
		"GeoCal::TiledFileBase::tile_size\n"
		"Tile size.  \n"
		"\n"
		""},
	 { "TiledFileBase_2_get_int", _wrap_TiledFileBase_2_get_int, METH_VARARGS, "\n"
		"get_int(TiledFileBase_2 self, boost::array< GeoCal::TiledFileBase< 2 >::index,2 > const & Index) -> int\n"
		"\n"
		"GeoCal::TiledFileBase::get_int\n"
		"Get data an convert to integer.  \n"
		"\n"
		""},
	 { "TiledFileBase_2_get_double", _wrap_TiledFileBase_2_get_double, METH_VARARGS, "\n"
		"get_double(TiledFileBase_2 self, boost::array< GeoCal::TiledFileBase< 2 >::index,2 > const & Index) -> double\n"
		"\n"
		"GeoCal::TiledFileBase::get_double\n"
		"Get data an convert to double.  \n"
		"\n"
		""},
	 { "TiledFileBase_2_read_int", _wrap_TiledFileBase_2_read_int, METH_VARARGS, "\n"
		"read_int(TiledFileBase_2 self, boost::array< GeoCal::TiledFileBase< 2 >::index,2 > const & Min_index, boost::array< GeoCal::TiledFileBase< 2 >::index,2 > const & Max_index, int * Res)\n"
		"\n"
		"GeoCal::TiledFileBase::read_int\n"
		"Read a subset of the data, and convert to int.  \n"
		"\n"
		""},
	 { "TiledFileBase_2_read_double", _wrap_TiledFileBase_2_read_double, METH_VARARGS, "\n"
		"read_double(TiledFileBase_2 self, boost::array< GeoCal::TiledFileBase< 2 >::index,2 > const & Min_index, boost::array< GeoCal::TiledFileBase< 2 >::index,2 > const & Max_index, double * Res)\n"
		"\n"
		"GeoCal::TiledFileBase::read_double\n"
		"Read a subset of the data, and convert to double.  \n"
		"\n"
		""},
	 { "TiledFileBase_2_write_int", _wrap_TiledFileBase_2_write_int, METH_VARARGS, "\n"
		"write_int(TiledFileBase_2 self, boost::array< GeoCal::TiledFileBase< 2 >::index,2 > const & Index, int Val)\n"
		"\n"
		"GeoCal::TiledFileBase::write_int\n"
		"Convert an int to type T, and write to file.  \n"
		"\n"
		""},
	 { "TiledFileBase_2_write_double", _wrap_TiledFileBase_2_write_double, METH_VARARGS, "\n"
		"write_double(TiledFileBase_2 self, boost::array< GeoCal::TiledFileBase< 2 >::index,2 > const & Index, double Val)\n"
		"\n"
		"GeoCal::TiledFileBase::write_double\n"
		"Convert a double to type T, and write to file.  \n"
		"\n"
...
static swig_type_info _swigt__p_boost__arrayT_boost__multi_array_types__index_2_t = {"_p_boost__arrayT_boost__multi_array_types__index_2_t", "boost::array< GeoCal::TiledFileBase< 2 >::index,2 > *|boost::array< boost::multi_array_types::index,2 > *", 0, 0, (void*)0, 0};
...
static swig_type_info *swig_type_initial[] = {
  ...
  &_swigt__p_boost__arrayT_boost__multi_array_types__index_2_t,
...
static swig_cast_info _swigc__p_GeoCal__GenericObject[] = {  {&_swigt__p_GeoCal__GenericObject, 0, 0, 0},  {&_swigt__p_GeoCal__TiledFileBaseT_2_t, _p_GeoCal__TiledFileBaseT_2_tTo_p_GeoCal__GenericObject, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_boost__arrayT_boost__multi_array_types__index_2_t[] = {  {&_swigt__p_boost__arrayT_boost__multi_array_types__index_2_t, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_boost__shared_ptrT_GeoCal__GenericObject_t[] = {  {&_swigt__p_boost__shared_ptrT_GeoCal__GenericObject_t, 0, 0, 0},  {&_swigt__p_boost__shared_ptrT_GeoCal__TiledFileBaseT_2_t_t, _p_boost__shared_ptrT_GeoCal__TiledFileBaseT_2_t_tTo_p_boost__shared_ptrT_GeoCal__GenericObject_t, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info *swig_cast_initial[] = {
  ...
  _swigc__p_boost__arrayT_boost__multi_array_types__index_2_t,
...
# endif
  ...
  GeoCal::SwigTypeMapperBase::add(typeid(GeoCal::TiledFileBase<2>), boost::make_shared<GeoCal::SwigTypeMapper< GeoCal::TiledFileBase<2> > > ("boost::shared_ptr< GeoCal::TiledFileBase<2> > *"));
