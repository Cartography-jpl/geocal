...
# endif
  ...
  SWIG_addvarlink(globals, "wgs84_a", Swig_var_wgs84_a_get, Swig_var_wgs84_a_set);
  SWIG_addvarlink(globals, "wgs84_b", Swig_var_wgs84_b_get, Swig_var_wgs84_b_set);
  SWIG_addvarlink(globals, "wgs84_esq", Swig_var_wgs84_esq_get, Swig_var_wgs84_esq_set);
#if PY_VERSION_HEX >= 0x03000000
  return m;
#else
  return;
