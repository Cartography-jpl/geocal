...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__RawRasterImage_t swig_types[65]
...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__VicarImageCoordinate_t swig_types[69]
