...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__SpotCamera_t swig_types[61]
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__TimeWithDerivative_t swig_types[62]
