...
#define SWIGTYPE_p_GeoCal__RollingShutterConstantTimeTable swig_types[14]
...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__RollingShutterConstantTimeTable_t swig_types[109]
