...
SWIGINTERN PyObject *_wrap_IgcMsp_joint_covariance(PyObject *self, PyObject *args) {
  ...
  }
  {
    ...
    if (SWIG_IsOK(res2)) {
      ...
      if (!argp2) {
        SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "IgcMsp_joint_covariance" "', argument " "2"" of type '" "GeoCal::IgcMsp const &""'"); 
      }
      if (newmem & SWIG_CAST_NEW_MEMORY) {
...
SWIGINTERN PyObject *_wrap_IgcMsp_msp_register_plugin(PyObject *self, PyObject *args) {
  ...
  swig_obj[0] = args;
  {
    ...
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "IgcMsp_msp_register_plugin" "', argument " "1"" of type '" "std::string const &""'"); 
    }
    arg1 = ptr;
  }
  {
...
SWIGINTERN PyObject *_wrap_IgcMsp_sensor_velocity(PyObject *self, PyObject *args) {
  ...
  }
  {
    ...
    if (SWIG_IsOK(res2)) {
      ...
      if (!argp2) {
        SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "IgcMsp_sensor_velocity" "', argument " "2"" of type '" "GeoCal::ImageCoordinate const &""'"); 
      }
      if (newmem & SWIG_CAST_NEW_MEMORY) {
