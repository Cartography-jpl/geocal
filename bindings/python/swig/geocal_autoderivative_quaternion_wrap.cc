...
/*-----------------------------------------------
              @(target):= _geocal_autoderivative_quaternion.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__geocal_autoderivative_quaternion

#else
#  define SWIG_init    init_geocal_autoderivative_quaternion

#endif
#define SWIG_name    "_geocal_autoderivative_quaternion"
...
#include "geocal_autoderivative_quaternion_wrap.h"
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"quat_rot_x", (PyCFunction)_wrap_quat_rot_x, METH_O, NULL},
	 { (char *)"quat_rot_y", (PyCFunction)_wrap_quat_rot_y, METH_O, NULL},
	 { (char *)"quat_rot_z", (PyCFunction)_wrap_quat_rot_z, METH_O, NULL},
	 { (char *)"quat_rot", _wrap_quat_rot, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
