...
#define SWIGTYPE_p_blitz__ArrayT_double_6_t swig_types[11]
...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__RayCaster_t swig_types[17]
#define SWIGTYPE_p_char swig_types[18]
#define SWIGTYPE_p_char_type swig_types[19]
...
SWIGINTERN PyObject *_wrap_RayCaster_next_position(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  resultobj = SWIG_NewPointerObj((new blitz::Array< double,6 >(static_cast< const blitz::Array< double,6 >& >(result))), SWIGTYPE_p_blitz__ArrayT_double_6_t, SWIG_POINTER_OWN |  0 );
  return resultobj;
fail:
  return NULL;
}
