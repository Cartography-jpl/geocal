...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__CalcRaster_t swig_types[58]
...
#define SWIGTYPE_p_std__basic_iosT_char_std__char_traitsT_char_t_t swig_types[100]
