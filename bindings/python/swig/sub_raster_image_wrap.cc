...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__RasterImageVariable_t swig_types[64]
...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__SubRasterImage_t swig_types[68]
