...
#include "hdf5_l1b2_field_map.h"   // Definition of HDF5::L1B2FieldMap
#include "MSPI-Shared/File/L1B2File/src/l1b2_file.h"
...
using std::cerr;
using MSPI::Shared::HDF5::L1B2FieldMap;
...
//-----------------------------------------------------------------------
    ...
    std::string filename = "File/FieldMap/tmp/hdf5_l1b2_field_map_test.hdf";
    {
      ConfiguredFieldMap 
	simple_field_map("File/FieldMap/src/hdf5_l1b2_field_map_test.field_map");
