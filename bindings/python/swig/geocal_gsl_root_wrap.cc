...
SWIGINTERN PyObject *_wrap_root__SWIG_0(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  ...
  if ((nobjs < 5) || (nobjs > 5)) SWIG_fail;
  {
    ...
    if (SWIG_IsOK(res1)) {
      ...
      if (!argp1) {
        SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "root" "', argument " "1"" of type '" "GeoCal::DFunctor const &""'"); 
      }
      if (newmem & SWIG_CAST_NEW_MEMORY) {
...
SWIGINTERN PyObject *_wrap_root_with_derivative__SWIG_0(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  ...
  if ((nobjs < 5) || (nobjs > 5)) SWIG_fail;
  {
    ...
    if (SWIG_IsOK(res1)) {
      ...
      if (!argp1) {
        SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "root_with_derivative" "', argument " "1"" of type '" "GeoCal::DFunctorWithDerivative const &""'"); 
      }
      if (newmem & SWIG_CAST_NEW_MEMORY) {
