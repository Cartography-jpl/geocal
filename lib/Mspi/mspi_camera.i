...
public:
  ...
  %python_attribute(gimbal_epsilon_with_derivative, AutoDerivative<double>);
  %python_attribute(gimbal_psi_with_derivative, AutoDerivative<double>);
  %python_attribute(gimbal_theta_with_derivative, AutoDerivative<double>);
