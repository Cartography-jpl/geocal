...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__ConstantSpacingTimeTable_t swig_types[100]
...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__RollingShutterConstantTimeTable_t swig_types[107]
