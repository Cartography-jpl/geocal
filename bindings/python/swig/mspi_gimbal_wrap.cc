...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_new_MspiGimbal(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args,"new_MspiGimbal",3,3,swig_obj)) SWIG_fail;
