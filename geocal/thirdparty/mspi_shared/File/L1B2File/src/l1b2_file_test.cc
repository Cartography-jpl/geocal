...
//-----------------------------------------------------------------------
    ...
    test_number++;
    std::string filename = "File/L1B2File/tmp/l1b2_file_test.hdf5";
    ConfiguredFieldMap simple_field_map("File/L1B2File/src/l1b2_file_test.simple_field_map");
    L1B2File file1(filename, MSPI::Shared::L1B2File::CREATE,
		   simple_field_map);
...
//-----------------------------------------------------------------------
    ...
    if (file1.granule_id() != "l1b2_file_test.hdf5") {
...
//-----------------------------------------------------------------------
    ...
    std::string filename2 = "File/L1B2File/tmp/l1b2_file_test2.hdf5";

    ConfiguredFieldMap simple_field_map2("File/L1B2File/src/l1b2_file_test.simple_field_map2");
    {
      L1B2File file2(filename2, MSPI::Shared::L1B2File::CREATE, simple_field_map2);
...
//-----------------------------------------------------------------------
// Test projection_info()  (read-only)
//-----------------------------------------------------------------------
...
//-----------------------------------------------------------------------
    ...
    test_number++;
    std::string filename3 = "File/L1B2File/tmp/l1b2_file_test3.hdf5";
    
    {
      L1B2File file2(filename3, MSPI::Shared::L1B2File::CREATE, simple_field_map2);
...
//-----------------------------------------------------------------------
    ...
    try {
      L1B2File file2(filename2, MSPI::Shared::L1B2File::READ, simple_field_map2b);
    } catch (Exception& e) {
      caught_exception = true;
      if (strcmp(e.what(), "Grid name '801_nm_band', in file, does not match band name 'Wrong grid name', in field map.  Band_number: 7   Filename: File/L1B2File/tmp/l1b2_file_test2.hdf5")) {
...
//-----------------------------------------------------------------------
    ...
    try {
      L1B2File file2(filename2, MSPI::Shared::L1B2File::READ, simple_field_map2c);
    } catch (Exception& e) {
      caught_exception = true;
      if (strcmp(e.what(), "Trouble with GDfieldinfo for required field name: Wrong Field Name,  grid: 801_nm_band,  Filename: File/L1B2File/tmp/l1b2_file_test2.hdf5")) {
	cerr << "L1B1File() exception = "<<e.what()<<"\n";
	cerr << "Unexpected result at line "<<__LINE__<<"\n";
	error = true;
      }
