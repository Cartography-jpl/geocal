...
#define SWIGTYPE_p_GeoCal__PhaseCorrelationMatcher swig_types[26]
...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__PhaseCorrelationMatcher_t swig_types[85]
