...
#define SWIGTYPE_p_blitz__ArrayT_GeoCal__AutoDerivativeT_double_t_1_t swig_types[44]
...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__WithParameter_t swig_types[100]
