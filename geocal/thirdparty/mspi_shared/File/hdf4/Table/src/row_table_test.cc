...
using std::cerr;
using MSPI::Shared::HDF4::RowTable;
...
//-----------------------------------------------------------------------
    ...
    test_number++;
    int32 fid = Hopen("File/Table/tmp/row_table_test.hdf",
...
//-----------------------------------------------------------------------
    ...
    int fid2 = Hopen("File/Table/tmp/row_table_test.hdf",
...
//-----------------------------------------------------------------------
    ...
    int fid3 = Hopen("File/Table/tmp/row_table_test.hdf",
		      DFACC_READ, DEF_NDDS);
