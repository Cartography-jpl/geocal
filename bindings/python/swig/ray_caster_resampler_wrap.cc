...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "RayCasterResampler_final_rad_step_double", _wrap_RayCasterResampler_final_rad_step_double, METH_VARARGS, "\n"
		"\n"
		"void RayCasterResampler::final_rad_step_double(const RasterImage &Input_img, blitz::Array< int, 6 > Ray_cast_res,\n"
		"blitz::Array< double, 2 > Rad_res, blitz::Array< int, 2 >\n"
		"Scratch_count)\n"
