...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__OrbitListCache_t swig_types[155]
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__OrbitQuaternionList_t swig_types[156]
