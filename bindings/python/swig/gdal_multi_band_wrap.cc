...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__GdalMultiBand_t swig_types[109]
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__GdalRasterImage_t swig_types[110]
