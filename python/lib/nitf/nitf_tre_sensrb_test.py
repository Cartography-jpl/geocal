...
def test_tre_sensrb_empty():
    ...
    fh = six.BytesIO()
    t.write_to_file(fh)
    assert fh.getvalue() == b'SENSRB00106NNNN00000.0000000000.0000000.000000010.00000000020.0000100000.00000000.0000000.0000000.000NNNN000000000000'
...
def test_tre_sensrb_general_data():
    ...
    t.write_to_file(fh)
    #print(fh.getvalue())
    assert fh.getvalue() == b'SENSRB00309YMy sensor                blah                            My platform              blah                            blah      1WGS84GHAESID  2017042700000.999999992017042786399.999999990020170427235959.999NNN00000.0000000000.0000000.000000010.00000000020.0000100000.00000000.0000000.0000000.000NNNN000000000000'
    fh2 = six.BytesIO(fh.getvalue())
    t2 = TreSENSRB()
    t2.read_from_file(fh2)
...
def test_tre_sensrb_sensor_array():
    ...
    t.write_to_file(fh)
    #print(fh.getvalue())
    assert fh.getvalue() == b'SENSRB00183NYsome detection      00001000000010000001.1000001.1000001.2000001.3000001.300YNN00000.0000000000.0000000.000000010.00000000020.0000100000.00000000.0000000.0000000.000NNNN000000000000'
    fh2 = six.BytesIO(fh.getvalue())
    t2 = TreSENSRB()
    t2.read_from_file(fh2)
...
def test_tre_sensrb_sensor_calibration_data():
    ...
    t.write_to_file(fh)
    #print(fh.getvalue())
    assert fh.getvalue() == b'SENSRB00227NNYmm01.000000-1.0000001e2         2e2         3e2         +000001.01e3         2.1e2       3.7e5       6.4e2       20170505N00000.0000000000.0000000.000000010.00000000020.0000100000.00000000.0000000.0000000.000NNNN000000000000'
    fh2 = six.BytesIO(fh.getvalue())
    t2 = TreSENSRB()
    t2.read_from_file(fh2)
...
def test_tre_sensrb_attitude_quaternion():
    ...
    t.write_to_file(fh)
    #print(fh.getvalue())
    assert fh.getvalue() == b'SENSRB00146NNNN00000.0000000000.0000000.000000010.00000000020.0000100000.00000000.0000000.0000000.000NNY0000.000100000.000200000.000300000.00040N000000000000'
    fh2 = six.BytesIO(fh.getvalue())
    t2 = TreSENSRB()
    t2.read_from_file(fh2)
