...
#include "hdf4_l1b1_field_map.h"   // Definition of HDF4::L1B1FieldMap
...
using std::cerr;
using MSPI::Shared::HDF4::L1B1FieldMap;
using MSPI::Shared::HDF4::L1B1File;
...
//-----------------------------------------------------------------------
    ...
    std::string filename = "File/FieldMap/tmp/hdf4_l1b1_field_map_test.hdf";
    {
      ...
      L1B1File file1(filename, MSPI::Shared::HDF4::L1B1File::CREATE,
		     simple_field_map);
