...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__GroundMspiOrbit_t swig_types[72]
...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__WithParameterNested_t swig_types[89]
