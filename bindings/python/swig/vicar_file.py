...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_vicar_file')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_vicar_file')
...
class VicarFile(geocal_swig.generic_object.GenericObject):
    ...
    def is_vicar_file(Fname):
        ...
        """
        return _vicar_file.VicarFile_is_vicar_file(Fname)

    is_vicar_file = staticmethod(is_vicar_file)

    def file_name_to_unit(Fname):
        """
...
def VicarFile_file_name_to_unit(Fname):
    """
