...
SWIGINTERN PyObject *_wrap_GdalBase__v_map_info__SWIG_1(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  ...
  }
  {
    ...
    if (SWIG_IsOK(res2)) {
      ...
      if (!argp2) {
        SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "GdalBase__v_map_info" "', argument " "2"" of type '" "GeoCal::MapInfo const &""'"); 
      }
      if (newmem & SWIG_CAST_NEW_MEMORY) {
...
SWIGINTERN PyObject *_wrap_gdal_driver_name(PyObject *self, PyObject *args) {
  ...
  swig_obj[0] = args;
  {
    ...
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "gdal_driver_name" "', argument " "1"" of type '" "std::string const &""'"); 
    }
    arg1 = ptr;
  }
  {
