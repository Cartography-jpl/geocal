...
class ForstnerFeatureDetector(FeatureDetector):
    ...
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    def __init__(self, Basic_ip_large_number = 1000, Maximum_weight_threshold = 10000, 
    Forstner_max_window_large_size = 9, 
    Forstner_max_window_small_size = 7, Forstner_window_size = 3, 
    ...
    Forstner_max_window_small_size, 
    Forstner_window_size, Roundness_threshold, 
...
class CcorrMatcher(ImageMatcher):
    ...
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    def __init__(self, Target_nline = 37, Target_nsamp = 37, Template_nline = 9, 
    Template_nsamp = 9, Min_ccorr = 0.3, Min_variance = 0): 
        """
        ...
        """
        _geocal.CcorrMatcher_swiginit(self,_geocal.new_CcorrMatcher(Target_nline, Target_nsamp, Template_nline, Template_nsamp, 
    Min_ccorr, Min_variance))
...
class LsmMatcher(ImageMatcher):
    ...
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    def __init__(self, Number_line = 21, Number_sample = 21, Border_size = 3, 
    Precision_goal = 0.0625, Precision_requirement = 0.2, 
    Max_sigma = 0.5, Rad_uncertainty_factor = 2.0, 
    Precision_min_geo_goal = 0.15, 
    Precision_min_rad_goal = 1): 
        """
        LsmMatcher::LsmMatcher(const LsmMatcher &M)
        Copy constructor. 
        """
        _geocal.LsmMatcher_swiginit(self,_geocal.new_LsmMatcher(Number_line, Number_sample, Border_size, Precision_goal, 
    Precision_requirement, Max_sigma, Rad_uncertainty_factor, 
    Precision_min_geo_goal, Precision_min_rad_goal))
    def _number_line(self):
        """
...
class GDALDataset(object):
    ...
    def __init__(self, *args, **kwargs): raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __swig_destroy__ = _geocal.delete_GDALDataset
GDALDataset_swigregister = _geocal.GDALDataset_swigregister
GDALDataset_swigregister(GDALDataset)
...
class GdalBase(object):
    ...
    def _data_set(self):
        ...
        """
        return _geocal.GdalBase__data_set(self)
...
GdalBase._data_set = new_instancemethod(_geocal.GdalBase__data_set,None,GdalBase)
...
def gdal_create_copy(*args):
  return _geocal.gdal_create_copy(*args)
gdal_create_copy = _geocal.gdal_create_copy

def gdal_create_erdas(*args):
  return _geocal.gdal_create_erdas(*args)
gdal_create_erdas = _geocal.gdal_create_erdas
...
class VicarLiteRasterImage(RasterImage):
    ...
    def __init__(self, *args): 
        ...
        Band=0, int Number_tile_line=-1, int Number_tile_sample=-1)
        Constructor. 
        """
    ...
    def __reduce__(self):
      return _new_from_init, (self.__class__, self.file.file_name,self.file.access,self.band,self.number_tile_line,self.number_tile_sample)
...
class VicarRasterImage(RasterImageTiledFile):
    ...
    def __reduce__(self):
      return _new_from_init, (self.__class__, self.vicar_file.file_name,self.vicar_file.access,self.number_tile_line,self.number_tile)
