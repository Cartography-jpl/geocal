...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__ImageCoordinateWithDerivative_t swig_types[56]
...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__RawRasterImage_t swig_types[64]
