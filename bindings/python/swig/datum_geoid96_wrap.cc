...
SWIGINTERN PyObject *_wrap_new_DatumGeoid96__SWIG_0(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  std::string *arg1 = 0 ;
  ...
  if ((nobjs < 1) || (nobjs > 1)) SWIG_fail;
  {
    ...
    if (!ptr) {
      SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "new_DatumGeoid96" "', argument " "1"" of type '" "std::string const &""'"); 
    }
    arg1 = ptr;
  }
  {
...
SWIGINTERN PyObject *_wrap_new_DatumGeoid96__SWIG_1(PyObject *self, Py_ssize_t nobjs, PyObject **SWIGUNUSEDPARM(swig_obj)) {
  PyObject *resultobj = 0;
  GeoCal::DatumGeoid96 *result = 0 ;
...
SWIGINTERN PyObject *_wrap_new_DatumGeoid96(PyObject *self, PyObject *args) {
  ...
  --argc;
  if (argc == 0) {
    PyObject *retobj = _wrap_new_DatumGeoid96__SWIG_1(self, argc, argv);
    if (!SWIG_Python_TypeErrorOccurred(retobj)) return retobj;
    SWIG_fail;
  }
  if (argc == 1) {
    PyObject *retobj = _wrap_new_DatumGeoid96__SWIG_0(self, argc, argv);
    if (!SWIG_Python_TypeErrorOccurred(retobj)) return retobj;
    SWIG_fail;
  }
  
fail:
  SWIG_Python_RaiseOrModifyTypeError("Wrong number or type of arguments for overloaded function 'new_DatumGeoid96'.\n"
    "  Possible C/C++ prototypes are:\n"
...
SWIGINTERN PyObject *_wrap_DatumGeoid96__v_file_name(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
...
SWIGINTERN PyObject *_wrap_delete_DatumGeoid96(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  GeoCal::DatumGeoid96 *arg1 = (GeoCal::DatumGeoid96 *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "new_DatumGeoid96", _wrap_new_DatumGeoid96, METH_VARARGS, "\n"
		"DatumGeoid96(std::string const & Fname=\"\")\n"
		"\n"
		"GeoCal::DatumGeoid96::DatumGeoid96\n"
		"Constructor.  \n"
		"\n"
		...
		"\n"
		""},
	 { "DatumGeoid96__v_file_name", _wrap_DatumGeoid96__v_file_name, METH_O, "\n"
		"DatumGeoid96__v_file_name(DatumGeoid96 self) -> std::string\n"
		"\n"
		"GeoCal::DatumGeoid96::file_name\n"
		""},
	 { "delete_DatumGeoid96", _wrap_delete_DatumGeoid96, METH_O, "\n"
		"delete_DatumGeoid96(DatumGeoid96 self)\n"
		"\n"
		"GeoCal::DatumGeoid96::~DatumGeoid96\n"
		""},
	 { "DatumGeoid96_swigregister", DatumGeoid96_swigregister, METH_O, NULL},
	 { "DatumGeoid96_swiginit", DatumGeoid96_swiginit, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
...
static PyMethodDef SwigMethods_proxydocs[] = {
	 ...
	 { "new_DatumGeoid96", _wrap_new_DatumGeoid96, METH_VARARGS, "\n"
		...
		""},
	 { "DatumGeoid96__v_file_name", _wrap_DatumGeoid96__v_file_name, METH_O, "\n"
		"_v_file_name(DatumGeoid96 self) -> std::string\n"
		"\n"
		"GeoCal::DatumGeoid96::file_name\n"
		""},
	 { "delete_DatumGeoid96", _wrap_delete_DatumGeoid96, METH_O, "\n"
