...
def test_gdal_to_nitf(isolated_dir, stereo_unit_test_data):
    ...
    ok'''
    subprocess.check_call(["gdal_to_nitf", "-q", str(stereo_unit_test_data / "10MAY21-1.img"),
                           "gdal_to_nitf.ntf"])
    ...
    for i in range(20):
        ...
        npt.assert_almost_equal(rpc.line_denominator[i], 
                            rpc2.line_denominator[i], 6)
        npt.assert_almost_equal(rpc.sample_numerator[i], 
                            rpc2.sample_numerator[i], 6)
        npt.assert_almost_equal(rpc.sample_denominator[i], 
...
def test_gdal_to_nitf_a(isolated_dir, stereo_unit_test_data):
    ...
    subprocess.check_call(["gdal_to_nitf", "-q", str(stereo_unit_test_data / "10MAY21-1_A.img"), 
                           "gdal_to_nitf.ntf"])
