...
#define SWIGTYPE_p_std__vectorT__Tp__Alloc_t swig_types[194]
...
SWIGINTERN PyObject *_wrap_Vector_ArgusOrbitData_insert__SWIG_0(PyObject *SWIGUNUSEDPARM(self), int nobjs, PyObject **swig_obj) {
  ...
  {
    try {
      result = (arg1)->insert(arg2,(std::vector< boost::shared_ptr< GeoCal::ArgusOrbitData > >::value_type const &)*arg3);
    } catch (const std::exception& e) {
      SWIG_exception(SWIG_RuntimeError, e.what());
    } catch (Swig::DirectorException &e) {
      SWIG_fail; 
...
SWIGINTERN PyObject *_wrap_Vector_ArgusOrbitData_insert__SWIG_1(PyObject *SWIGUNUSEDPARM(self), int nobjs, PyObject **swig_obj) {
  ...
  {
    try {
      (arg1)->insert(arg2,arg3,(std::vector< boost::shared_ptr< GeoCal::ArgusOrbitData > >::value_type const &)*arg4);
    } catch (const std::exception& e) {
      SWIG_exception(SWIG_RuntimeError, e.what());
    } catch (Swig::DirectorException &e) {
      SWIG_fail; 
