...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__CalcRaster_t swig_types[69]
...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__IgcSimulated_t swig_types[88]
