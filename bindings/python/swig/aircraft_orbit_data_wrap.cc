...
#define SWIGTYPE_p_boost__arrayT_double_3_t swig_types[43]
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__AircraftOrbitData_t swig_types[44]
...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__Geodetic_t swig_types[59]
