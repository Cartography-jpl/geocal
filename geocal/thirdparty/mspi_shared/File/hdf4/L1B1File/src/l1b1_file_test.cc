...
//-----------------------------------------------------------------------
    ...
    test_number++;
    std::string filename = "File/hdf4/L1B1File/tmp/l1b1_file_test.hdf";
    SimpleFieldMap simple_field_map;
    L1B1File file1(filename, MSPI::Shared::HDF4::L1B1File::CREATE, simple_field_map);
...
//-----------------------------------------------------------------------
    ...
    if (file1.granule_id() != "l1b1_file_test.hdf") {
...
//-----------------------------------------------------------------------
    ...
    test_number++;
    std::string filename2 = "File/hdf4/L1B1File/tmp/l1b1_file_test2.hdf";
    {
      L1B1File file2(filename2, MSPI::Shared::HDF4::L1B1File::CREATE, simple_field_map);
...
//-----------------------------------------------------------------------
    ...
    try {
      L1B1File file2(filename2, MSPI::Shared::HDF4::L1B1File::READ, simple_field_map2);
    } catch (Exception& e) {
      caught_exception = true;
      if (strcmp(e.what(), "Swath name 'Row2', in file, does not match row name 'Row4', in field map.  Row_number: 2   Filename: File/hdf4/L1B1File/tmp/l1b1_file_test2.hdf")) {
...
//-----------------------------------------------------------------------
    ...
    try {
      L1B1File file2(filename2, MSPI::Shared::HDF4::L1B1File::READ, simple_field_map3);
    } catch (Exception& e) {
      caught_exception = true;
      if (strcmp(e.what(), "Trouble with SWfieldinfo for required field name: E,  swath: Row2,  Filename: File/hdf4/L1B1File/tmp/l1b1_file_test2.hdf")) {
	cerr << "L1B1File() exception = "<<e.what()<<"\n";
	cerr << "Unexpected result at line "<<__LINE__<<"\n";
	error = true;
      }
...
//-----------------------------------------------------------------------
    ...
    test_number++;
    std::string filename3 = "File/hdf4/L1B1File/tmp/l1b1_file_test3.hdf";
    {
      L1B1File file3(filename3, MSPI::Shared::HDF4::L1B1File::CREATE, simple_field_map);
