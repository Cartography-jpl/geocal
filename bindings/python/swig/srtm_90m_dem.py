...
from ._swig_wrap import _srtm_90m_dem
...
_swig_new_instance_method = _srtm_90m_dem.SWIG_PyInstanceMethod_New
_swig_new_static_method = _srtm_90m_dem.SWIG_PyStaticMethod_New
...
class SwigPyIterator(object):
    ...
    value = _swig_new_instance_method(_srtm_90m_dem.SwigPyIterator_value)
    incr = _swig_new_instance_method(_srtm_90m_dem.SwigPyIterator_incr)
    decr = _swig_new_instance_method(_srtm_90m_dem.SwigPyIterator_decr)
    distance = _swig_new_instance_method(_srtm_90m_dem.SwigPyIterator_distance)
    equal = _swig_new_instance_method(_srtm_90m_dem.SwigPyIterator_equal)
    copy = _swig_new_instance_method(_srtm_90m_dem.SwigPyIterator_copy)
    next = _swig_new_instance_method(_srtm_90m_dem.SwigPyIterator_next)
    __next__ = _swig_new_instance_method(_srtm_90m_dem.SwigPyIterator___next__)
    previous = _swig_new_instance_method(_srtm_90m_dem.SwigPyIterator_previous)
    advance = _swig_new_instance_method(_srtm_90m_dem.SwigPyIterator_advance)
    __eq__ = _swig_new_instance_method(_srtm_90m_dem.SwigPyIterator___eq__)
    __ne__ = _swig_new_instance_method(_srtm_90m_dem.SwigPyIterator___ne__)
    __iadd__ = _swig_new_instance_method(_srtm_90m_dem.SwigPyIterator___iadd__)
    __isub__ = _swig_new_instance_method(_srtm_90m_dem.SwigPyIterator___isub__)
    __add__ = _swig_new_instance_method(_srtm_90m_dem.SwigPyIterator___add__)
    __sub__ = _swig_new_instance_method(_srtm_90m_dem.SwigPyIterator___sub__)
    def __iter__(self):
        return self
...
# Register Srtm90mData in _srtm_90m_dem:
_srtm_90m_dem.Srtm90mData_swigregister(Srtm90mData)
class Srtm90mDem(geocal_swig.dem_map_info.DemMapInfo):
    ...
    _v_number_file_read = _swig_new_instance_method(_srtm_90m_dem.Srtm90mDem__v_number_file_read)

    @property
    def number_file_read(self):
        return self._v_number_file_read()

    reset_number_file_read = _swig_new_instance_method(_srtm_90m_dem.Srtm90mDem_reset_number_file_read)
...
# Register Srtm90mDem in _srtm_90m_dem:
_srtm_90m_dem.Srtm90mDem_swigregister(Srtm90mDem)
