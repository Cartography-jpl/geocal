...
if have_shape_file:
    ...
    class ShapeFile(collections.abc.Mapping):
        ...
        def __init__(self, fname, mode="r", driver_name="ESRI Shapefile"):
            ...
            if mode == "r":
                ...
                self.data_source = ogr.GetDriverByName(driver_name).CreateDataSource(
                    fname
                )
            else:
        ...
        def add_layer(
            ...
            geometry_type,
            fields,
            spatial_reference=osr.SpatialReference(osr.GetUserInputAsWKT("WGS84")),
        ):
            ...
            data_layer = self.data_source.CreateLayer(
                name, spatial_reference, geometry_type
            )
            for v in fields:
    ...
    class ShapeLayer(collections.abc.Sequence):
        ...
        def __init__(self, shape_file, index):
            ...
            self.field_list = [
                self.layer.GetLayerDefn().GetFieldDefn(i).GetName()
