...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__ImageCoordinateWithDerivative_t swig_types[45]
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__ImageCoordinate_t swig_types[46]
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__MeasuredTimeTable_t swig_types[47]
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__RollingShutterConstantTimeTable_t swig_types[48]
