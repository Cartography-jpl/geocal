...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_geocal_quaternion')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_geocal_quaternion')
...
__all__ = ["Quaternion_AutoDerivative_double","quat_rot_x","quat_rot_y","quat_rot_z","quat_rot","quaternion_to_matrix","matrix_to_quaternion","quaternion_to_array","array_to_quaternion","quat_to_ypr","determine_quat_rot","quat_normalize"]
