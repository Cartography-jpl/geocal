...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__TiledFileBaseT_2_t_t swig_types[86]
...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__VicarImageCoordinate_t swig_types[89]
#define SWIGTYPE_p_char swig_types[90]
#define SWIGTYPE_p_char_type swig_types[91]
#define SWIGTYPE_p_difference_type swig_types[92]
#define SWIGTYPE_p_fmtflags swig_types[93]
#define SWIGTYPE_p_index swig_types[94]
...
SWIGINTERN PyObject *_wrap_new_RasterImageTiledFile__SWIG_0(PyObject *SWIGUNUSEDPARM(self), int nobjs, PyObject **swig_obj) {
  ...
  if ((nobjs < 1) || (nobjs > 1)) SWIG_fail;
  res1 = SWIG_ConvertPtr(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_GeoCal__TiledFileBaseT_2_t_t,  0  | 0);
  if (!SWIG_IsOK(res1)) {
  ...
  if (!argp1) {
    SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "new_RasterImageTiledFile" "', argument " "1"" of type '" "boost::shared_ptr< GeoCal::TiledFileBase< 2 > > const &""'"); 
  }
  arg1 = reinterpret_cast< boost::shared_ptr< GeoCal::TiledFileBase< 2 > > * >(argp1);
  {
    try {
...
SWIGINTERN PyObject *_wrap_RasterImageTiledFile__v_tile_file_base(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  PyObject *swig_obj[1] ;
  SwigValueWrapper< boost::shared_ptr< GeoCal::TiledFileBase< 2 > > > result;
  ...
  resultobj = SWIG_NewPointerObj((new boost::shared_ptr< GeoCal::TiledFileBase< 2 > >(static_cast< const boost::shared_ptr< GeoCal::TiledFileBase< 2 > >& >(result))), SWIGTYPE_p_boost__shared_ptrT_GeoCal__TiledFileBaseT_2_t_t, SWIG_POINTER_OWN |  0 );
  return resultobj;
fail:
  return NULL;
}
...
# endif
  ...
  GeoCal::swig_type_map[GeoCal::type_index(typeid(GeoCal::RasterImageTiledFile))] =
  boost::shared_ptr<GeoCal::SwigTypeMapperBase>(new GeoCal::SwigTypeMapper< GeoCal::RasterImageTiledFile >("boost::shared_ptr< GeoCal::RasterImageTiledFile > *"));
