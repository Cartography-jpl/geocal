...
#define SWIGTYPE_p_GeoCal__ThreadPool swig_types[1]
...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__ThreadPool_t swig_types[77]
...
/*-----------------------------------------------
              @(target):= _geocal_thread_pool.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__geocal_thread_pool

#else
#  define SWIG_init    init_geocal_thread_pool

#endif
#define SWIG_name    "_geocal_thread_pool"
...
#include "geocal_thread_pool_wrap.h"
...
SWIGINTERN PyObject *_wrap_ThreadPool_thread_pool(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  GeoCal::ThreadPool *result = 0 ;
  
  (void)self;
  if (!SWIG_Python_UnpackTuple(args, "ThreadPool_thread_pool", 0, 0, 0)) SWIG_fail;
  {
    try {
      result = (GeoCal::ThreadPool *) &GeoCal::ThreadPool::thread_pool();
  ...
  {
    boost::shared_ptr<  GeoCal::ThreadPool > *smartresult = new boost::shared_ptr<  GeoCal::ThreadPool >(result SWIG_NO_NULL_DELETER_0);
    resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(smartresult), SWIGTYPE_p_boost__shared_ptrT_GeoCal__ThreadPool_t, SWIG_POINTER_OWN);
  }
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_ThreadPool__v_number_thread__SWIG_0(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  ...
  if ((nobjs < 1) || (nobjs > 1)) SWIG_fail;
  {
    ...
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ThreadPool__v_number_thread" "', argument " "1"" of type '" "GeoCal::ThreadPool const *""'");
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
  ...
  {
    try {
      result = (int)((GeoCal::ThreadPool const *)arg1)->number_thread();
    } catch (Swig::DirectorException &e) {
      SWIG_fail; 
    } catch (const std::exception& e) {
      SWIG_exception(SWIG_RuntimeError, e.what());
...
SWIGINTERN PyObject *_wrap_ThreadPool__v_number_thread__SWIG_1(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  GeoCal::ThreadPool *arg1 = (GeoCal::ThreadPool *) 0 ;
  int *arg2 = 0 ;
  void *argp1 = 0 ;
  ...
  if ((nobjs < 2) || (nobjs > 2)) SWIG_fail;
  {
    ...
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_GeoCal__ThreadPool_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "ThreadPool__v_number_thread" "', argument " "1"" of type '" "GeoCal::ThreadPool *""'");
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
  ...
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "ThreadPool__v_number_thread" "', argument " "2"" of type '" "int""'");
  } 
  temp2 = static_cast< int >(val2);
  arg2 = &temp2;
  {
    try {
      (arg1)->number_thread((int const &)*arg2);
    } catch (Swig::DirectorException &e) {
      SWIG_fail; 
    } catch (const std::exception& e) {
      SWIG_exception(SWIG_RuntimeError, e.what());
...
SWIGINTERN PyObject *_wrap_ThreadPool__v_number_thread(PyObject *self, PyObject *args) {
  Py_ssize_t argc;
  PyObject *argv[3] = {
    0
  };
  
  if (!(argc = SWIG_Python_UnpackTuple(args, "ThreadPool__v_number_thread", 0, 2, argv))) SWIG_fail;
  --argc;
  if (argc == 1) {
    PyObject *retobj = _wrap_ThreadPool__v_number_thread__SWIG_0(self, argc, argv);
    if (!SWIG_Python_TypeErrorOccurred(retobj)) return retobj;
    SWIG_fail;
  }
  if (argc == 2) {
    PyObject *retobj = _wrap_ThreadPool__v_number_thread__SWIG_1(self, argc, argv);
    if (!SWIG_Python_TypeErrorOccurred(retobj)) return retobj;
    SWIG_fail;
  }
  
fail:
  SWIG_Python_RaiseOrModifyTypeError("Wrong number or type of arguments for overloaded function 'ThreadPool__v_number_thread'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    GeoCal::ThreadPool::number_thread() const\n"
    "    GeoCal::ThreadPool::number_thread(int const &)\n");
  return 0;
}
...
SWIGINTERN PyObject *_wrap_delete_ThreadPool(PyObject *self, PyObject *args) {
  ...
  swig_obj[0] = args;
  {
    ...
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_GeoCal__ThreadPool_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_ThreadPool" "', argument " "1"" of type '" "GeoCal::ThreadPool *""'");
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
      tempshared1 = *reinterpret_cast< boost::shared_ptr<  GeoCal::ThreadPool > * >(argp1);
      delete reinterpret_cast< boost::shared_ptr<  GeoCal::ThreadPool > * >(argp1);
...
SWIGINTERN PyObject *ThreadPool_swigregister(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *obj;
  if (!SWIG_Python_UnpackTuple(args, "swigregister", 1, 1, &obj)) return NULL;
  SWIG_TypeNewClientData(SWIGTYPE_p_boost__shared_ptrT_GeoCal__ThreadPool_t, SWIG_NewClientData(obj));
  return SWIG_Py_Void();
}
...
static void *_p_GeoCal__ThreadPoolTo_p_GeoCal__GenericObject(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((GeoCal::GenericObject *)  ((GeoCal::ThreadPool *) x));
}
static void *_p_boost__shared_ptrT_GeoCal__ThreadPool_tTo_p_boost__shared_ptrT_GeoCal__GenericObject_t(void *x, int *newmemory) {
    *newmemory = SWIG_CAST_NEW_MEMORY;
    return (void *) new boost::shared_ptr< GeoCal::GenericObject >(*(boost::shared_ptr< GeoCal::ThreadPool > *)x);
}
...
static swig_type_info _swigt__p_GeoCal__ThreadPool = {"_p_GeoCal__ThreadPool", "GeoCal::ThreadPool *", 0, 0, (void*)0, 0};
...
static swig_type_info _swigt__p_boost__shared_ptrT_GeoCal__ThreadPool_t = {"_p_boost__shared_ptrT_GeoCal__ThreadPool_t", "boost::shared_ptr< GeoCal::ThreadPool > *", 0, 0, (void*)0, 0};
...
static swig_type_info *swig_type_initial[] = {
  ...
  &_swigt__p_boost__shared_ptrT_GeoCal__ThreadPool_t,
  &_swigt__p_char,
  &_swigt__p_char_type,
...
static swig_cast_info _swigc__p_GeoCal__GenericObject[] = {  {&_swigt__p_GeoCal__GenericObject, 0, 0, 0},  {&_swigt__p_GeoCal__ThreadPool, _p_GeoCal__ThreadPoolTo_p_GeoCal__GenericObject, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_GeoCal__ThreadPool[] = {  {&_swigt__p_GeoCal__ThreadPool, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_boost__shared_ptrT_GeoCal__GenericObject_t[] = {  {&_swigt__p_boost__shared_ptrT_GeoCal__GenericObject_t, 0, 0, 0},  {&_swigt__p_boost__shared_ptrT_GeoCal__ThreadPool_t, _p_boost__shared_ptrT_GeoCal__ThreadPool_tTo_p_boost__shared_ptrT_GeoCal__GenericObject_t, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_boost__shared_ptrT_GeoCal__ThreadPool_t[] = {  {&_swigt__p_boost__shared_ptrT_GeoCal__ThreadPool_t, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info *swig_cast_initial[] = {
  ...
  _swigc__p_boost__shared_ptrT_GeoCal__ThreadPool_t,
  _swigc__p_char,
  _swigc__p_char_type,
...
# endif
  ...
  GeoCal::SwigTypeMapperBase::add(typeid(GeoCal::ThreadPool), boost::make_shared<GeoCal::SwigTypeMapper< GeoCal::ThreadPool > > ("boost::shared_ptr< GeoCal::ThreadPool > *"));
  
  SWIG_Python_SetConstant(d, "ThreadPool_default_number_thread",SWIG_From_int(static_cast< int >(GeoCal::ThreadPool::default_number_thread)));
#if PY_VERSION_HEX >= 0x03000000
  return m;
#else
  return;
