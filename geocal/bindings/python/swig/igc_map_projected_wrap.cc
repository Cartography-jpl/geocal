...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__CalcMapProjected_t swig_types[47]
...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__IgcMapProjected_t swig_types[63]
...
SWIGINTERN PyObject *_wrap_new_IgcMapProjected(PyObject *self, PyObject *args) {
  ...
  if (!(argc = SWIG_Python_UnpackTuple(args,"new_IgcMapProjected",0,4,argv))) SWIG_fail;
  --argc;
  if (argc == 2) {
