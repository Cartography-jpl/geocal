...
from ._swig_wrap import _raster_multifile
...
_swig_new_instance_method = _raster_multifile.SWIG_PyInstanceMethod_New
_swig_new_static_method = _raster_multifile.SWIG_PyStaticMethod_New
...
class SwigPyIterator(object):
    ...
    value = _swig_new_instance_method(_raster_multifile.SwigPyIterator_value)
    incr = _swig_new_instance_method(_raster_multifile.SwigPyIterator_incr)
    decr = _swig_new_instance_method(_raster_multifile.SwigPyIterator_decr)
    distance = _swig_new_instance_method(_raster_multifile.SwigPyIterator_distance)
    equal = _swig_new_instance_method(_raster_multifile.SwigPyIterator_equal)
    copy = _swig_new_instance_method(_raster_multifile.SwigPyIterator_copy)
    next = _swig_new_instance_method(_raster_multifile.SwigPyIterator_next)
    __next__ = _swig_new_instance_method(_raster_multifile.SwigPyIterator___next__)
    previous = _swig_new_instance_method(_raster_multifile.SwigPyIterator_previous)
    advance = _swig_new_instance_method(_raster_multifile.SwigPyIterator_advance)
    __eq__ = _swig_new_instance_method(_raster_multifile.SwigPyIterator___eq__)
    __ne__ = _swig_new_instance_method(_raster_multifile.SwigPyIterator___ne__)
    __iadd__ = _swig_new_instance_method(_raster_multifile.SwigPyIterator___iadd__)
    __isub__ = _swig_new_instance_method(_raster_multifile.SwigPyIterator___isub__)
    __add__ = _swig_new_instance_method(_raster_multifile.SwigPyIterator___add__)
    __sub__ = _swig_new_instance_method(_raster_multifile.SwigPyIterator___sub__)
    def __iter__(self):
        return self
...
# Register RasterMultifile in _raster_multifile:
_raster_multifile.RasterMultifile_swigregister(RasterMultifile)
