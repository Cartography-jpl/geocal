...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__Refraction_t swig_types[48]
...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__TimeWithDerivative_t swig_types[51]
