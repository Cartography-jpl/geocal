...
SWIGINTERN PyObject *_wrap_new_RasterImageMultiBandVariable__SWIG_1(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  ...
  if ((nobjs < 1) || (nobjs > 1)) SWIG_fail;
  {
    ...
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "new_RasterImageMultiBandVariable" "', argument " "1"" of type '" "std::vector< boost::shared_ptr< GeoCal::RasterImage >,std::allocator< boost::shared_ptr< GeoCal::RasterImage > > > const &""'"); 
    }
    arg1 = ptr;
  }
  {
