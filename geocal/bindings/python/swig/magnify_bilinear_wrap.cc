...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__MagnifyBilinearImageGroundConnection_t swig_types[70]
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__MagnifyBilinear_t swig_types[71]
