...
SWIGINTERN PyObject *_wrap_RayCasterResampler_final_rad_step_double(PyObject *self, PyObject *args) {
  ...
  }
  {
    ...
    if (SWIG_IsOK(res2)) {
      ...
      if (!argp2) {
        SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "RayCasterResampler_final_rad_step_double" "', argument " "2"" of type '" "GeoCal::RasterImage const &""'"); 
      }
      if (newmem & SWIG_CAST_NEW_MEMORY) {
        tempshared2 = *reinterpret_cast< boost::shared_ptr< const GeoCal::RasterImage > * >(argp2);
        delete reinterpret_cast< boost::shared_ptr< const GeoCal::RasterImage > * >(argp2);
  ...
  {
    try {
      (arg1)->final_rad_step_double((GeoCal::RasterImage const &)*arg2,arg3,arg4,arg5);
    } catch (Swig::DirectorException &e) {
      SWIG_fail; 
    } catch (const std::exception& e) {
      SWIG_exception(SWIG_RuntimeError, e.what());
