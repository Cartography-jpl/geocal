...
#define SWIGTYPE_p_GeoCal__MemoryMultiBand swig_types[21]
...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__MemoryMultiBand_t swig_types[64]
...
SWIGINTERN PyObject *_wrap_MemoryMultiBand__v_data(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  }
  {
    ...
    PyArray_BASE(resultobj) = SWIG_NewPointerObj(SWIG_as_voidptr(t), 
      SWIGTYPE_p_blitz__ArrayT_int_3_t, 
      SWIG_POINTER_NEW | 0 );
  }
  return resultobj;
fail:
