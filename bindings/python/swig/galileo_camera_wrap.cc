...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__GalileoCamera_t swig_types[115]
...
# endif
  ...
  GeoCal::SwigTypeMapperBase::add(typeid(GeoCal::GalileoCamera), boost::make_shared<GeoCal::SwigTypeMapper< GeoCal::GalileoCamera > > ("boost::shared_ptr< GeoCal::GalileoCamera > *"));
