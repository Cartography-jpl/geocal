...
#define SWIG_name    "_with_parameter"
/* -----------------------------------------------------------------------------
...
#define SWIGTYPE_p_GeoCal__WithParameter swig_types[7]
#define SWIGTYPE_p_GeoCal__WithParameterNested swig_types[8]
#define SWIGTYPE_p_GeoCal__WithParameterShare swig_types[9]
#define SWIGTYPE_p_SwigDirector_WithParameter swig_types[10]
...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__WithParameterNested_t swig_types[92]
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__WithParameterShare_t swig_types[93]
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__WithParameter_t swig_types[94]
#define SWIGTYPE_p_boost__shared_ptrT_SwigDirector_WithParameter_t swig_types[95]
...
/*-----------------------------------------------
              @(target):= _with_parameter.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__with_parameter

#else
#  define SWIG_init    init_with_parameter
...
#include CMAKE_KLUDGE_INCLUDE_HEADER(with_parameter)
  
#include "geocal_serialize_support.h"
 namespace boost {
   namespace serialization {
     template<class Archive>
     void serialize(Archive& ar, SwigDirector_WithParameter& D, const unsigned int version) {
       ar & boost::serialization::make_nvp(BOOST_PP_STRINGIZE(WithParameter),
 					  boost::serialization::base_object<GeoCal::WithParameter>(D));
     }
     template<class Archive> 
     void save_construct_data(Archive & ar,
			      const SwigDirector_WithParameter* d, 
     ...
     template<class Archive>
     void load_construct_data(Archive & ar, SwigDirector_WithParameter* d,
 			     const unsigned int version)
     {
       std::string python_object;
       ar & BOOST_SERIALIZATION_NVP(python_object);
       PyObject* pobj = cpickle_loads(python_object);
       ::new(d)SwigDirector_WithParameter(pobj);
       boost::shared_ptr<GeoCal::WithParameter> *smartresult = d ? new boost::shared_ptr<GeoCal::WithParameter>(d) : 0;
       PyObject* thisobj = SWIG_NewPointerObj(SWIG_as_voidptr(smartresult), SWIG_TypeQuery("boost::shared_ptr<GeoCal::WithParameter>*"), SWIG_POINTER_NEW | SWIG_POINTER_OWN);
       // Transfer ownership of SwigDirector_ ## WithParameter to pobj.
       SWIG_Python_SetSwigThis(pobj, thisobj);
       Py_DECREF(thisobj);
     }
   }
}
BOOST_CLASS_EXPORT_KEY(SwigDirector_WithParameter);
BOOST_CLASS_EXPORT_IMPLEMENT(SwigDirector_WithParameter);
template void boost::serialization::serialize(boost::archive::polymorphic_oarchive& ar, SwigDirector_WithParameter& D, const unsigned int version);
template void boost::serialization::serialize(boost::archive::polymorphic_iarchive& ar, SwigDirector_WithParameter& D, const unsigned int version);
template void boost::serialization::load_construct_data
  (polymorphic_iarchive & ar, SwigDirector_WithParameter* d, const unsigned int version);
template void boost::serialization::save_construct_data
  (polymorphic_oarchive & ar, const SwigDirector_WithParameter* d, const unsigned int version);
...
SWIGINTERN PyObject *_wrap_WithParameter__v_parameter__SWIG_0(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  ...
  if ((nobjs < 1) || (nobjs > 1)) SWIG_fail;
  {
    ...
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "WithParameter__v_parameter" "', argument " "1"" of type '" "GeoCal::WithParameter const *""'");
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
      tempshared1 = *reinterpret_cast< boost::shared_ptr< const GeoCal::WithParameter > * >(argp1);
      delete reinterpret_cast< boost::shared_ptr< const GeoCal::WithParameter > * >(argp1);
      arg1 = const_cast< GeoCal::WithParameter * >(tempshared1.get());
    } else {
      smartarg1 = reinterpret_cast< boost::shared_ptr< const GeoCal::WithParameter > * >(argp1);
...
SWIGINTERN PyObject *_wrap_WithParameter__v_parameter__SWIG_1(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  GeoCal::WithParameter *arg1 = (GeoCal::WithParameter *) 0 ;
  ...
  if ((nobjs < 2) || (nobjs > 2)) SWIG_fail;
  {
    ...
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_GeoCal__WithParameter_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "WithParameter__v_parameter" "', argument " "1"" of type '" "GeoCal::WithParameter *""'");
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
...
SWIGINTERN PyObject *_wrap_WithParameter__v_parameter(PyObject *self, PyObject *args) {
  Py_ssize_t argc;
  PyObject *argv[3] = {
    0
  };
  
  if (!(argc = SWIG_Python_UnpackTuple(args, "WithParameter__v_parameter", 0, 2, argv))) SWIG_fail;
  --argc;
  if (argc == 1) {
    PyObject *retobj = _wrap_WithParameter__v_parameter__SWIG_0(self, argc, argv);
    if (!SWIG_Python_TypeErrorOccurred(retobj)) return retobj;
    SWIG_fail;
  }
  if (argc == 2) {
    PyObject *retobj = _wrap_WithParameter__v_parameter__SWIG_1(self, argc, argv);
    if (!SWIG_Python_TypeErrorOccurred(retobj)) return retobj;
    SWIG_fail;
  }
  
fail:
  SWIG_Python_RaiseOrModifyTypeError("Wrong number or type of arguments for overloaded function 'WithParameter__v_parameter'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    GeoCal::WithParameter::parameter() const\n"
    "    GeoCal::WithParameter::parameter(blitz::Array< double,1 > const &)\n");
  return 0;
}


SWIGINTERN PyObject *_wrap_WithParameter__v_parameter_with_derivative__SWIG_0(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  GeoCal::WithParameter *arg1 = (GeoCal::WithParameter *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if ((nobjs < 1) || (nobjs > 1)) SWIG_fail;
  {
    ...
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_GeoCal__WithParameter_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "WithParameter__v_parameter_with_derivative" "', argument " "1"" of type '" "GeoCal::WithParameter const *""'");
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
      tempshared1 = *reinterpret_cast< boost::shared_ptr< const GeoCal::WithParameter > * >(argp1);
      delete reinterpret_cast< boost::shared_ptr< const GeoCal::WithParameter > * >(argp1);
...
SWIGINTERN PyObject *_wrap_WithParameter__v_parameter_with_derivative__SWIG_1(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  GeoCal::WithParameter *arg1 = (GeoCal::WithParameter *) 0 ;
  ...
  if ((nobjs < 2) || (nobjs > 2)) SWIG_fail;
  {
    ...
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_GeoCal__WithParameter_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "WithParameter__v_parameter_with_derivative" "', argument " "1"" of type '" "GeoCal::WithParameter *""'");
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
      tempshared1 = *reinterpret_cast< boost::shared_ptr<  GeoCal::WithParameter > * >(argp1);
      delete reinterpret_cast< boost::shared_ptr<  GeoCal::WithParameter > * >(argp1);
  ...
  }
  {
    ...
    if (SWIG_IsOK(res2)) {
      ...
      if (!SWIG_IsOK(res2)) {
        SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "WithParameter__v_parameter_with_derivative" "', argument " "2"" of type '" "GeoCal::ArrayAd< double,1 > const &""'");
      }
      if (!argp2) {
        SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "WithParameter__v_parameter_with_derivative" "', argument " "2"" of type '" "GeoCal::ArrayAd< double,1 > const &""'"); 
      }
      if (newmem & SWIG_CAST_NEW_MEMORY) {
...
SWIGINTERN PyObject *_wrap_WithParameter__v_parameter_with_derivative(PyObject *self, PyObject *args) {
  Py_ssize_t argc;
  PyObject *argv[3] = {
    0
  };
  
  if (!(argc = SWIG_Python_UnpackTuple(args, "WithParameter__v_parameter_with_derivative", 0, 2, argv))) SWIG_fail;
  --argc;
  if (argc == 1) {
    PyObject *retobj = _wrap_WithParameter__v_parameter_with_derivative__SWIG_0(self, argc, argv);
    if (!SWIG_Python_TypeErrorOccurred(retobj)) return retobj;
    SWIG_fail;
  }
  if (argc == 2) {
    PyObject *retobj = _wrap_WithParameter__v_parameter_with_derivative__SWIG_1(self, argc, argv);
    if (!SWIG_Python_TypeErrorOccurred(retobj)) return retobj;
    SWIG_fail;
  }
  
fail:
  SWIG_Python_RaiseOrModifyTypeError("Wrong number or type of arguments for overloaded function 'WithParameter__v_parameter_with_derivative'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    GeoCal::WithParameter::parameter_with_derivative() const\n"
    "    GeoCal::WithParameter::parameter_with_derivative(GeoCal::ArrayAd< double,1 > const &)\n");
  return 0;
}


SWIGINTERN PyObject *_wrap_WithParameter__v_parameter_name(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  GeoCal::WithParameter *arg1 = (GeoCal::WithParameter *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  swig_obj[0] = args;
  {
    ...
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_GeoCal__WithParameter_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "WithParameter__v_parameter_name" "', argument " "1"" of type '" "GeoCal::WithParameter const *""'");
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
      tempshared1 = *reinterpret_cast< boost::shared_ptr< const GeoCal::WithParameter > * >(argp1);
      delete reinterpret_cast< boost::shared_ptr< const GeoCal::WithParameter > * >(argp1);
...
SWIGINTERN PyObject *_wrap_WithParameter__v_parameter_subset__SWIG_0(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  GeoCal::WithParameter *arg1 = (GeoCal::WithParameter *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if ((nobjs < 1) || (nobjs > 1)) SWIG_fail;
  {
    ...
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_GeoCal__WithParameter_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "WithParameter__v_parameter_subset" "', argument " "1"" of type '" "GeoCal::WithParameter const *""'");
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
      tempshared1 = *reinterpret_cast< boost::shared_ptr< const GeoCal::WithParameter > * >(argp1);
      delete reinterpret_cast< boost::shared_ptr< const GeoCal::WithParameter > * >(argp1);
...
SWIGINTERN PyObject *_wrap_WithParameter__v_parameter_subset__SWIG_1(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  GeoCal::WithParameter *arg1 = (GeoCal::WithParameter *) 0 ;
  blitz::Array< double,1 > *arg2 = 0 ;
  void *argp1 = 0 ;
  ...
  if ((nobjs < 2) || (nobjs > 2)) SWIG_fail;
  {
    ...
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_GeoCal__WithParameter_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "WithParameter__v_parameter_subset" "', argument " "1"" of type '" "GeoCal::WithParameter *""'");
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
      tempshared1 = *reinterpret_cast< boost::shared_ptr<  GeoCal::WithParameter > * >(argp1);
      delete reinterpret_cast< boost::shared_ptr<  GeoCal::WithParameter > * >(argp1);
...
SWIGINTERN PyObject *_wrap_WithParameter__v_parameter_subset(PyObject *self, PyObject *args) {
  Py_ssize_t argc;
  PyObject *argv[3] = {
    0
  };
  
  if (!(argc = SWIG_Python_UnpackTuple(args, "WithParameter__v_parameter_subset", 0, 2, argv))) SWIG_fail;
  --argc;
  if (argc == 1) {
    PyObject *retobj = _wrap_WithParameter__v_parameter_subset__SWIG_0(self, argc, argv);
    if (!SWIG_Python_TypeErrorOccurred(retobj)) return retobj;
    SWIG_fail;
  }
  if (argc == 2) {
    PyObject *retobj = _wrap_WithParameter__v_parameter_subset__SWIG_1(self, argc, argv);
    if (!SWIG_Python_TypeErrorOccurred(retobj)) return retobj;
    SWIG_fail;
  }
  
fail:
  SWIG_Python_RaiseOrModifyTypeError("Wrong number or type of arguments for overloaded function 'WithParameter__v_parameter_subset'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    GeoCal::WithParameter::parameter_subset() const\n"
    "    GeoCal::WithParameter::parameter_subset(blitz::Array< double,1 > const &)\n");
  return 0;
}


SWIGINTERN PyObject *_wrap_WithParameter__v_parameter_with_derivative_subset__SWIG_0(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  GeoCal::WithParameter *arg1 = (GeoCal::WithParameter *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  if ((nobjs < 1) || (nobjs > 1)) SWIG_fail;
  {
    ...
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_GeoCal__WithParameter_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "WithParameter__v_parameter_with_derivative_subset" "', argument " "1"" of type '" "GeoCal::WithParameter const *""'");
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
      tempshared1 = *reinterpret_cast< boost::shared_ptr< const GeoCal::WithParameter > * >(argp1);
      delete reinterpret_cast< boost::shared_ptr< const GeoCal::WithParameter > * >(argp1);
...
SWIGINTERN PyObject *_wrap_WithParameter__v_parameter_with_derivative_subset__SWIG_1(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  GeoCal::WithParameter *arg1 = (GeoCal::WithParameter *) 0 ;
  GeoCal::ArrayAd< double,1 > *arg2 = 0 ;
  void *argp1 = 0 ;
  ...
  if ((nobjs < 2) || (nobjs > 2)) SWIG_fail;
  {
    ...
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_GeoCal__WithParameter_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "WithParameter__v_parameter_with_derivative_subset" "', argument " "1"" of type '" "GeoCal::WithParameter *""'");
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
      tempshared1 = *reinterpret_cast< boost::shared_ptr<  GeoCal::WithParameter > * >(argp1);
      delete reinterpret_cast< boost::shared_ptr<  GeoCal::WithParameter > * >(argp1);
  ...
  }
  {
    ...
    if (SWIG_IsOK(res2)) {
      ...
      res2 = SWIG_ConvertPtrAndOwn(swig_obj[1], &argp2, SWIGTYPE_p_boost__shared_ptrT_GeoCal__ArrayAdT_double_1_t_t,  0 , &newmem);
      if (!SWIG_IsOK(res2)) {
        SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "WithParameter__v_parameter_with_derivative_subset" "', argument " "2"" of type '" "GeoCal::ArrayAd< double,1 > const &""'");
      }
      if (!argp2) {
        SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "WithParameter__v_parameter_with_derivative_subset" "', argument " "2"" of type '" "GeoCal::ArrayAd< double,1 > const &""'"); 
      }
      if (newmem & SWIG_CAST_NEW_MEMORY) {
        tempshared2 = *reinterpret_cast< boost::shared_ptr< const GeoCal::ArrayAd<double,1> > * >(argp2);
        delete reinterpret_cast< boost::shared_ptr< const GeoCal::ArrayAd<double,1> > * >(argp2);
...
SWIGINTERN PyObject *_wrap_WithParameter__v_parameter_with_derivative_subset(PyObject *self, PyObject *args) {
  Py_ssize_t argc;
  PyObject *argv[3] = {
    0
  };
  
  if (!(argc = SWIG_Python_UnpackTuple(args, "WithParameter__v_parameter_with_derivative_subset", 0, 2, argv))) SWIG_fail;
  --argc;
  if (argc == 1) {
    PyObject *retobj = _wrap_WithParameter__v_parameter_with_derivative_subset__SWIG_0(self, argc, argv);
    if (!SWIG_Python_TypeErrorOccurred(retobj)) return retobj;
    SWIG_fail;
  }
  if (argc == 2) {
    PyObject *retobj = _wrap_WithParameter__v_parameter_with_derivative_subset__SWIG_1(self, argc, argv);
    if (!SWIG_Python_TypeErrorOccurred(retobj)) return retobj;
    SWIG_fail;
  }
  
fail:
  SWIG_Python_RaiseOrModifyTypeError("Wrong number or type of arguments for overloaded function 'WithParameter__v_parameter_with_derivative_subset'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    GeoCal::WithParameter::parameter_with_derivative_subset() const\n"
    "    GeoCal::WithParameter::parameter_with_derivative_subset(GeoCal::ArrayAd< double,1 > const &)\n");
  return 0;
}


SWIGINTERN PyObject *_wrap_WithParameter__v_parameter_name_subset(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  GeoCal::WithParameter *arg1 = (GeoCal::WithParameter *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  swig_obj[0] = args;
  {
    ...
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_GeoCal__WithParameter_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "WithParameter__v_parameter_name_subset" "', argument " "1"" of type '" "GeoCal::WithParameter const *""'");
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
      tempshared1 = *reinterpret_cast< boost::shared_ptr< const GeoCal::WithParameter > * >(argp1);
      delete reinterpret_cast< boost::shared_ptr< const GeoCal::WithParameter > * >(argp1);
...
SWIGINTERN PyObject *_wrap_WithParameter__v_parameter_mask(PyObject *self, PyObject *args) {
  ...
  swig_obj[0] = args;
  {
    ...
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_GeoCal__WithParameter_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "WithParameter__v_parameter_mask" "', argument " "1"" of type '" "GeoCal::WithParameter const *""'");
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
      tempshared1 = *reinterpret_cast< boost::shared_ptr< const GeoCal::WithParameter > * >(argp1);
      delete reinterpret_cast< boost::shared_ptr< const GeoCal::WithParameter > * >(argp1);
...
SWIGINTERN PyObject *_wrap_WithParameter_add_identity_gradient(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  GeoCal::WithParameter *arg1 = (GeoCal::WithParameter *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  swig_obj[0] = args;
  {
    ...
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_GeoCal__WithParameter_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "WithParameter_add_identity_gradient" "', argument " "1"" of type '" "GeoCal::WithParameter *""'");
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
      tempshared1 = *reinterpret_cast< boost::shared_ptr<  GeoCal::WithParameter > * >(argp1);
      delete reinterpret_cast< boost::shared_ptr<  GeoCal::WithParameter > * >(argp1);
...
SWIGINTERN PyObject *_wrap_new_WithParameter(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  ...
  {
    boost::shared_ptr<  GeoCal::WithParameter > *smartresult = result ? new boost::shared_ptr<  GeoCal::WithParameter >(result SWIG_NO_NULL_DELETER_SWIG_POINTER_NEW) : 0;
    resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(smartresult), SWIGTYPE_p_boost__shared_ptrT_GeoCal__WithParameter_t, SWIG_POINTER_NEW | SWIG_POINTER_OWN);
  }
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_delete_WithParameter(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  GeoCal::WithParameter *arg1 = (GeoCal::WithParameter *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  swig_obj[0] = args;
  {
    ...
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_GeoCal__WithParameter_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_WithParameter" "', argument " "1"" of type '" "GeoCal::WithParameter *""'");
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
      tempshared1 = *reinterpret_cast< boost::shared_ptr<  GeoCal::WithParameter > * >(argp1);
      delete reinterpret_cast< boost::shared_ptr<  GeoCal::WithParameter > * >(argp1);
...
SWIGINTERN PyObject *_wrap_disown_WithParameter(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  GeoCal::WithParameter *arg1 = (GeoCal::WithParameter *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
...
SWIGINTERN PyObject *WithParameter_swigregister(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *obj = NULL;
  if (!SWIG_Python_UnpackTuple(args, "swigregister", 1, 1, &obj)) return NULL;
  SWIG_TypeNewClientData(SWIGTYPE_p_boost__shared_ptrT_GeoCal__WithParameter_t, SWIG_NewClientData(obj));
  return SWIG_Py_Void();
}

SWIGINTERN PyObject *WithParameter_swiginit(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  return SWIG_Python_InitShadowInstance(args);
}

SWIGINTERN PyObject *_wrap_new_WithParameterNested(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  GeoCal::WithParameterNested *result = 0 ;
  
  (void)self;
  if (!SWIG_Python_UnpackTuple(args, "new_WithParameterNested", 0, 0, 0)) SWIG_fail;
  {
    try {
      result = (GeoCal::WithParameterNested *)new GeoCal::WithParameterNested();
    } catch (Swig::DirectorException &e) {
      SWIG_fail; 
    } catch (const std::exception& e) {
      SWIG_exception(SWIG_RuntimeError, e.what());
  ...
  {
    boost::shared_ptr<  GeoCal::WithParameterNested > *smartresult = result ? new boost::shared_ptr<  GeoCal::WithParameterNested >(result SWIG_NO_NULL_DELETER_SWIG_POINTER_NEW) : 0;
    resultobj = SWIG_NewPointerObj(SWIG_as_voidptr(smartresult), SWIGTYPE_p_boost__shared_ptrT_GeoCal__WithParameterNested_t, SWIG_POINTER_NEW | SWIG_POINTER_OWN);
  }
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_WithParameterNested_add_object(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  GeoCal::WithParameterNested *arg1 = (GeoCal::WithParameterNested *) 0 ;
  boost::shared_ptr< GeoCal::WithParameter > *arg2 = 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  void *argp2 ;
  int res2 = 0 ;
  boost::shared_ptr< GeoCal::WithParameter > tempshared2 ;
  boost::shared_ptr< GeoCal::WithParameter > temp2shared2 ;
  PyObject *swig_obj[2] ;
  
  (void)self;
  if (!SWIG_Python_UnpackTuple(args, "WithParameterNested_add_object", 2, 2, swig_obj)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_GeoCal__WithParameterNested_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "WithParameterNested_add_object" "', argument " "1"" of type '" "GeoCal::WithParameterNested *""'");
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
  ...
  {
    int newmem = 0;
    res2 = SWIG_ConvertPtrAndOwn(swig_obj[1], &argp2, SWIGTYPE_p_boost__shared_ptrT_GeoCal__WithParameter_t,  0 , &newmem);
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "WithParameterNested_add_object" "', argument " "2"" of type '" "boost::shared_ptr< GeoCal::WithParameter > const &""'");
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
      if (argp2) tempshared2 = *reinterpret_cast< boost::shared_ptr< GeoCal::WithParameter > * >(argp2);
      delete reinterpret_cast< boost::shared_ptr< GeoCal::WithParameter > * >(argp2);
      arg2 = &tempshared2;
    } else {
  ...
  {
    try {
      (arg1)->add_object((boost::shared_ptr< GeoCal::WithParameter > const &)*arg2);
    } catch (Swig::DirectorException &e) {
      SWIG_fail; 
    } catch (const std::exception& e) {
      SWIG_exception(SWIG_RuntimeError, e.what());
...
SWIGINTERN PyObject *_wrap_WithParameterNested_clear_object(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  GeoCal::WithParameterNested *arg1 = (GeoCal::WithParameterNested *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
...
SWIGINTERN PyObject *_wrap_delete_WithParameterNested(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  GeoCal::WithParameterNested *arg1 = (GeoCal::WithParameterNested *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  swig_obj[0] = args;
  {
    ...
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_GeoCal__WithParameterNested_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_WithParameterNested" "', argument " "1"" of type '" "GeoCal::WithParameterNested *""'");
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
      tempshared1 = *reinterpret_cast< boost::shared_ptr<  GeoCal::WithParameterNested > * >(argp1);
      delete reinterpret_cast< boost::shared_ptr<  GeoCal::WithParameterNested > * >(argp1);
...
SWIGINTERN PyObject *WithParameterNested_swigregister(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *obj = NULL;
  if (!SWIG_Python_UnpackTuple(args, "swigregister", 1, 1, &obj)) return NULL;
  SWIG_TypeNewClientData(SWIGTYPE_p_boost__shared_ptrT_GeoCal__WithParameterNested_t, SWIG_NewClientData(obj));
  return SWIG_Py_Void();
}

SWIGINTERN PyObject *WithParameterNested_swiginit(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  return SWIG_Python_InitShadowInstance(args);
}
...
SWIGINTERN PyObject *_wrap_WithParameterShare_add_object(PyObject *self, PyObject *args) {
  ...
  void *argp1 = 0 ;
  int res1 = 0 ;
  boost::shared_ptr< GeoCal::WithParameterShare > tempshared1 ;
  boost::shared_ptr< GeoCal::WithParameterShare > *smartarg1 = 0 ;
  void *argp2 ;
  int res2 = 0 ;
  boost::shared_ptr< GeoCal::WithParameter > tempshared2 ;
  boost::shared_ptr< GeoCal::WithParameter > temp2shared2 ;
  ...
  (void)self;
  if (!SWIG_Python_UnpackTuple(args, "WithParameterShare_add_object", 2, 2, swig_obj)) SWIG_fail;
  {
    int newmem = 0;
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_GeoCal__WithParameterShare_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "WithParameterShare_add_object" "', argument " "1"" of type '" "GeoCal::WithParameterShare *""'");
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
      tempshared1 = *reinterpret_cast< boost::shared_ptr<  GeoCal::WithParameterShare > * >(argp1);
      delete reinterpret_cast< boost::shared_ptr<  GeoCal::WithParameterShare > * >(argp1);
      arg1 = const_cast< GeoCal::WithParameterShare * >(tempshared1.get());
    } else {
      smartarg1 = reinterpret_cast< boost::shared_ptr<  GeoCal::WithParameterShare > * >(argp1);
      arg1 = const_cast< GeoCal::WithParameterShare * >((smartarg1 ? smartarg1->get() : 0));
    }
  }
  {
    int newmem = 0;
    res2 = SWIG_ConvertPtrAndOwn(swig_obj[1], &argp2, SWIGTYPE_p_boost__shared_ptrT_GeoCal__WithParameter_t,  0 , &newmem);
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "WithParameterShare_add_object" "', argument " "2"" of type '" "boost::shared_ptr< GeoCal::WithParameter > const &""'");
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
      if (argp2) tempshared2 = *reinterpret_cast< boost::shared_ptr< GeoCal::WithParameter > * >(argp2);
      delete reinterpret_cast< boost::shared_ptr< GeoCal::WithParameter > * >(argp2);
...
SWIGINTERN PyObject *_wrap_WithParameterShare_clear_object(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  GeoCal::WithParameterShare *arg1 = (GeoCal::WithParameterShare *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  swig_obj[0] = args;
  {
    ...
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_GeoCal__WithParameterShare_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "WithParameterShare_clear_object" "', argument " "1"" of type '" "GeoCal::WithParameterShare *""'");
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
      tempshared1 = *reinterpret_cast< boost::shared_ptr<  GeoCal::WithParameterShare > * >(argp1);
      delete reinterpret_cast< boost::shared_ptr<  GeoCal::WithParameterShare > * >(argp1);
...
SWIGINTERN PyObject *_wrap_WithParameterShare__v_parameter_mask__SWIG_0(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  GeoCal::WithParameterShare *arg1 = (GeoCal::WithParameterShare *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  boost::shared_ptr< GeoCal::WithParameterShare const > tempshared1 ;
  boost::shared_ptr< GeoCal::WithParameterShare const > *smartarg1 = 0 ;
  SwigValueWrapper< blitz::Array< bool,1 > > result;
  ...
  if ((nobjs < 1) || (nobjs > 1)) SWIG_fail;
  {
    ...
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_GeoCal__WithParameterShare_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "WithParameterShare__v_parameter_mask" "', argument " "1"" of type '" "GeoCal::WithParameterShare const *""'");
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
      tempshared1 = *reinterpret_cast< boost::shared_ptr< const GeoCal::WithParameterShare > * >(argp1);
      delete reinterpret_cast< boost::shared_ptr< const GeoCal::WithParameterShare > * >(argp1);
      arg1 = const_cast< GeoCal::WithParameterShare * >(tempshared1.get());
    } else {
      smartarg1 = reinterpret_cast< boost::shared_ptr< const GeoCal::WithParameterShare > * >(argp1);
      arg1 = const_cast< GeoCal::WithParameterShare * >((smartarg1 ? smartarg1->get() : 0));
    }
  }
  {
    try {
      result = ((GeoCal::WithParameterShare const *)arg1)->parameter_mask();
    } catch (Swig::DirectorException &e) {
      SWIG_fail; 
    } catch (const std::exception& e) {
      SWIG_exception(SWIG_RuntimeError, e.what());
...
SWIGINTERN PyObject *_wrap_WithParameterShare__v_parameter_mask__SWIG_1(PyObject *self, Py_ssize_t nobjs, PyObject **swig_obj) {
  PyObject *resultobj = 0;
  GeoCal::WithParameterShare *arg1 = (GeoCal::WithParameterShare *) 0 ;
  ...
  if ((nobjs < 2) || (nobjs > 2)) SWIG_fail;
  {
    ...
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_GeoCal__WithParameterShare_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "WithParameterShare__v_parameter_mask" "', argument " "1"" of type '" "GeoCal::WithParameterShare *""'");
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
      tempshared1 = *reinterpret_cast< boost::shared_ptr<  GeoCal::WithParameterShare > * >(argp1);
      delete reinterpret_cast< boost::shared_ptr<  GeoCal::WithParameterShare > * >(argp1);
  ...
  }
  {
    ...
    if(!SWIG_IsOK(res)) {
      ...
      if(!numpy2.obj) {
        SWIG_Error(SWIG_TypeError, "in method 'WithParameterShare__v_parameter_mask', expecting type  Array<bool,1>");
        return NULL;
      }
      if(PyArray_NDIM((PyArrayObject*)numpy2.obj) !=1) {
        SWIG_Error(SWIG_TypeError, "in method 'WithParameterShare__v_parameter_mask', expecting type  Array<bool,1>");
...
SWIGINTERN PyObject *_wrap_WithParameterShare__v_parameter_mask(PyObject *self, PyObject *args) {
  Py_ssize_t argc;
  PyObject *argv[3] = {
    0
  };
  
  if (!(argc = SWIG_Python_UnpackTuple(args, "WithParameterShare__v_parameter_mask", 0, 2, argv))) SWIG_fail;
  --argc;
  if (argc == 1) {
    PyObject *retobj = _wrap_WithParameterShare__v_parameter_mask__SWIG_0(self, argc, argv);
    if (!SWIG_Python_TypeErrorOccurred(retobj)) return retobj;
    SWIG_fail;
  }
  if (argc == 2) {
    PyObject *retobj = _wrap_WithParameterShare__v_parameter_mask__SWIG_1(self, argc, argv);
    if (!SWIG_Python_TypeErrorOccurred(retobj)) return retobj;
    SWIG_fail;
  }
  
fail:
  SWIG_Python_RaiseOrModifyTypeError("Wrong number or type of arguments for overloaded function 'WithParameterShare__v_parameter_mask'.\n"
    "  Possible C/C++ prototypes are:\n"
    "    GeoCal::WithParameterShare::parameter_mask() const\n"
    "    GeoCal::WithParameterShare::parameter_mask(blitz::Array< bool,1 > const &)\n");
  return 0;
}


SWIGINTERN PyObject *_wrap_delete_WithParameterShare(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  GeoCal::WithParameterShare *arg1 = (GeoCal::WithParameterShare *) 0 ;
  void *argp1 = 0 ;
  int res1 = 0 ;
  ...
  swig_obj[0] = args;
  {
    ...
    res1 = SWIG_ConvertPtrAndOwn(swig_obj[0], &argp1, SWIGTYPE_p_boost__shared_ptrT_GeoCal__WithParameterShare_t, 0 |  0 , &newmem);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "delete_WithParameterShare" "', argument " "1"" of type '" "GeoCal::WithParameterShare *""'");
    }
    if (newmem & SWIG_CAST_NEW_MEMORY) {
      tempshared1 = *reinterpret_cast< boost::shared_ptr<  GeoCal::WithParameterShare > * >(argp1);
      delete reinterpret_cast< boost::shared_ptr<  GeoCal::WithParameterShare > * >(argp1);
...
SWIGINTERN PyObject *WithParameterShare_swigregister(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *obj = NULL;
  if (!SWIG_Python_UnpackTuple(args, "swigregister", 1, 1, &obj)) return NULL;
  SWIG_TypeNewClientData(SWIGTYPE_p_boost__shared_ptrT_GeoCal__WithParameterShare_t, SWIG_NewClientData(obj));
  return SWIG_Py_Void();
}
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "WithParameter__v_parameter", _wrap_WithParameter__v_parameter, METH_VARARGS, "\n"
		"WithParameter__v_parameter(WithParameter self) -> BlitzArray_double_1\n"
		"WithParameter__v_parameter(WithParameter self, BlitzArray_double_1 V)\n"
		"\n"
		"GeoCal::WithParameter::parameter\n"
		"Set the value of the parameters.  \n"
		"\n"
		""},
	 { "WithParameter__v_parameter_with_derivative", _wrap_WithParameter__v_parameter_with_derivative, METH_VARARGS, "\n"
		"WithParameter__v_parameter_with_derivative(WithParameter self) -> ArrayAd_double_1\n"
		"WithParameter__v_parameter_with_derivative(WithParameter self, ArrayAd_double_1 V)\n"
		"\n"
		"GeoCal::WithParameter::parameter_with_derivative\n"
		"Set the value of the parameters, including derivatives of the parameter.  \n"
		"\n"
		"Useful for doing Jacobian calculations.  \n"
		"\n"
		""},
	 { "WithParameter__v_parameter_name", _wrap_WithParameter__v_parameter_name, METH_O, "\n"
		"WithParameter__v_parameter_name(WithParameter self) -> vector_string\n"
		"\n"
		"GeoCal::WithParameter::parameter_name\n"
		"Descriptive name of each parameter.  \n"
		"\n"
		""},
	 { "WithParameter__v_parameter_subset", _wrap_WithParameter__v_parameter_subset, METH_VARARGS, "\n"
		"WithParameter__v_parameter_subset(WithParameter self) -> BlitzArray_double_1\n"
		"WithParameter__v_parameter_subset(WithParameter self, BlitzArray_double_1 V)\n"
		"\n"
		"GeoCal::WithParameter::parameter_subset\n"
		"Set the part of the parameter set that passes the mask.  \n"
		"\n"
		""},
	 { "WithParameter__v_parameter_with_derivative_subset", _wrap_WithParameter__v_parameter_with_derivative_subset, METH_VARARGS, "\n"
		"WithParameter__v_parameter_with_derivative_subset(WithParameter self) -> ArrayAd_double_1\n"
		"WithParameter__v_parameter_with_derivative_subset(WithParameter self, ArrayAd_double_1 V)\n"
		"\n"
		"GeoCal::WithParameter::parameter_with_derivative_subset\n"
		"Set the part of the parameter set that passes the mask.  \n"
		"\n"
		""},
	 { "WithParameter__v_parameter_name_subset", _wrap_WithParameter__v_parameter_name_subset, METH_O, "\n"
		"WithParameter__v_parameter_name_subset(WithParameter self) -> vector_string\n"
		"\n"
		"GeoCal::WithParameter::parameter_name_subset\n"
		"Return the part of the parameter name that passes the mask.  \n"
		"\n"
		""},
	 { "WithParameter__v_parameter_mask", _wrap_WithParameter__v_parameter_mask, METH_O, "\n"
		"WithParameter__v_parameter_mask(WithParameter self) -> BlitzArray_bool_1\n"
		"\n"
		"GeoCal::WithParameter::parameter_mask\n"
		"Return the parameter subset mask, where \"true\" means include the parameter and\n"
		"\"false\" means don't.  \n"
		"\n"
		""},
	 { "WithParameter_add_identity_gradient", _wrap_WithParameter_add_identity_gradient, METH_O, "\n"
		"WithParameter_add_identity_gradient(WithParameter self)\n"
		"\n"
		"GeoCal::WithParameter::add_identity_gradient\n"
		"A very common thing is to want the gradient each of the active parameters (those\n"
		"returned by parameter_subset) to be the parameters the gradient is relative to,\n"
		"i.e.  \n"
		"\n"
		"the first parameter has gradient of [1,0,0...], the second [0,1,0...] etc. This\n"
		"utility routine sets that up.  \n"
		"\n"
		""},
	 { "new_WithParameter", _wrap_new_WithParameter, METH_O, "new_WithParameter(PyObject * _self) -> WithParameter"},
	 { "delete_WithParameter", _wrap_delete_WithParameter, METH_O, "\n"
		"delete_WithParameter(WithParameter self)\n"
		"\n"
		"GeoCal::WithParameter::~WithParameter\n"
		""},
	 { "disown_WithParameter", _wrap_disown_WithParameter, METH_O, NULL},
	 { "WithParameter_swigregister", WithParameter_swigregister, METH_O, NULL},
	 { "WithParameter_swiginit", WithParameter_swiginit, METH_VARARGS, NULL},
	 { "new_WithParameterNested", _wrap_new_WithParameterNested, METH_NOARGS, "\n"
		"new_WithParameterNested() -> WithParameterNested\n"
		"\n"
		"GeoCal::WithParameterNested::WithParameterNested\n"
		""},
	 { "WithParameterNested_add_object", _wrap_WithParameterNested_add_object, METH_VARARGS, "\n"
		"WithParameterNested_add_object(WithParameterNested self, boost::shared_ptr< GeoCal::WithParameter > const & Obj)\n"
		"\n"
		"GeoCal::WithParameterNested::add_object\n"
		""},
	 { "WithParameterNested_clear_object", _wrap_WithParameterNested_clear_object, METH_O, "\n"
		"WithParameterNested_clear_object(WithParameterNested self)\n"
		"\n"
		"GeoCal::WithParameterNested::clear_object\n"
		""},
	 { "delete_WithParameterNested", _wrap_delete_WithParameterNested, METH_O, "\n"
		"delete_WithParameterNested(WithParameterNested self)\n"
		"\n"
		"GeoCal::WithParameterNested::~WithParameterNested\n"
		""},
	 ...
	 { "new_WithParameterShare", _wrap_new_WithParameterShare, METH_NOARGS, "\n"
		"new_WithParameterShare() -> WithParameterShare\n"
		"\n"
	 ...
	 { "WithParameterShare_add_object", _wrap_WithParameterShare_add_object, METH_VARARGS, "\n"
		"WithParameterShare_add_object(WithParameterShare self, boost::shared_ptr< GeoCal::WithParameter > const & Obj)\n"
		"\n"
		"GeoCal::WithParameterShare::add_object\n"
		""},
	 { "WithParameterShare_clear_object", _wrap_WithParameterShare_clear_object, METH_O, "\n"
		"WithParameterShare_clear_object(WithParameterShare self)\n"
		"\n"
		"GeoCal::WithParameterShare::clear_object\n"
		""},
	 { "WithParameterShare__v_parameter_mask", _wrap_WithParameterShare__v_parameter_mask, METH_VARARGS, "\n"
		"WithParameterShare__v_parameter_mask(WithParameterShare self) -> BlitzArray_bool_1\n"
		"WithParameterShare__v_parameter_mask(WithParameterShare self, BlitzArray_bool_1 V)\n"
		"\n"
		"GeoCal::WithParameterShare::parameter_mask\n"
		""},
	 { "delete_WithParameterShare", _wrap_delete_WithParameterShare, METH_O, "\n"
		"delete_WithParameterShare(WithParameterShare self)\n"
		"\n"
		"GeoCal::WithParameterShare::~WithParameterShare\n"
		""},
...
static PyMethodDef SwigMethods_proxydocs[] = {
	 ...
	 { "SwigPyIterator_swigregister", SwigPyIterator_swigregister, METH_O, NULL},
	 { "WithParameter__v_parameter", _wrap_WithParameter__v_parameter, METH_VARARGS, "\n"
		"_v_parameter(WithParameter self) -> BlitzArray_double_1\n"
		"_v_parameter(WithParameter self, BlitzArray_double_1 V)\n"
		"\n"
		"GeoCal::WithParameter::parameter\n"
		"Set the value of the parameters.  \n"
		"\n"
		""},
	 { "WithParameter__v_parameter_with_derivative", _wrap_WithParameter__v_parameter_with_derivative, METH_VARARGS, "\n"
		"_v_parameter_with_derivative(WithParameter self) -> ArrayAd_double_1\n"
		"_v_parameter_with_derivative(WithParameter self, ArrayAd_double_1 V)\n"
		"\n"
		"GeoCal::WithParameter::parameter_with_derivative\n"
		"Set the value of the parameters, including derivatives of the parameter.  \n"
		"\n"
		...
		""},
	 { "WithParameter__v_parameter_name", _wrap_WithParameter__v_parameter_name, METH_O, "\n"
		"_v_parameter_name(WithParameter self) -> vector_string\n"
		"\n"
		"GeoCal::WithParameter::parameter_name\n"
		"Descriptive name of each parameter.  \n"
		"\n"
		""},
	 { "WithParameter__v_parameter_subset", _wrap_WithParameter__v_parameter_subset, METH_VARARGS, "\n"
		"_v_parameter_subset(WithParameter self) -> BlitzArray_double_1\n"
		"_v_parameter_subset(WithParameter self, BlitzArray_double_1 V)\n"
		"\n"
		"GeoCal::WithParameter::parameter_subset\n"
		"Set the part of the parameter set that passes the mask.  \n"
		"\n"
		""},
	 { "WithParameter__v_parameter_with_derivative_subset", _wrap_WithParameter__v_parameter_with_derivative_subset, METH_VARARGS, "\n"
		"_v_parameter_with_derivative_subset(WithParameter self) -> ArrayAd_double_1\n"
		"_v_parameter_with_derivative_subset(WithParameter self, ArrayAd_double_1 V)\n"
		"\n"
		"GeoCal::WithParameter::parameter_with_derivative_subset\n"
		"Set the part of the parameter set that passes the mask.  \n"
		"\n"
		""},
	 { "WithParameter__v_parameter_name_subset", _wrap_WithParameter__v_parameter_name_subset, METH_O, "\n"
		"_v_parameter_name_subset(WithParameter self) -> vector_string\n"
		"\n"
		"GeoCal::WithParameter::parameter_name_subset\n"
		"Return the part of the parameter name that passes the mask.  \n"
		"\n"
		""},
	 { "WithParameter__v_parameter_mask", _wrap_WithParameter__v_parameter_mask, METH_O, "\n"
		"_v_parameter_mask(WithParameter self) -> BlitzArray_bool_1\n"
		"\n"
		"GeoCal::WithParameter::parameter_mask\n"
		"Return the parameter subset mask, where \"true\" means include the parameter and\n"
		"\"false\" means don't.  \n"
		...
		""},
	 { "WithParameter_add_identity_gradient", _wrap_WithParameter_add_identity_gradient, METH_O, "\n"
		"add_identity_gradient(WithParameter self)\n"
		"\n"
		"GeoCal::WithParameter::add_identity_gradient\n"
		"A very common thing is to want the gradient each of the active parameters (those\n"
		"returned by parameter_subset) to be the parameters the gradient is relative to,\n"
	 ...
	 { "new_WithParameterNested", _wrap_new_WithParameterNested, METH_NOARGS, "\n"
		...
		""},
	 { "WithParameterNested_add_object", _wrap_WithParameterNested_add_object, METH_VARARGS, "\n"
		"add_object(WithParameterNested self, boost::shared_ptr< GeoCal::WithParameter > const & Obj)\n"
		"\n"
		"GeoCal::WithParameterNested::add_object\n"
		""},
	 { "WithParameterNested_clear_object", _wrap_WithParameterNested_clear_object, METH_O, "\n"
		"clear_object(WithParameterNested self)\n"
		"\n"
		"GeoCal::WithParameterNested::clear_object\n"
		""},
	 { "delete_WithParameterNested", _wrap_delete_WithParameterNested, METH_O, "\n"
	 ...
	 { "new_WithParameterShare", _wrap_new_WithParameterShare, METH_NOARGS, "\n"
		...
		""},
	 { "WithParameterShare_add_object", _wrap_WithParameterShare_add_object, METH_VARARGS, "\n"
		"add_object(WithParameterShare self, boost::shared_ptr< GeoCal::WithParameter > const & Obj)\n"
		"\n"
		"GeoCal::WithParameterShare::add_object\n"
		""},
	 { "WithParameterShare_clear_object", _wrap_WithParameterShare_clear_object, METH_O, "\n"
		"clear_object(WithParameterShare self)\n"
		"\n"
		"GeoCal::WithParameterShare::clear_object\n"
		""},
	 { "WithParameterShare__v_parameter_mask", _wrap_WithParameterShare__v_parameter_mask, METH_VARARGS, "\n"
		"_v_parameter_mask(WithParameterShare self) -> BlitzArray_bool_1\n"
		"_v_parameter_mask(WithParameterShare self, BlitzArray_bool_1 V)\n"
		"\n"
		"GeoCal::WithParameterShare::parameter_mask\n"
		""},
	 { "delete_WithParameterShare", _wrap_delete_WithParameterShare, METH_O, "\n"
...
static swig_cast_info _swigc__p_GeoCal__GenericObject[] = {  {&_swigt__p_GeoCal__GenericObject, 0, 0, 0},  {&_swigt__p_GeoCal__AutoDerivativeRefT_double_t, _p_GeoCal__AutoDerivativeRefT_double_tTo_p_GeoCal__GenericObject, 0, 0},  {&_swigt__p_GeoCal__AutoDerivativeT_double_t, _p_GeoCal__AutoDerivativeT_double_tTo_p_GeoCal__GenericObject, 0, 0},  {&_swigt__p_GeoCal__WithParameter, _p_GeoCal__WithParameterTo_p_GeoCal__GenericObject, 0, 0},  {&_swigt__p_GeoCal__WithParameterNested, _p_GeoCal__WithParameterNestedTo_p_GeoCal__GenericObject, 0, 0},  {&_swigt__p_GeoCal__WithParameterShare, _p_GeoCal__WithParameterShareTo_p_GeoCal__GenericObject, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_GeoCal__WithParameter[] = {  {&_swigt__p_GeoCal__WithParameter, 0, 0, 0},  {&_swigt__p_GeoCal__WithParameterNested, _p_GeoCal__WithParameterNestedTo_p_GeoCal__WithParameter, 0, 0},  {&_swigt__p_GeoCal__WithParameterShare, _p_GeoCal__WithParameterShareTo_p_GeoCal__WithParameter, 0, 0},{0, 0, 0, 0}};
...
# endif
  ...
  GeoCal::SwigTypeMapperBase::add(typeid(GeoCal::WithParameter), boost::make_shared<GeoCal::SwigTypeMapper< GeoCal::WithParameter > > ("boost::shared_ptr< GeoCal::WithParameter > *"));
  
  
  GeoCal::SwigTypeMapperBase::add(typeid(GeoCal::WithParameterNested), boost::make_shared<GeoCal::SwigTypeMapper< GeoCal::WithParameterNested > > ("boost::shared_ptr< GeoCal::WithParameterNested > *"));
  
  
  GeoCal::SwigTypeMapperBase::add(typeid(GeoCal::WithParameterShare), boost::make_shared<GeoCal::SwigTypeMapper< GeoCal::WithParameterShare > > ("boost::shared_ptr< GeoCal::WithParameterShare > *"));
  
  
  GeoCal::SwigTypeMapperBase::add(typeid(SwigDirector_WithParameter), boost::make_shared<GeoCal::SwigTypeMapper< SwigDirector_WithParameter > > ("boost::shared_ptr< SwigDirector" "WithParameter > *"));
