...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__CartLabMultifile_t swig_types[149]
...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__GdalCartLabMultifile_t swig_types[164]
