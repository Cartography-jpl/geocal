...
#define SWIGTYPE_p_GeoCal__SubRasterImageMultiBand swig_types[55]
...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__SubRasterImageMultiBand_t swig_types[191]
