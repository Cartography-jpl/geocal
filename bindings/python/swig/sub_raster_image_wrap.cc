...
#define SWIGTYPE_p_GeoCal__SubRasterImage swig_types[28]
...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__SubRasterImage_t swig_types[85]
...
# endif
  ...
  GeoCal::swig_type_map[GeoCal::type_index(typeid(GeoCal::SubRasterImage))] =
  boost::shared_ptr<GeoCal::SwigTypeMapperBase>(new GeoCal::SwigTypeMapper< GeoCal::SubRasterImage >("boost::shared_ptr< GeoCal::SubRasterImage > *"));
