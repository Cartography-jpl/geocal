...
#define SWIGTYPE_p_GeoCal__Geocentric swig_types[8]
#define SWIGTYPE_p_GeoCal__Geodetic swig_types[9]
...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__Geocentric_t swig_types[38]
