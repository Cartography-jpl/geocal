...
SWIGINTERN PyObject *_wrap_new_CameraRationalPolyomial(PyObject *self, PyObject *args) {
  ...
  arg5 = static_cast< double >(val5);
  {
    ...
    if (!argp6) {
      SWIG_exception_fail(SWIG_NullReferenceError, "invalid null reference " "in method '" "new_CameraRationalPolyomial" "', argument " "6"" of type '" "boost::math::quaternion< double >""'");
    } else {
