...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "MapInfo__v_is_geodetic_360", _wrap_MapInfo__v_is_geodetic_360, METH_O, "\n"
		"\n"
		"bool GeoCal::MapInfo::is_geodetic_360() const\n"
	 ...
	 { "MapInfo_cover", _wrap_MapInfo_cover, METH_VARARGS, "\n"
		...
		"Create a MapInfo that has the same map projection and pixel resolution as this one,\n"
		"but covers the given set of points.\n"
	 ...
	 { "MapInfo_scale", _wrap_MapInfo_scale, METH_VARARGS, "\n"
		...
		"Create a MapInfo that has the same upper left corner, and a pixel size scaled by the\n"
		"given number of line and samples per pixel.\n"
	 ...
	 { "MapInfo__v_transform", _wrap_MapInfo__v_transform, METH_O, "\n"
		...
		""},
	 { "MapInfo___str__", _wrap_MapInfo___str__, METH_O, NULL},
	 { "delete_MapInfo", _wrap_delete_MapInfo, METH_O, NULL},
