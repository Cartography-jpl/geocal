...
#define SWIGTYPE_p_GeoCal__RsmImageGroundConnection swig_types[52]
...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__RsmImageGroundConnection_t swig_types[190]
