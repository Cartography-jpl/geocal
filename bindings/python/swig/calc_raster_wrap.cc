...
#define SWIGTYPE_p_GeoCal__RasterImageVariable swig_types[22]
...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__CalcRaster_t swig_types[42]
...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__VicarImageCoordinate_t swig_types[66]
