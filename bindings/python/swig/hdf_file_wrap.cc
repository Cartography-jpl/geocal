...
#define SWIGTYPE_p_boost__shared_ptrT_GeoCal__HdfFile_t swig_types[28]
...
# endif
  ...
  GeoCal::swig_type_map[GeoCal::type_index(typeid(GeoCal::HdfFile))] =
  boost::shared_ptr<GeoCal::SwigTypeMapperBase>(new GeoCal::SwigTypeMapper< GeoCal::HdfFile >("boost::shared_ptr< GeoCal::HdfFile > *"));
